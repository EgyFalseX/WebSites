<%@ Page Title="" Language="C#" MasterPageFile="master.master" AutoEventWireup="true" CodeFile="alsofofEditor.aspx.cs" Inherits="alsofofEditor" %>
    ...
    <tr>
        <td>
            <dx:ASPxGridView ID="GVEditor" runat="server" AutoGenerateColumns="False" 
                ...
                KeyFieldName="alsofof_code" RightToLeft="True" 
...
s.cpShowPopup = undefined;
                ...
                <Columns>
                    ...
                    <dx:GridViewDataTextColumn Caption="اسم الصف" FieldName="alsofof_name" VisibleIndex="5">
            ...
            <asp:AccessDataSource ID="DSData" runat="server" DataFile="~/App_Data/Download_Center.mdb" 
                DeleteCommand="DELETE FROM [alsofof] WHERE [alsofof_code] = ?" InsertCommand="INSERT INTO [alsofof] ([alsofof_code], [alsofof_name]) VALUES (?, ?)" SelectCommand="SELECT [alsofof_code], [alsofof_name] FROM [alsofof]" 
                UpdateCommand="UPDATE [alsofof] SET [alsofof_name] = ? WHERE [alsofof_code] = ?" OnInserting="DSData_Inserting">
                <DeleteParameters>
