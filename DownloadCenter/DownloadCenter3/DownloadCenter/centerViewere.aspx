<%@ Page Title="" Language="C#" MasterPageFile="masteruser.master" AutoEventWireup="true" CodeFile="centerViewere.aspx.cs" Inherits="centerViewer" %>
    ...
    <tr>
        <td>
            <dx:ASPxGridView ID="GVEditor" runat="server" AutoGenerateColumns="False" 
                ...
                KeyFieldName="id_prog" CssFilePath="../App_Themes/PlasticBlue/{0}/styles.css" 
...
{2}" notallowedfileextensionerrortext="امتداد الملف غير مسموح به">
                ...
                <SettingsPager ShowDefaultImages="False">
                    ...
                    <Summary AllPagesText="Pages :  {0} - {1} ({2} Record)" />
                </SettingsPager>
