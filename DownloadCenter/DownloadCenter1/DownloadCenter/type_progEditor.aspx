<%@ Page Title="" Language="C#" MasterPageFile="master.master" AutoEventWireup="true" CodeFile="type_progEditor.aspx.cs" Inherits="type_progEditor" %>
    ...
    <tr>
        <td>
            <dx:ASPxGridView ID="GVEditor" runat="server" AutoGenerateColumns="False" 
                ...
                KeyFieldName="type_prog_id" RightToLeft="True" 
...
s.cpShowPopup = undefined;
                ...
                <Columns>
                    ...
                    <dx:GridViewDataTextColumn Caption="اسم المادة" FieldName="name_prog" VisibleIndex="5">
                        <EditFormSettings ColumnSpan="1" RowSpan="1" />
            ...
            <asp:AccessDataSource ID="DSData" runat="server" DataFile="~/App_Data/Download_Center.mdb" 
                DeleteCommand="DELETE FROM [type_prog] WHERE [type_prog_id] = ?" InsertCommand="INSERT INTO [type_prog] ([type_prog_id], [name_prog]) VALUES (?, ?)" SelectCommand="SELECT [type_prog_id], [name_prog] FROM [type_prog]" 
                UpdateCommand="UPDATE [type_prog] SET [name_prog] = ? WHERE [type_prog_id] = ?" OnInserting="DSData_Inserting">
                <DeleteParameters>
