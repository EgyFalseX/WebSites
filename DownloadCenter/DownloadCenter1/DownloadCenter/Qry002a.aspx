<%@ Page Title="" Language="C#" MasterPageFile="masteruser.master" AutoEventWireup="true" CodeFile="Qry002a.aspx.cs" Inherits="Qry002a" %>
    ...
    <tr>
        <td>
            <dx:ASPxGridView ID="GVEditor" runat="server" AutoGenerateColumns="False" 
                ...
                KeyFieldName="studentcode" RightToLeft="True" 
...
s.cpShowPopup = undefined;
                ...
                <Columns>
                    ...
                    <dx:GridViewDataTextColumn Caption="الصف" FieldName="alsofof_name" VisibleIndex="1">
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataTextColumn Caption="الفصل" FieldName="name_al_fasl" VisibleIndex="2">
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataDateColumn Caption="التاريخ" FieldName="downdate" VisibleIndex="6">
            ...
            <asp:AccessDataSource ID="DSData" runat="server" 
                ...
                SelectCommand="SELECT studentcode FROM download WHERE (id_prog = ?)" 
                ...
                <SelectParameters>
                    <asp:QueryStringParameter DefaultValue="-1" Name="?" QueryStringField="id" />
                </SelectParameters>
                <UpdateParameters>
                    <asp:Parameter Name="code_al_fasl" Type="Byte" />
                    <asp:Parameter Name="alsofof_code" Type="Byte" />
            ...
            <asp:AccessDataSource ID="DStype_prog" runat="server" 
                DataFile="~/App_Data/Download_Center.mdb" 
                SelectCommand="SELECT download.id_prog, center.code_al_fasl, center.alsofof_code, center.name_prog FROM (download LEFT OUTER JOIN center ON download.id_prog = center.id_prog) GROUP BY download.id_prog, center.code_al_fasl, center.alsofof_code, center.name_prog" 
                OnSelecting="DSData_Selecting" oninserting="DSData_Inserting" 
                onupdating="DSData_Updating">
            </asp:AccessDataSource>
        </td>
