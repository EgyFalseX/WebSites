                    ...
                    <dx:GridViewDataImageColumn Caption="الرابط" FieldName="link" 
                        ...
                        <EditItemTemplate>
                            <dx:ASPxUploadControl ID="ASPxUploadControl1" runat="server" CssFilePath="App_Themes/DevEx/{0}/styles.css"
                                ...
                                Width="280px">
                                <validationsettings generalerrortext="فشل التحميل بسبب خطــاء داخلي" maxfilesize="614400"
                                    
                                    maxfilesizeerrortext="الملف اكبر من 600 كيلوبايت برجاء رفع ملف اصغر من 600 كيلوبايت" multiselectionerrortext="خطاء في نوع الملف :  {0} files are invalid because they exceed the allowed file size ({1}) or their extensions are not allowed. These files have been removed from selection, so they will not be uploaded. 
...
{2}" notallowedfileextensionerrortext="امتداد الملف غير مسموح به">
                    ...
                    <AdvancedModeSettings TemporaryFolder="App_Data\UploadTemp\" />
                            ...
                            <br />
                            <dx:ASPxLabel runat="server" Text="External link"></dx:ASPxLabel>
                            <br />
                            <dx:ASPxTextBox ID="txtLink" runat="server" Width="200px" Height="19px" Text='<%# Bind("link") %>'></dx:ASPxTextBox>
                        </EditItemTemplate>
                    ...
                    <dx:GridViewDataDateColumn Caption="تاريخ الرفع" FieldName="date_up" VisibleIndex="5">
                        <EditFormSettings ColumnSpan="2" />
                    </dx:GridViewDataDateColumn>
                    <dx:GridViewDataMemoColumn Caption="الوصف" FieldName="Description" 
                        VisibleIndex="6">
