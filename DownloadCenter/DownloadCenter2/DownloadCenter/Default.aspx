...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderMain" Runat="Server">
    ...
    <dx:ASPxNavBar ID="ASPxNavBarMain" runat="server" Font-Bold="True" Font-Size="10pt" LoadingPanelText="جاري التحميل&amp;hellip;" RightToLeft="True" Width="325px" Theme="PlasticBlue" style="margin-right: 0px">
        <Groups>
            <dx:NavBarGroup Text="المستخدمين" Name="groupUser" Expanded="False">
            ...
            <dx:NavBarGroup Text="المدير" Name="groupAdmin">
                ...
                <Items>
                    <dx:NavBarItem NavigateUrl="alsofofEditor.aspx" Text="الصفوف">
                    </dx:NavBarItem>
                    <dx:NavBarItem NavigateUrl="type_progEditor.aspx" Text="المواد">
                    </dx:NavBarItem>
                    <dx:NavBarItem NavigateUrl="centerEditor.aspx" Text="مكتبة الدروس">
                    </dx:NavBarItem>
                    <dx:NavBarItem NavigateUrl="Qry001.aspx" Text=" استعلام عدد مرات التحميل">
                    </dx:NavBarItem>
                    <dx:NavBarItem NavigateUrl="Qry002.aspx" Text="اسماء الطلاب الذي  تم التحميل بواسطتهم">
                    </dx:NavBarItem>
                </Items>
            </dx:NavBarGroup>
        </Groups>
