<%@ Page Title="" Language="C#" MasterPageFile="masteruser.master" AutoEventWireup="true" CodeFile="Qry002.aspx.cs" Inherits="Qry002" %>
...
s.cpShowPopup = undefined;
                ...
                <Columns>
                    ...
                    <dx:GridViewDataTextColumn Caption="ملخص البرنامج" FieldName="name_prog" 
                        VisibleIndex="3">
                        <EditFormSettings ColumnSpan="2" />
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataHyperLinkColumn Caption="تفاصيل تحميل الملف" FieldName="id_prog" VisibleIndex="6">
                        <PropertiesHyperLinkEdit NavigateUrlFormatString="Qry002a.aspx?id={0}" TextFormatString="تفاصيل تحميل الملف">
