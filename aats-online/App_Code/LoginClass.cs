...
public class LoginClass
{
    ...
    public string LoginMethod()
    {
        ...
        if(IsAdmin==true)
            cmd.CommandText = "select * from TBLFriends where username=@UserName and pass=@Password and isadmin=true";
        else
            cmd.CommandText = "select * from TBLFriends where username=@UserName and pass=@Password";
