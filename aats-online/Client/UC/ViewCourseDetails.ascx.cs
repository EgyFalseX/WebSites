...
public partial class ViewCourseDetails : System.Web.UI.UserControl
{
    ...
    protected void SelectCource_Click(object sender, EventArgs e)
    {
        ...
        {
            Response.Redirect("http://aats-online.com/Client/ViewCourseDetails.aspx");
        }
        else
        {
            Response.Redirect("http://aats-online.com/Client/ViewCourseDetails.aspx?Courseitem=1&CourseId=" + RCB.SelectedValue);
        }
    }
    #endregion   
