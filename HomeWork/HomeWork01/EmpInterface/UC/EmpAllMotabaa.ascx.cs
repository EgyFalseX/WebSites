...
public partial class UserControls_EmpshowHWforAstudent : System.Web.UI.UserControl
{
    ...
    {
        gr_StudentMotaba.DataSource = Emp.GetAllMotabaa();
    ...
    protected void lblSTName_DataBinding(object sender, EventArgs e)
    {
        (sender as Label).Text = new Codes().StudentName(Convert.ToInt64((sender as Label).Text));
    }
}
