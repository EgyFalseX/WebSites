<%@ Page Title="" Language="C#" MasterPageFile="Master.master" AutoEventWireup="true" CodeFile="ViewHomeworkEn.aspx.cs" Inherits="ViewHomeworkEn" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <dx:ASPxGridView ID="ASPxGridView1" runat="server" AutoGenerateColumns="False" DataSourceID="DSData" EnableTheming="True" Theme="PlasticBlue" Font-Size="12pt" style="direction: rtl">
        <Columns>
            <dx:GridViewDataDateColumn Caption="Date" FieldName="add_date" SortIndex="0" SortOrder="Descending" VisibleIndex="1">
            </dx:GridViewDataDateColumn>
            <dx:GridViewDataTextColumn Caption="Grade" FieldName="fasl_name" VisibleIndex="2">
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn Caption="Class" FieldName="alsofof_name" VisibleIndex="3">
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataHyperLinkColumn Caption="Link" FieldName="id" VisibleIndex="5">
                <PropertiesHyperLinkEdit NavigateUrlFormatString="ViewDetails.aspx?id={0}" TextFormatString="عرض">
                </PropertiesHyperLinkEdit>
            </dx:GridViewDataHyperLinkColumn>
            <dx:GridViewDataCheckColumn Caption="Read" FieldName="read_code" VisibleIndex="0">
