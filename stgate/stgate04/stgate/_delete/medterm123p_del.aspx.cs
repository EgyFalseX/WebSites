...
public partial class medterm123p_del : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        DataTable userData = LoadDataTable(string.Format(@"SELECT [manth_code], [arabic], [math], [english], [englishe], [frensh], [deen], drasat, since, rsm, comp FROM [month_net] 
        ...
        lblrsm.Text = userData.Rows[0]["rsm"].ToString();
        lblcomp.Text = userData.Rows[0]["comp"].ToString();
    ...
    static string ConnectionString()
    {
        ...
        constr += sv.MapPath(@"data/3/Datanet.mdb");
        return constr;
    }
}