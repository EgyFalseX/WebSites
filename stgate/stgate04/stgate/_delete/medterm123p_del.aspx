<%@ Page Title="" Language="C#" MasterPageFile="~/stgate/masterst.master" AutoEventWireup="true" CodeFile="medterm123p_del.aspx.cs" Inherits="medterm123p_del" %>
            ...
            <td class="auto-style2">
                <dx:ASPxFormLayout ID="ASPxFormLayout1" runat="server" EnableTheming="True" Font-Bold="False" Font-Size="14pt" Theme="iOS" style="text-align: right">
                    <Items>
                        ...
                        <dx:LayoutItem Caption="Art">
                            <LayoutItemNestedControlCollection>
                                <dx:LayoutItemNestedControlContainer runat="server" SupportsDisabledAttribute="True">
                                    <dx:ASPxLabel ID="lblrsm" runat="server" Font-Size="14pt" Width="200px">
                                    </dx:ASPxLabel>
                                </dx:LayoutItemNestedControlContainer>
                            </LayoutItemNestedControlCollection>
                        </dx:LayoutItem>
                        <dx:LayoutItem Caption="Computer">
                            <LayoutItemNestedControlCollection>
                                <dx:LayoutItemNestedControlContainer runat="server" SupportsDisabledAttribute="True">
                                    <dx:ASPxLabel ID="lblcomp" runat="server" Font-Size="14pt" Width="200px">
                                    </dx:ASPxLabel>
                                </dx:LayoutItemNestedControlContainer>
                            </LayoutItemNestedControlCollection>
                        </dx:LayoutItem>
