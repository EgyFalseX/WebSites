<%@ Page Title="" Language="C#" MasterPageFile="~/stgate/masterst.master" AutoEventWireup="true" CodeFile="medterm46.aspx.cs" Inherits="medterm46" %>
            ...
            <td class="auto-style2">
                <dx:ASPxGridView ID="ASPxGridView1" runat="server" AutoGenerateColumns="False" DataSourceID="dsData" EnableTheming="True" Theme="iOS">
                    <Columns>
                        ...
                        <dx:GridViewDataTextColumn Caption="English Level" FieldName="englishe" VisibleIndex="6">
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="Frensh" FieldName="frensh" VisibleIndex="7">
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="Religion" FieldName="deen" VisibleIndex="8">
                        </dx:GridViewDataTextColumn>
                ...
                <asp:AccessDataSource ID="dsData" runat="server" DataFile="data/2/Datanet.mdb" SelectCommand="SELECT TOP 1 20 AS [manth_code], 20 AS [arabic], 20 AS [math], 20 AS [english], 20 AS drasat, 20 AS since, 20 AS [englishe], 20 AS [frensh], 20 AS [deen] FROM [month_net]
UNION 
SELECT [manth_code], [arabic], [math], [english], drasat, since, [englishe], [frensh], [deen] FROM [month_net] WHERE ([stu_code] = ?) AND (perm = TRUE)
">
                    <SelectParameters>
