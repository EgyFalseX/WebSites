<%@ Page Title="" Language="C#" MasterPageFile="master.master" AutoEventWireup="true" CodeFile="STBehaviorViewer.aspx.cs" Inherits="STBehaviorViewer" %>
    ...
    <tr>
        <td>
            <dx:ASPxGridView ID="GVEditor" runat="server" AutoGenerateColumns="False" 
                ...
                KeyFieldName="date" RightToLeft="True" CssFilePath="../App_Themes/PlasticBlue/{0}/styles.css" 
...
s.cpShowPopup = undefined;
                ...
                <Columns>
                    ...
                    <dx:GridViewDataDateColumn Caption="Behavior Date" FieldName="date" VisibleIndex="1">
                        <PropertiesDateEdit DisplayFormatString="d/M/yyyy">
                        </PropertiesDateEdit>
                    </dx:GridViewDataDateColumn>
                    <dx:GridViewDataTextColumn Caption="Remarks" FieldName="rems" VisibleIndex="3">
                        <PropertiesTextEdit DisplayFormatString="d/M/yyyy">
                        </PropertiesTextEdit>
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataComboBoxColumn Caption="Behavior" FieldName="colekeyat_code" VisibleIndex="2">
                        <PropertiesComboBox DataSourceID="DScolekeyat" TextField="colekeyat_name" ValueField="colekeyat_code">
                            <Columns>
            ...
            <asp:AccessDataSource ID="DSData" runat="server" 
                ...
                SelectCommand="SELECT colekeyat_code, [date], rems FROM stu_colekeyat WHERE (asase_code = (SELECT MAX(asase_code) AS Expr1 FROM student_t)) AND (stu_code = ?)">
                <SelectParameters>
