<%@ Page Title="" Language="C#" MasterPageFile="../masterst.master" AutoEventWireup="true" CodeFile="QBmawadEditor.aspx.cs" Inherits="QBmawadEditor" %>
        ...
        <tr>
            <td style="direction: ltr">
                <dx:aspxgridview id="GVEditor" runat="server" autogeneratecolumns="False" caption="البيــــــــــا نـــــــــــــــات"
                    datasourceid="DSData" keyfieldname="mawad_no" righttoleft="True" summarytext="الملخص"
...
s.cpShowPopup = undefined;
                ...
                <Columns>
                    ...
                    <dx:GridViewDataTextColumn VisibleIndex="2" Caption="المادة" FieldName="mowad_name">
                ...
                <asp:AccessDataSource ID="DSData" runat="server" DataFile="../data/QBank.mdb"
                    DeleteCommand="DELETE FROM [mawad] WHERE ([mawad_no] = ?) " InsertCommand="INSERT INTO [mawad] ([mawad_no], [mowad_name]) VALUES (?, ?)"
                    SelectCommand="SELECT [mawad_no], [mowad_name] FROM [mawad]"
                    UpdateCommand="UPDATE [mawad] SET [mowad_name] = ? WHERE ([mawad_no] = ?) ">
                    <DeleteParameters>
