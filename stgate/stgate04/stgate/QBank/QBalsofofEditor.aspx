<%@ Page Title="" Language="C#" MasterPageFile="../masterst.master" AutoEventWireup="true" CodeFile="QBalsofofEditor.aspx.cs" Inherits="QBalsofofEditor" %>
        ...
        <tr>
            <td style="direction: ltr">
                <dx:aspxgridview id="GVEditor" runat="server" autogeneratecolumns="False" caption="البيــــــــــا نـــــــــــــــات"
                    datasourceid="DSData" keyfieldname="alsofof_code" righttoleft="True" summarytext="الملخص"
                    cssfilepath="../App_Themes/PlasticBlue/{0}/styles.css"
                    csspostfix="PlasticBlue" enabletheming="True"
                    onrowdeleted="GVEditor_RowDeleted" onrowupdated="GVEditor_RowUpdated"
                    onrowinserted="GVEditor_RowInserted"
                    font-bold="True" enablecallbacks="False" OnRowInserting="GVEditor_RowInserting">
...
s.cpShowPopup = undefined;
                ...
                <Columns>
                    ...
                    <dx:GridViewDataTextColumn VisibleIndex="2" Caption="اسم الصف" FieldName="alsofof_name">
                ...
                <asp:AccessDataSource ID="DSData" runat="server" DataFile="../data/QBank.mdb"
                    DeleteCommand="DELETE FROM [alsofof] WHERE [alsofof_code] = ?" InsertCommand="INSERT INTO [alsofof] ([alsofof_code], [alsofof_name], [marhala_code]) VALUES (?, ?, ?)"
                    SelectCommand="SELECT [alsofof_code], [alsofof_name], [marhala_code] FROM [alsofof]"
                    UpdateCommand="UPDATE [alsofof] SET [alsofof_name] = ?, [marhala_code] = ? WHERE [alsofof_code] = ?">
                    <DeleteParameters>
