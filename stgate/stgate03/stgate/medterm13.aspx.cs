...
public partial class medterm13 : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        DataTable userData = LoadDataTable(string.Format(@"SELECT [manth_code], [arabic], [math], [english], [englishe], [frensh], [deen] FROM [month_net] 
