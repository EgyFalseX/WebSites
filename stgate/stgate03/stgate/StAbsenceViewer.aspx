<%@ Page Title="" Language="C#" MasterPageFile="master.master" AutoEventWireup="true" CodeFile="StAbsenceViewer.aspx.cs" Inherits="StAbsenceViewer" %>
    ...
    <tr>
        <td>
            <dx:ASPxGridView ID="GVEditor" runat="server" AutoGenerateColumns="False" 
                ...
                KeyFieldName="eyab_date_from" RightToLeft="True" CssFilePath="../App_Themes/PlasticBlue/{0}/styles.css" 
...
s.cpShowPopup = undefined;
                ...
                <Columns>
                    <dx:GridViewCommandColumn ButtonType="Image" Caption="العمليات" 
                        VisibleIndex="2" Width="120px" Visible="False">
                    ...
                    <dx:GridViewDataDateColumn Caption="Absence From" FieldName="eyab_date_from" VisibleIndex="0">
                        <PropertiesDateEdit DisplayFormatString="d/M/yyyy">
                        </PropertiesDateEdit>
                    </dx:GridViewDataDateColumn>
                    <dx:GridViewDataDateColumn Caption="Absence To" FieldName="eyab_date_to" VisibleIndex="1">
                        <PropertiesDateEdit DisplayFormatString="d/M/yyyy">
                        </PropertiesDateEdit>
                    </dx:GridViewDataDateColumn>
                </Columns>
            ...
            <asp:AccessDataSource ID="DSData" runat="server" 
                ...
                SelectCommand="SELECT eyab_date_from, asase_code, eyab_code, eyab_date_to FROM stu_eyab WHERE (asase_code = (SELECT MAX(asase_code) AS Expr1 FROM student_t)) AND (stu_code = ?)">
                <SelectParameters>
