...
public partial class ResultXViewer : System.Web.UI.Page
{
    ...
    protected void btnView_Click(object sender, EventArgs e)
    {
        ...
        if (cbSaf.Value.ToString() == "3" || cbSaf.Value.ToString() == "4" || cbSaf.Value.ToString() == "5")
        {
            LoadResult1();
        }
        else if (cbSaf.Value.ToString() == "6" || cbSaf.Value.ToString() == "7" || cbSaf.Value.ToString() == "8")
        {
            LoadResult2();
        }
    ...
    private void LoadResult1()
    {
        ...
        qmid.falsafa, qmid.kemea_level FROM qmid WHERE asase_code = {0} AND alsofof_code = {1} AND gloos = {2}", asase_code, Saf, Gloos), DatabasePath);
