...
public partial class StLogin_ : Page
{
    ...
    protected void BtnLogin_Click(object sender, EventArgs e)
    {
        ...
        DataTable userData = LoadDataTable(string.Format(@"SELECT stu_code, user_name, [pass]
        FROM student WHERE (user_name = '{0}') AND ([pass] = '{1}')", TxtUserName.Text, TxtPassword.Text), false);
