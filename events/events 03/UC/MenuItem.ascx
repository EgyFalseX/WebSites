    ...
    <tr>
        <td>
            <dx:ASPxGridView ID="GVEditor" runat="server" AutoGenerateColumns="False" Caption="البيــــــــــا نـــــــــــــــات"
                ...
                Font-Bold="True" EnableCallBacks="False" OnCellEditorInitialize="GVEditor_CellEditorInitialize">
...
s.cpShowPopup = undefined;
                ...
                <Columns>
                    ...
                    <dx:GridViewDataTextColumn Caption="مسار الصورة" FieldName="ItemPic" VisibleIndex="11"
                        Name="ItemPic">
                        <DataItemTemplate>
...
{2}" NotAllowedFileExtensionErrorText="امتداد الملف غير مسموح به">
                    ...
                    <dx:GridViewDataMemoColumn Caption="ملخص" FieldName="ItemInfo" VisibleIndex="13">
                    ...
                    <dx:GridViewDataTextColumn VisibleIndex="15"
                        ...
                        <EditFormSettings Caption="مسار ملف" CaptionLocation="Top" ColumnSpan="2" />
                        <EditItemTemplate>
                            <dx:ASPxUploadControl ID="UCFile" runat="server" CssFilePath="../App_Themes/PlasticBlue/{0}/styles.css"
                                CssPostfix="PlasticBlue" OnFileUploadComplete="UCFile_FileUploadComplete" ShowProgressPanel="True"
                                ShowUploadButton="True" SpriteCssFilePath="../App_Themes/PlasticBlue/{0}/sprite.css"
                                Width="280px">
...
{2}" NotAllowedFileExtensionErrorText="امتداد الملف غير مسموح به">
  ...
  _aspxGetElementById('lblPath').innerHTML = e.callbackData;
                    ...
                    <dx:GridViewDataCheckColumn Caption="اظهار / اخفاء" FieldName="showonline" VisibleIndex="18">
            ...
            <asp:AccessDataSource ID="DSData" runat="server" DataFile="../App_Data/events.mdb"
                DeleteCommand="DELETE FROM [MenuItem] WHERE [ItemID] = ?" InsertCommand="INSERT INTO [MenuItem] ([ItemName], [Itemtypeid], [LagnaId], [Itemdatestart], [Itemdateend], [Show_Hide], [Data_Path], [ItemInfo], [ItemPic], [showonline]) VALUES (@ItemName, @Itemtypeid, @LagnaId, @Itemdatestart, @Itemdateend, @Show_Hide, @Data_Path, @ItemInfo, @ItemPic, @showonline)"
                SelectCommand="SELECT [ItemID], [ItemName], [Itemtypeid], [LagnaId], [Itemdatestart], [Itemdateend], [Show_Hide], [Data_Path], [ItemInfo], [ItemPic], [showonline] FROM [MenuItem]
order by ItemID desc"
                UpdateCommand="UPDATE MenuItem SET ItemName = @ItemName, Itemtypeid = @Itemtypeid, LagnaId = @LagnaId, Itemdatestart = @Itemdatestart, Itemdateend = @Itemdateend, Show_Hide = @Show_Hide, Data_Path = @Data_Path, ItemInfo = @ItemInfo, ItemPic = @ItemPic, showonline = @showonline WHERE (ItemID = @ItemID)">
                <DeleteParameters>
                ...
                <InsertParameters>
                    ...
                    <asp:Parameter Name="showonline" />
                </InsertParameters>
                <UpdateParameters>
                    <asp:Parameter Name="ItemName" />
                    <asp:Parameter Name="Itemtypeid" />
                    <asp:Parameter Name="LagnaId" />
                    <asp:Parameter Name="Itemdatestart" />
                    <asp:Parameter Name="Itemdateend" />
                    <asp:Parameter Name="Show_Hide" />
                    <asp:Parameter Name="Data_Path" />
                    <asp:Parameter Name="ItemInfo" />
                    <asp:Parameter Name="ItemPic" />
                    <asp:Parameter Name="showonline" />
