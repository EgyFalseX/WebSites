<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ViewMenu_s.ascx.cs" Inherits="ViewMenu" %>
...
<img class="style2" src="http://ets.eg/IMG/banara.jpg" /></td>
    </tr>
    <tr>
        <td style="text-align: center">
            <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/Indexa.htm" 
