...
<dx:ASPxDataView ID="ASPxDataViewViewer" runat="server" 
    ...
    style="text-align: center" DataSourceID="DSData" ColumnCount="2">
    <ItemTemplate>
        <table cellspacing="0" class="rlvEditTable" dir="rtl" 
            style="height: 364px; width: 380px;">
            <tr>
            ...
            <tr>
                <td align="right" class="style3" colspan="3" style="text-align: center" 
                    ...
                    <asp:Image ID="img" runat="server" BackColor="White" BorderColor="White" 
                        ...
                        ImageUrl='<%# Eval("ItemPic", "../Files/img/{0}") %>' Width="150px" />
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td class="style4" valign="top">
                    <asp:Label ID="lblLagnaName" runat="server" Text='<%# Eval("LagnaName") %>'></asp:Label>
                </td>
            </tr>
            <tr>
                <td align="right" valign="top">
                ...
                <td class="style4" valign="top">
                    <asp:Label ID="lblItemdatestart" runat="server" 
                        Text='<%# Eval("Itemdatestart", "{0:dd/MM/yyyy}") %>'></asp:Label>
                </td>
            </tr>
            <tr>
                <td align="right" valign="top">
                ...
                <td class="style4" valign="top">
                    <asp:Label ID="lblItemdateend" runat="server" 
                        Text='<%# Eval("Itemdateend", "{0:dd/MM/yyyy}") %>'></asp:Label>
                </td>
            </tr>
            <tr>
                <td align="right" valign="top">
                ...
                <td class="style4" valign="top">
                    <asp:Label ID="lblItemInfo" runat="server" Text='<%# Eval("ItemInfo") %>'></asp:Label>
                </td>
            </tr>
            <tr>
                <td align="right" valign="top">
    ...
    <DisabledStyle ForeColor="#B1B1B8">
            ...
            <asp:AccessDataSource ID="DSData" runat="server" DataFile="../App_Data/events.mdb" 
                SelectCommand="SELECT [ItemID], [ItemName], [Itemtypeid], [LagnaId], [Itemdatestart], [Itemdateend], [ItemInfo], [ItemPic],
