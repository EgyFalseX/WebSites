<%@ Control Language="C#" AutoEventWireup="true" CodeFile="addata.ascx.cs" Inherits="addata" %>
...
s.cpShowPopup = undefined;
                ...
                <Columns>
                    ...
                    <dx:GridViewDataCheckColumn Caption="مدير" FieldName="seeall" VisibleIndex="3">
            ...
            <asp:AccessDataSource ID="DSData" runat="server" DataFile="../App_Data/events.mdb" 
                DeleteCommand="DELETE FROM [addata] WHERE [id] = ?" 
                InsertCommand="INSERT INTO [addata] ([user], [pass], [LagnaId], [seeall]) VALUES (?, ?, ?, ?)" 
                SelectCommand="SELECT [id], [user], [pass], [LagnaId], [seeall] FROM [addata]" 
                ...
                UpdateCommand="UPDATE [addata] SET [user] = ?, [pass] = ?, [LagnaId] = ?, [seeall] = ? WHERE [id] = ?">
                <DeleteParameters>
                ...
                <InsertParameters>
                    ...
                    <asp:Parameter Name="seeall" Type="Boolean" />
                </InsertParameters>
                <UpdateParameters>
                    <asp:Parameter Name="user" Type="String" />
                    <asp:Parameter Name="pass" Type="String" />
