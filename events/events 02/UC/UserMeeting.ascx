<%@ Control Language="C#" AutoEventWireup="true" CodeFile="UserMeeting.ascx.cs" Inherits="UserMeeting" %>
...
s.cpShowPopup = undefined;
            ...
            <asp:AccessDataSource ID="DSaddata" runat="server" DataFile="../App_Data/events.mdb" 
