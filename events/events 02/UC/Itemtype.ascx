<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Itemtype.ascx.cs" Inherits="Itemtype" %>
    ...
    <tr>
        <td>
            <dx:ASPxGridView ID="GVEditor" runat="server" AutoGenerateColumns="False" 
                ...
                KeyFieldName="Itemtypeid" RightToLeft="True" 
...
s.cpShowPopup = undefined;
                ...
                <Columns>
                    ...
                    <dx:GridViewDataTextColumn Caption="اسم الفاعليه او الحدث" FieldName="Itemtype" 
                        VisibleIndex="1">
            ...
            <asp:AccessDataSource ID="DSData" runat="server" DataFile="../App_Data/events.mdb" 
                DeleteCommand="DELETE FROM [Itemtype] WHERE Itemtypeid = ?" 
                InsertCommand="INSERT INTO [Itemtype] ([Itemtype]) VALUES (?)" 
                SelectCommand="SELECT [Itemtypeid], [Itemtype] FROM [Itemtype]" 
                ...
                UpdateCommand="UPDATE [Itemtype] SET [Itemtype] = ? WHERE Itemtypeid = ?">
                <DeleteParameters>
