<%@ Page Title="" Language="C#" MasterPageFile="master.master" AutoEventWireup="true" CodeFile="CDdept.aspx.cs" Inherits="CDdept" %>
        ...
        <tr>
            <td>
                <dx:ASPxGridView ID="GVEditor" runat="server" AutoGenerateColumns="False"
                    ...
                    KeyFieldName="deptId" RightToLeft="True"
...
s.cpShowPopup = undefined;
                    ...
                    <Columns>
                        ...
                        <dx:GridViewDataTextColumn Caption="اسم الجهة" FieldName="deptName"
                            VisibleIndex="1">
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataCheckColumn Caption="مدير نظام" FieldName="isadmin" VisibleIndex="2">
                ...
                <asp:AccessDataSource ID="DSData" runat="server" DataFile="~/App_Data/Maintenance.mdb"
                    DeleteCommand="DELETE FROM [CDdept] WHERE [deptId] = ?" InsertCommand="INSERT INTO [CDdept] ([deptId], [deptName], [isadmin]) VALUES (?, ?, ?)"
                    SelectCommand="SELECT [deptId], [deptName], [isadmin] FROM [CDdept]"
                    UpdateCommand="UPDATE [CDdept] SET [deptName] = ?, [isadmin] = ? WHERE [deptId] = ?" OnInserting="DSData_Inserting">
                    <DeleteParameters>
