...
s.cpShowPopup = undefined;
                    ...
                    <Columns>
                        ...
                        <dx:GridViewDataTextColumn Caption="الاسم" FieldName="realname"
                            VisibleIndex="2">
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataCheckColumn Caption="نشط" FieldName="IsActive" VisibleIndex="7">
                        </dx:GridViewDataCheckColumn>
                        <dx:GridViewDataTextColumn Caption="موبيل" FieldName="mobil" VisibleIndex="3">
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="ايميل" FieldName="umail" VisibleIndex="4">
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="اسم المستخدم" FieldName="UserName" VisibleIndex="5">
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="كلمة المرو" FieldName="Password" VisibleIndex="6">
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataComboBoxColumn Caption="الجهة" FieldName="deptId" VisibleIndex="1">
                ...
                <asp:AccessDataSource ID="DSData" runat="server" DataFile="~/App_Data/Maintenance.mdb"
                    DeleteCommand="DELETE FROM [Users] WHERE [UserID] = ?" InsertCommand="INSERT INTO [Users] ([UserID], [UserName], [Password], [IsActive], [realname], [mobil], [umail], [deptId]) VALUES (?, ?, ?, ?, ?, ?, ?, ?)"
                    SelectCommand="SELECT [UserID], [UserName], [Password], [IsActive], [realname], [mobil], [umail], [deptId] FROM [Users]"
                    UpdateCommand="UPDATE [Users] SET [UserName] = ?, [Password] = ?, [IsActive] = ?, [realname] = ?, [mobil] = ?, [umail] = ?, [deptId] = ? WHERE [UserID] = ?" OnInserting="DSData_Inserting">
                    <DeleteParameters>
                ...
                <asp:AccessDataSource ID="DSCDdept" runat="server" DataFile="~/App_Data/Maintenance.mdb"
                    SelectCommand="SELECT [deptId], [deptName] FROM [CDdept]" OnInserting="DSData_Inserting">
                </asp:AccessDataSource>
            </td>
        </tr>
    </table>
