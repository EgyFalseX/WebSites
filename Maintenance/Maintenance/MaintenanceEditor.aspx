<%@ Page Title="" Language="C#" MasterPageFile="master.master" AutoEventWireup="true" CodeFile="MaintenanceEditor.aspx.cs" Inherits="MaintenanceEditor" %>
...
s.cpShowPopup = undefined;
                ...
                <asp:AccessDataSource ID="DSData" runat="server" DataFile="~/App_Data/Maintenance.mdb"
                    SelectCommand="SELECT Maintenance.MaintenanceId, Maintenance.MaintenanceDate, Maintenance.maddres, Maintenance.mclosed, Users.realname, Maintenance.read_code FROM (Maintenance LEFT OUTER JOIN Users ON Maintenance.UserID = Users.UserID) WHERE (Maintenance.todeptId = ?)" OnInserting="DSData_Inserting" OnSelecting="DSData_Selecting">
                    <SelectParameters>
                        <asp:SessionParameter DefaultValue="-1" Name="?" SessionField="deptIdMaintenance" />
                    </SelectParameters>
