<%@ Page Title="" Language="C#" MasterPageFile="master.master" AutoEventWireup="true" CodeFile="emp.aspx.cs" Inherits="emp" %>
...
s.cpShowPopup = undefined;
                    ...
                    <Columns>
                        ...
                        <dx:GridViewDataTextColumn Caption="اسم الموظف" FieldName="empname"
                            VisibleIndex="1">
                ...
                <asp:AccessDataSource ID="DSData" runat="server" DataFile="~/App_Data/adaa.mdb"
                    DeleteCommand="DELETE FROM [emp] WHERE ([empid] = ?)" InsertCommand="INSERT INTO [emp] ([empid], [empname]) VALUES (?, ?)"
                    SelectCommand="SELECT [empid], [empname] FROM [emp]"
                    UpdateCommand="UPDATE [emp] SET [empname] = ? WHERE ([empid] = ?)" OnInserting="DSData_Inserting">
                    <DeleteParameters>
