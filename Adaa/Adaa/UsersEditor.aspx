...
s.cpShowPopup = undefined;
                ...
                <asp:AccessDataSource ID="DSData" runat="server" DataFile="~/App_Data/adaa.mdb"
                    DeleteCommand="DELETE FROM [Users] WHERE [UserID] = ?" InsertCommand="INSERT INTO [Users] ([UserID], [UserName], [Password], [IsAdmin]) VALUES (?, ?, ?, ?)"
                    SelectCommand="SELECT [UserID], [UserName], [Password], [IsAdmin] FROM [Users]"
                    UpdateCommand="UPDATE [Users] SET [UserName] = ?, [Password] = ?, [IsAdmin] = ? WHERE [UserID] = ?" OnInserting="DSData_Inserting">
                    <DeleteParameters>
