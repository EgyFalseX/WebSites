<%@ Page Title="" Language="C#" MasterPageFile="master.master" AutoEventWireup="true" CodeFile="Cdreporttype.aspx.cs" Inherits="Cdreporttype" %>
        ...
        <tr>
            <td>
                <dx:ASPxGridView ID="GVEditor" runat="server" AutoGenerateColumns="False"
                    ...
                    KeyFieldName="reporttypeid" RightToLeft="True"
...
s.cpShowPopup = undefined;
                    ...
                    <Columns>
                        ...
                        <dx:GridViewDataTextColumn Caption="اسم نوع المتابعة" FieldName="reporttype"
                            VisibleIndex="1">
                ...
                <asp:AccessDataSource ID="DSData" runat="server" DataFile="~/App_Data/adaa.mdb"
                    DeleteCommand="DELETE FROM [Cdreporttype] WHERE [reporttypeid] = ?" InsertCommand="INSERT INTO [Cdreporttype] ([reporttypeid], [reporttype]) VALUES (?, ?)"
                    SelectCommand="SELECT [reporttypeid], [reporttype] FROM [Cdreporttype]"
                    UpdateCommand="UPDATE [Cdreporttype] SET [reporttype] = ? WHERE ([reporttypeid] = ?)" OnInserting="DSData_Inserting">
                    <DeleteParameters>
