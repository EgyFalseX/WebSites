<%@ Control Language="C#" AutoEventWireup="true" CodeFile="CDGovEditor.ascx.cs" Inherits="CDGovEditor" %>
...
s.cpShowPopup = undefined;
                ...
                <Columns>
                    ...
                    <dx:GridViewDataTextColumn Caption="المحافظة" FieldName="Gov" 
                        VisibleIndex="1">
            ...
            <asp:SqlDataSource ID="DSData" runat="server" 
                ...
                DeleteCommand="DELETE FROM [CDGov] WHERE [GovId] = @GovId" InsertCommand="INSERT INTO [CDGov] ([GovId], [Gov]) 
VALUES 
((select ISNULL(MAX(GovId) + 1, 1) from CDGov), @Gov)" 
                ...
                UpdateCommand="UPDATE [CDGov] SET [Gov] = @Gov WHERE [GovId] = @GovId">
                <DeleteParameters>
