<%@ Control Language="C#" AutoEventWireup="true" CodeFile="CDSubCommitteEditor.ascx.cs" Inherits="CDSubCommitteEditor" %>
...
s.cpShowPopup = undefined;
                ...
                <Columns>
                    ...
                    <dx:GridViewDataTextColumn Caption="اللجنة النقابية" FieldName="SubCommitte" 
                        VisibleIndex="1">
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataComboBoxColumn Caption="اسم النقابة" FieldName="SyndicateId" 
                        VisibleIndex="2">
                        <PropertiesComboBox DataSourceID="DSCDSyndicate" TextField="Syndicate" ValueField="SyndicateId" 
                            ValueType="System.Int32">
                            <Columns>
                                <dx:ListBoxColumn Caption="المحافظه" FieldName="Gov" />
                            </Columns>
                        </PropertiesComboBox>
            ...
            <asp:SqlDataSource ID="DSData" runat="server" 
                ...
                DeleteCommand="DELETE FROM [CDSubCommitte] WHERE [SubCommitteId] = @SubCommitteId" InsertCommand="INSERT INTO [CDSubCommitte] ([SubCommitteId], [SubCommitte], [SyndicateId]) VALUES (@SubCommitteId, @SubCommitte, @SyndicateId)" 
                ProviderName="<%$ ConnectionStrings:ETSDATAConnectionString.ProviderName %>" 
                SelectCommand="SELECT        SubCommitteId, SubCommitte, SyndicateId
FROM            CDSubCommitte
WHERE        EXISTS
                             (SELECT        SyndicateId
                                FROM            Users
                ...
                UpdateCommand="UPDATE [CDSubCommitte] SET [SubCommitte] = @SubCommitte, [SyndicateId] = @SyndicateId WHERE [SubCommitteId] = @SubCommitteId">
                <DeleteParameters>
