<%@ Control Language="C#" AutoEventWireup="true" CodeFile="RolesEditor.ascx.cs" Inherits="RolesEditor" %>
...
s.cpShowPopup = undefined;
                ...
                <Columns>
                    ...
                    <dx:GridViewDataTextColumn Caption="اسم المجموعة" FieldName="RoleName" 
                        VisibleIndex="1">
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataMemoColumn Caption="وصف المجموعة" FieldName="RoleDesc" 
                        VisibleIndex="2">
            ...
            <asp:SqlDataSource ID="DSData" runat="server" 
                ...
                DeleteCommand="DELETE FROM [Roles] WHERE [RoleID] = @RoleID" InsertCommand="INSERT INTO [Roles] ([RoleID], [RoleName], [RoleDesc]) 
VALUES 
((select ISNULL(MAX(RoleID) + 1, 1) from Roles), @RoleName, @RoleDesc)" 
                ...
                UpdateCommand="UPDATE [Roles] SET [RoleName] = @RoleName, [RoleDesc] = @RoleDesc WHERE [RoleID] = @RoleID">
                <DeleteParameters>
                ...
                <UpdateParameters>
                    <asp:Parameter Name="RoleName" Type="String" />
                    <asp:Parameter Name="RoleDesc" Type="Byte" />
