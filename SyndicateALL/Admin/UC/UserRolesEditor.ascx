<%@ Control Language="C#" AutoEventWireup="true" CodeFile="UserRolesEditor.ascx.cs" Inherits="UserRolesEditor" %>
...
s.cpShowPopup = undefined;
                ...
                <Columns>
                    ...
                    <dx:GridViewDataComboBoxColumn Caption="المستخدم" FieldName="UserId" 
                        VisibleIndex="2">
                        <PropertiesComboBox DataSourceID="DSUsers" TextField="UserName" 
                            ValueField="UserID" ValueType="System.Int32">
                            <Columns>
                                <dx:ListBoxColumn Caption="اسم المستخدم" FieldName="UserName" />
                            </Columns>
                        </PropertiesComboBox>
                    </dx:GridViewDataComboBoxColumn>
                    <dx:GridViewDataComboBoxColumn Caption="المجموعه" FieldName="RoleId" 
                        VisibleIndex="3">
                        <PropertiesComboBox DataSourceID="DSRoles" TextField="RoleName" 
                            ValueField="RoleID" ValueType="System.Int32">
                            <Columns>
                                <dx:ListBoxColumn Caption="اسم المجموعه" FieldName="RoleName" />
                            </Columns>
                        </PropertiesComboBox>
                    </dx:GridViewDataComboBoxColumn>
                </Columns>
            ...
            <asp:SqlDataSource ID="DSData" runat="server" 
                ...
                DeleteCommand="DELETE FROM [UserRoles] WHERE [UserId] = @original_UserId AND [RoleId] = @original_RoleId" InsertCommand="INSERT INTO [UserRoles] ([UserId], [RoleId]) VALUES (@UserId, @RoleId)" 
                ProviderName="<%$ ConnectionStrings:ETSDATAConnectionString.ProviderName %>" 
                SelectCommand="SELECT [UserId], [RoleId] FROM [UserRoles]" 
                UpdateCommand="UPDATE       UserRoles
SET                UserId = @UserId , RoleId = @RoleId 
WHERE UserId = @original_UserId AND RoleId = @original_RoleId" 
