<%@ Control Language="C#" AutoEventWireup="true" CodeFile="CDSyndicateEditor.ascx.cs" Inherits="CDSyndicateEditor" %>
...
s.cpShowPopup = undefined;
                ...
                <Columns>
                    ...
                    <dx:GridViewDataTextColumn Caption="اسم النقابة" FieldName="Syndicate" 
                        VisibleIndex="1">
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataComboBoxColumn Caption="المحافظة" FieldName="GOVID" 
                        VisibleIndex="2">
                        <PropertiesComboBox DataSourceID="DSCDGov" TextField="Gov" ValueField="GovId" 
            ...
            <asp:SqlDataSource ID="DSData" runat="server" 
                ...
                DeleteCommand="DELETE FROM [CDSyndicate] WHERE [SyndicateId] = @SyndicateId" InsertCommand="INSERT INTO [CDSyndicate] ([SyndicateId], [Syndicate], [GOVID]) 
VALUES
((select ISNULL(MAX(SyndicateId) + 1, 1) from CDSyndicate), @Syndicate, @GOVID)" 
                ProviderName="<%$ ConnectionStrings:ETSDATAConnectionString.ProviderName %>" 
                SelectCommand="SELECT [SyndicateId], [Syndicate], [GOVID] FROM [CDSyndicate]" 
                
                UpdateCommand="UPDATE [CDSyndicate] SET [Syndicate] = @Syndicate, [GOVID] = @GOVID WHERE [SyndicateId] = @SyndicateId">
                <DeleteParameters>
                    <asp:Parameter Name="SyndicateId" Type="Int32" />
                </DeleteParameters>
                <InsertParameters>
                    <asp:Parameter Name="Syndicate" Type="String" />
            ...
            <asp:SqlDataSource ID="DSCDGov" runat="server" 
                ConnectionString="<%$ ConnectionStrings:ETSDATAConnectionString %>" 
                ProviderName="<%$ ConnectionStrings:ETSDATAConnectionString.ProviderName %>" 
