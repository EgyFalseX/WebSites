...
public class mcETSMobile
{
     ...
     public static string EtsMobileConnectionstring
    {
        get
        {
            return System.Configuration.ConfigurationManager.ConnectionStrings["ETSMOBILEConnectionString"].ToString();
        }
    }

    public static string ExcelFiles = "~/App_Data/ExcelFiles/";
