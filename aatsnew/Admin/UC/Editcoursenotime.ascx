<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Editcoursenotime.ascx.cs" Inherits="Editcoursenotime" %>
<style type="text/css">
    .style1
    {
        width: 600px;
...
<DatePopupButton ImageUrl="" HoverImageUrl=""></DatePopupButton>
        ...
        <tr>
            <td class="style2">
                &nbsp;</td>
            <td>
                <asp:CheckBox ID="cbShowOnline" runat="server" Checked="True" Text="يعرض" />
            </td>
        </tr>
        <tr>
            <td class="style2">
        ...
        <tr>
            <td class="style3">
                &nbsp;</td>
            <td class="style4">
                <asp:HyperLink ID="HLReservation" runat="server" Font-Bold="True" ForeColor="Blue" 
                    NavigateUrl="../Reservation.aspx">تفاصيل الحجز</asp:HyperLink>
            </td>
        </tr>
        <tr>
            <td class="style2">
...
<DatePopupButton ImageUrl="" HoverImageUrl=""></DatePopupButton>
        ...
        <tr>
            <td class="style2">
                &nbsp;</td>
            <td>
                <asp:CheckBox ID="cbShowOnlineEdit" runat="server" Checked="True" Text="يعرض" />
            </td>
        </tr>
        <tr>
            <td class="style2">
