                ...
                <telerik:RadGrid ID="RadGridEdit" GridLines="None" runat="server" 
                    ...
                    <MasterTableView CommandItemDisplay="TopAndBottom" DataKeyNames="CourseId" HorizontalAlign="NotSet"
                        ...
                        <Columns>
                            ...
                            <telerik:GridDateTimeColumn DataField="StartDate" 
                                DataFormatString="{0:d/M/yyyy}" DataType="System.DateTime" 
                                FilterControlAltText="Filter StartDate column" HeaderText="تاريخ البداية" 
                                SortExpression="StartDate" UniqueName="StartDate" 
                                EditDataFormatString="d/M/yyyy">
                                <HeaderStyle HorizontalAlign="Center" />
                                <ItemStyle HorizontalAlign="Center" />
                            </telerik:GridDateTimeColumn>
                            <telerik:GridDateTimeColumn DataField="EndDate" DataFormatString="{0:d/M/yyyy}" 
                                DataType="System.DateTime" FilterControlAltText="Filter EndDate column" 
                            ...
                            <telerik:GridHyperLinkColumn DataTextField="الحجز" 
                                ...
                                UniqueName="column1" DataNavigateUrlFormatString="../EditTrainee.aspx" 
                            ...
                            <telerik:GridHyperLinkColumn DataTextField="السداد" 
                                ...
                                UniqueName="column2" DataNavigateUrlFormatString="../ViewTraineesdd.aspx" 
                                DataNavigateUrlFields="CourseId">
                                <HeaderStyle HorizontalAlign="Center" />
                                <ItemStyle HorizontalAlign="Center" />
                            </telerik:GridHyperLinkColumn>
