<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ViewCourseNoTimeDetailsViewer.ascx.cs" Inherits="ViewCourseNoTimeDetailsViewer" %>
<style type="text/css">
    .style1
    {
        width: 748px;
...
<table align="center" style="width: 899px; height: 44px;">
    <tr>
