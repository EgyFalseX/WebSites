    ...
    <tr>
        <td>
            ...
            <telerik:RadAjaxPanel ID="RadAjaxPanelEdit" runat="server">
                ...
                <telerik:RadGrid ID="RadGridEdit" GridLines="None" runat="server" 
                    ...
                    <MasterTableView CommandItemDisplay="TopAndBottom" DataKeyNames="TraineeID" HorizontalAlign="NotSet" 
                        ...
                        <Columns>
                            <telerik:GridDropDownColumn DataField="CourseId" DataSourceID="DSTBLCourses" 
                                DataType="System.Int32" EnableEmptyListItem="True" 
                                FilterControlAltText="Filter CourseId column" HeaderText="اسم الدوره" 
                                ListTextField="CourseName" ListValueField="CourseId" SortExpression="CourseId" 
                                UniqueName="CourseId" Display="False" Visible="False">
                            ...
                            <telerik:GridDropDownColumn DataField="sdd" DataSourceID="DStd_starting1" 
                                DataType="System.Int32" Display="False" 
                                FilterControlAltText="Filter sdd column" HeaderText="سدد" 
                                ListTextField="name_starting" ListValueField="id_starting" SortExpression="sdd" 
                                UniqueName="sdd">
                                <HeaderStyle HorizontalAlign="Center" />
                                <ItemStyle HorizontalAlign="Center" />
                            </telerik:GridDropDownColumn>
                            <telerik:GridBoundColumn DataField="name_starting" 
                                FilterControlAltText="Filter name_starting column" HeaderText="سدد" 
                                ReadOnly="True" SortExpression="name_starting" UniqueName="name_starting">
                                <HeaderStyle HorizontalAlign="Center" />
                                <ItemStyle HorizontalAlign="Center" />
                            </telerik:GridBoundColumn>
            ...
            <asp:AccessDataSource ID="DSData"
                ...
                InsertCommand="INSERT INTO [TBLTrainee] ([TraineeID], [TraineeName], [NationalityId], [Mobile], [Email], [Address], [mony], [accname], [countryId], [CourseId], [TimeIn], sdd, City) 
                VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, NOW(), ?, ?)" 
                SelectCommand="SELECT [TraineeID], [TraineeName],
[NationalityId], 
[Mobile], [Email], [Address], [TimeIn], [mony], [accname],
[countryId], CourseId, sdd,City,
(Select name_starting From td_starting1 Where id_starting = TBLTrainee.sdd) AS name_starting ,
...
(Select Nationality From CdNationality Where NationalityId = TBLTrainee.NationalityId) AS Nationality
 FROM [TBLTrainee] order by TimeIn desc
" 
                
                UpdateCommand="UPDATE [TBLTrainee] SET [TraineeName] = ?, [NationalityId] = ?, [Mobile] = ?, [Email] = ?, [Address] = ?, [mony] = ?, [accname] = ?, [countryId] = ?, [CourseId] = ?, sdd = ?, City = ? WHERE [TraineeID] = ?" 
