...
public partial class Reservation : System.Web.UI.UserControl
{
    ...
    protected void RBtnSend_Click(object sender, EventArgs e)
    {
        ...
        //    return;
        //}
        string ResultMsg = DB.InsertTBLTraineenotime(RTxtTraineeName.Text, RTxtNameInEnglish.Text, RCBNationalityId.SelectedValue, RCBcountryId.SelectedValue, RTxtCity.Text, RTxtAddress.Text, RTxttel.Text, RTxtMobile.Text, RTxtEmail.Text
