    ...
    <tr>
        <td valign="top">
            ...
            <telerik:RadAjaxPanel ID="RadAjaxPanelEdit" runat="server">
                ...
                <div id="FrmEditor">
                    <table align="center" class="style1" border="0.9">
                        <tr>
                            <td style="direction: rtl" class="style8">
                                <telerik:RadComboBox ID="RCBCourseId" runat="server" AutoPostBack="True" DataSourceID="DSMenuItem" DataTextField="CourseName" DataValueField="CourseId" TabIndex="2" Width="203px">
                                </telerik:RadComboBox>
                            </td>
                        ...
                        <tr>
                            <td class="style8" colspan="2" style="direction: rtl; text-align: center;">
                                <telerik:RadButton ID="RBtnSend" runat="server" OnClick="RBtnSend_Click" TabIndex="11" Text="ارســـال">
                                </telerik:RadButton>
                                <telerik:RadButton ID="RBtnClear" runat="server" OnClick="RBtnClear_Click" TabIndex="12" Text="مســـــح" Visible="False">
                                </telerik:RadButton>
                            </td>
                            <td style="direction: rtl">&nbsp;</td>
                        </tr>
                                ...
                                <table align="center" class="style3">
                                    <tr>
                                        <td class="auto-style1">
                                            <asp:RequiredFieldValidator ID="VRTxtTraineeName0" runat="server" ControlToValidate="RTxtTraineeName" ErrorMessage="ادخل اسمك بالعربيه " Font-Bold="True" ForeColor="Red"></asp:RequiredFieldValidator>
                                        </td>
                                        <td class="auto-style1">
                                            <asp:RequiredFieldValidator ID="VRTxtNameInEnglish" runat="server" ControlToValidate="RTxtNameInEnglish" ErrorMessage="ادخل اسمك بالانجليزيه" Font-Bold="True" ForeColor="Red"></asp:RequiredFieldValidator>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="style6">
                                            <asp:RequiredFieldValidator ID="VRCBNationalityId" runat="server" ControlToValidate="RCBNationalityId" ErrorMessage="ادخل جنسيتك" Font-Bold="True" ForeColor="Red"></asp:RequiredFieldValidator>
                                        </td>
                                        <td class="style6">
                                            <asp:RequiredFieldValidator ID="VRCBcountryId" runat="server" ControlToValidate="RCBcountryId" ErrorMessage="ادخل دولة الاقامه" Font-Bold="True" ForeColor="Red"></asp:RequiredFieldValidator>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="style6">
                                            <asp:RequiredFieldValidator ID="VRTxtCity" runat="server" ControlToValidate="RTxtCity" ErrorMessage="ادخل مدينتك" Font-Bold="True" ForeColor="Red"></asp:RequiredFieldValidator>
                                        </td>
                                        <td class="style6">
                                            <asp:RequiredFieldValidator ID="VRTxttel" runat="server" ControlToValidate="RTxttel" ErrorMessage="ادخل هاتفك" Font-Bold="True" ForeColor="Red"></asp:RequiredFieldValidator>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="style6">
                                            <asp:RequiredFieldValidator ID="VRTxtMobile" runat="server" ControlToValidate="RTxtMobile" ErrorMessage="ادخل جوالك" Font-Bold="True" ForeColor="Red"></asp:RequiredFieldValidator>
                                        </td>
                                        <td class="style6">
                                            <asp:RequiredFieldValidator ID="VRTxtEmail" runat="server" ControlToValidate="RTxtEmail" ErrorMessage="ادخل بريدك" Font-Bold="True" ForeColor="Red"></asp:RequiredFieldValidator>
                                        </td>
                                    </tr>
                                </table>
                            </td>
...
<asp:AccessDataSource ID="DSCdNationality" runat="server" SelectCommand="Select NationalityId, Nationality From CdNationality"
    DataFile="~/App_Data/AATSWEB.mdb"></asp:AccessDataSource>
<asp:AccessDataSource ID="DSMenuItem" runat="server" SelectCommand="SELECT [CourseId], [CourseName] FROM [TBLCoursesnotime] WHERE ([ShowOnline] = ?)"
