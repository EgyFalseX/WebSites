<%@ Page Title="" Language="C#" MasterPageFile="masterpage.master" AutoEventWireup="true" CodeFile="SubjectViewere.aspx.cs" Inherits="SubjectViewer" %>
...
<table align="center">
    ...
    <tr>
        <td dir="ltr" style="text-align: center" class="auto-style1">
            <dx:ASPxDataView ID="ASPxDataView1" runat="server" DataSourceID="DSData" 
                ...
                <ItemTemplate>
                    <dx:ASPxFormLayout ID="ASPxFormLayout1" runat="server" ColCount="2" 
                        EnableTheming="True" RightToLeft="True" Theme="Office2010Black" Width="217px" ShowItemCaptionColon="False">
                        <Items>
                            <dx:LayoutItem Caption=":Subject" HorizontalAlign="Left">
                                <LayoutItemNestedControlCollection>
                                    <dx:LayoutItemNestedControlContainer runat="server" SupportsDisabledAttribute="True">
                                        <dx:ASPxLabel ID="ASPxFormLayout1_E1" runat="server" Text='<%# Eval("addresse") %>'>
                                        </dx:ASPxLabel>
                                    </dx:LayoutItemNestedControlContainer>
                                </LayoutItemNestedControlCollection>
                                <CaptionSettings Location="Top" VerticalAlign="Middle" HorizontalAlign="Left" />
                            </dx:LayoutItem>
                            ...
                            <dx:LayoutItem Caption="Info" ColSpan="2">
                                <LayoutItemNestedControlCollection>
                                    <dx:LayoutItemNestedControlContainer runat="server" SupportsDisabledAttribute="True">
                                        <dx:ASPxMemo ID="ASPxFormLayout1_E2" runat="server" Height="71px" 
                                            ReadOnly="True" Text='<%# Eval("smallinfoe") %>' Width="184px">
                            ...
                            <dx:LayoutItem Caption="Details" ColSpan="2" ShowCaption="False">
                                <LayoutItemNestedControlCollection>
                                    <dx:LayoutItemNestedControlContainer runat="server" SupportsDisabledAttribute="True">
                                        <dx:ASPxHyperLink ID="ASPxFormLayout1_E4" runat="server" NavigateUrl='<%# Eval("aboutid", "defaulte.aspx?id={0}") %>' Text="Show">
                                        </dx:ASPxHyperLink>
                                    </dx:LayoutItemNestedControlContainer>
                                </LayoutItemNestedControlCollection>
