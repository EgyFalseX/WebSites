<%@ Page Title="" Language="C#" MasterPageFile="master.master" AutoEventWireup="true" CodeFile="subjectEditore.aspx.cs" Inherits="AboutEditor" %>
    ...
    <tr>
        <td>
            <dx:ASPxGridView ID="GVEditor" runat="server" AutoGenerateColumns="False" 
                ...
                onrowinserted="GVEditor_RowInserted" Font-Bold="True" Theme="Glass" 
...
s.cpShowPopup = undefined;
                ...
                <Columns>
                    ...
                    <dx:GridViewDataTextColumn Caption="subject" FieldName="addresse" VisibleIndex="2">
                        <EditFormSettings Visible="True" />
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataTextColumn Caption="الموضوع" FieldName="address" VisibleIndex="1">
                        <PropertiesTextEdit Width="300px">
                        </PropertiesTextEdit>
                        <EditFormSettings CaptionLocation="Top" />
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataMemoColumn Caption="info" FieldName="smallinfoe" VisibleIndex="4">
                    ...
                    <dx:GridViewDataTextColumn Caption="الصورة" FieldName="primg" VisibleIndex="5">
                        <PropertiesTextEdit Width="300px">
                        </PropertiesTextEdit>
                        <EditFormSettings CaptionLocation="Top" />
                        <DataItemTemplate>
...
{2}" notallowedfileextensionerrortext="امتداد الملف غير مسموح به">
                    ...
                    <dx:GridViewDataHyperLinkColumn Caption="التقرير" FieldName="aboutid" VisibleIndex="11">
                        <PropertiesHyperLinkEdit NavigateUrlFormatString="CreatePage.aspx?id={0}" TextFormatString="التقرير">
            ...
            <asp:AccessDataSource ID="DSData" runat="server" 
                ...
                DeleteCommand="DELETE FROM [school] WHERE [aboutid] = ?"
                InsertCommand="INSERT INTO [school] ( [address],[addresse], [smallinfo],[smallinfoe], [primg]) VALUES (?,?,?, ?, ?)"  
                SelectCommand="SELECT [aboutid],  [address],[addresse], [smallinfo],[smallinfoe], [primg] FROM [school] " 
                
                UpdateCommand="UPDATE [school] SET [address] = ?,[addresse] = ?, [smallinfo] = ?,[smallinfoe] = ?, [primg] = ? WHERE [aboutid] = ?" 
                OnInserting="DSData_Inserting" OnUpdating="DSData_Updating">
                <DeleteParameters>
                ...
                <InsertParameters>
                    ...
                    <asp:Parameter Name="smallinfoe" Type="String" />
