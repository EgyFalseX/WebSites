<%@ Page Title="" Language="C#" MasterPageFile="master.master" AutoEventWireup="true" CodeFile="picEditor.aspx.cs" Inherits="AboutEditor" %>
...
s.cpShowPopup = undefined;
                ...
                <Columns>
                    ...
                    <dx:GridViewDataTextColumn Caption="عنوان الصورة" FieldName="Caption" 
                        VisibleIndex="1">
                        <PropertiesTextEdit Width="300px">
                        </PropertiesTextEdit>
                        <EditFormSettings CaptionLocation="Top" />
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataTextColumn Caption="الصورة" FieldName="ImageLink" 
                        VisibleIndex="6">
                        <PropertiesTextEdit Width="300px">
                        </PropertiesTextEdit>
                        <EditFormSettings CaptionLocation="Top" />
                        <DataItemTemplate>
                            <dx:ASPxImage ID="ASPxImage1" runat="server" Height="32px" ImageUrl='<%# Eval("ImageLink", "schoolPhoto/{0}") %>' Width="32px">
                            </dx:ASPxImage>
                        </DataItemTemplate>
                        <EditItemTemplate>
...
{2}" notallowedfileextensionerrortext="امتداد الملف غير مسموح به">
                    ...
                    <dx:GridViewDataTextColumn Caption="pic address" FieldName="Captione" VisibleIndex="4">
                        <EditFormSettings CaptionLocation="Top" />
                    </dx:GridViewDataTextColumn>
                </Columns>
            ...
            <asp:AccessDataSource ID="DSData" runat="server" 
                ...
                InsertCommand="INSERT INTO [RotatorData] ([aboutid], [Caption],[Captione], [ImageLink]) VALUES (?, ?,?, ? )"  
                SelectCommand="SELECT [ID], [aboutid], [Caption],[Captione], [ImageLink] FROM [RotatorData] WHERE ([aboutid] = ?)" 
                
                UpdateCommand="UPDATE [RotatorData] SET [Caption] = ?,[Captione] = ?, [ImageLink] = ? WHERE [ID] = ?" 
