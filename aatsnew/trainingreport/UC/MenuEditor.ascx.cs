...
public partial class QAMenuEditor : System.Web.UI.UserControl
{
    ...
    protected void IBAdd_Click(object sender, ImageClickEventArgs e)
    {
        ...
        OleDbCommand cmd = new OleDbCommand(String.Format(@"Insert Into MenuItem (ItemName, Show_Hide, ItemInfo, ItemPic) 
        VALUES ('{0}', 1, '{1}', '{2}')", TxtAdd.Text, TxtAddInfo.Text, TxtAddImg.Text), Con);
        try
        {
            Con.Open();
            cmd.ExecuteNonQuery();
