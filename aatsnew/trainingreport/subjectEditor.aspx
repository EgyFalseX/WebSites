...
{2}" notallowedfileextensionerrortext="امتداد الملف غير مسموح به">
                    ...
                    <dx:GridViewDataHyperLinkColumn Caption="الصور" FieldName="aboutid" VisibleIndex="11">
                        <PropertiesHyperLinkEdit NavigateUrlFormatString="picEditor.aspx?id={0}" TextFormatString="الصور">
            ...
            <asp:AccessDataSource ID="DSData" runat="server" 
                ...
                InsertCommand="INSERT INTO [school] ( [address], [smallinfo], [primg]) VALUES (?, ?, ?)"  
                SelectCommand="SELECT [aboutid],  [address], [smallinfo], [primg] FROM [school] " 
                
                UpdateCommand="UPDATE [school] SET [address] = ?, [smallinfo] = ?, [primg] = ? WHERE [aboutid] = ?" 
