...
using System.Drawing.Imaging;
    ...
    public partial class UploadImageUserControl : System.Web.UI.UserControl
    {
       ...
       // string saveInDBPath;
        ...
        protected void uploadASPxButton_Click(object sender, EventArgs e)
        {
            ...
            string pathname;
            ThumbnailSliderWebApplication_PathesClass pathesobject = new ThumbnailSliderWebApplication_PathesClass();
            ...
            if (uc.IsValid == true )
                if (uc.PostedFile.FileName != "")
                {
                    if (IsImageDRight(uc.PostedFile.InputStream))
                    {
                        ...
                        msgUploadASPxLabel.Text = "تم رفع الصورة بنجاح من فضلك لا تنسى الضغط على حفظ";
                        //try
                        //{
