<%@ Control Language="C#" AutoEventWireup="true" CodeFile="UploadImageUserControl1.ascx.cs" Inherits="UploadImageUserControl1" %>
...
<dx:ASPxLoadingPanel ID="ASPxLoadingPanel1" runat="server" ClientInstanceName="ASPxLoadingPanel1" CssFilePath="~/App_Themes/Office2010Black/{0}/styles.css" CssPostfix="Office2010Black" ImageSpacing="5px" Modal="True" Theme="Aqua">
    <Image Url="~/App_Themes/Office2010Black/Web/Loading.gif">
    </Image>
</dx:ASPxLoadingPanel>
<dx:ASPxCallbackPanel ID="ASPxCallbackPanel1" runat="server" ClientIDMode="AutoID" ClientInstanceName="ASPxCallbackPanel1" ClientVisible="False" Width="200px">
...
<dx:ASPxUploadControl ID="imageASPxUploadControl" runat="server" ClientInstanceName="imageASPxUploadControl" EnableTheming="True" FileUploadMode="OnPageLoad" Theme="Office2003Blue" Width="280px">
    <ValidationSettings AllowedFileExtensions=".jpg, .jpeg, .jpe, .gif, .bmp, .PNG, .TIF, .TIFF" MaxFileSize="200000">
    </ValidationSettings>
    <ClientSideEvents FileUploadComplete="function(s, e) {
	msgUploadASPxLabel.SetText('Uploaded Succesfully');     
}" />
</dx:ASPxUploadControl>
<dx:ASPxButton ID="uploadASPxButton" runat="server" AutoPostBack="False" ClientInstanceName="uploadASPxButton" EnableTheming="True" Font-Bold="True" OnClick="uploadASPxButton_Click" Text="Upload^" Theme="Office2003Blue" CausesValidation="False">
