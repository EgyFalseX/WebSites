<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Login1UserControl.ascx.cs" Inherits="LoginUserControl1" %>
        ...
        <tr>
            ...
            <td>
                <dx:ASPxButton ID="submitASPxButton" runat="server" 
                    ...
                    ValidationGroup="signInVG" Font-Bold="True" EnableTheming="True" Theme="RedWine" OnClick="submitASPxButton_Click">
