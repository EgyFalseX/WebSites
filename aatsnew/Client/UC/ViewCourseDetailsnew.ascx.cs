...
public partial class ViewCourseDetails : System.Web.UI.UserControl
{
    ...
    protected void SelectCource_Click(object sender, EventArgs e)
    {
        ...
        {
            Response.Redirect("http://aats-online.com/Client/ViewCourseDetailsnew.aspx");
        }
        else
        {
            Response.Redirect("http://aats-online.com/Client/ViewCourseDetailsnew.aspx?Courseitem=1&CourseId=" + RCB.SelectedValue);
        }
    }
    #endregion   
    
   
    protected void btnCourceNew_Click(object sender, EventArgs e)
    {
        if (RCBCources.SelectedValue == null || RCBCources.SelectedValue == string.Empty)
            return;
        Response.Redirect("AddTraineenew.aspx?CourseId=" + RCBCources.SelectedValue);
