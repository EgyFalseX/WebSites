    ...
    <tr>
        <td style="text-align: center; direction: rtl" bgcolor="#E0E0E0">
            ...
            <asp:Label ID="Label1" runat="server" Font-Size="18pt" 
                style="font-family: 'Times New Roman', Times, serif; font-weight: 700; color: #000080;" 
                ...
                ForeColor="Red" Font-Bold="True" Font-Names="Times New Roman"></asp:Label>
                </dt>
            </dl>
        </td>
    </tr>
...
<asp:Panel ID="PnlInfo" runat="server" Visible="False">
    <table align="center" class="style2">
        <tr>
            <td class="auto-style1" style="direction: rtl">
                <asp:Label ID="LblUniqueNo" runat="server" Font-Bold="True"></asp:Label>
            </td>
            <td bgcolor="Gray" style="direction: rtl; background-color: #0099CC;" class="auto-style2">
        ...
        <tr>
            ...
            <td bgcolor="Gray" style="direction: rtl; background-color: #0099CC;">
