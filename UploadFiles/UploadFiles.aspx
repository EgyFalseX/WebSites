            ...
            <table align="center" class="auto-style1">
                <tr>
                    <td style="text-align: center">
                        <dx:ASPxComboBox ID="cb" runat="server" AutoPostBack="True" DataSourceID="dsData" DropDownStyle="DropDown" Font-Size="Medium" OnSelectedIndexChanged="cb_SelectedIndexChanged" TextField="FileInformation" ValueField="Id" Width="250px">
                        </dx:ASPxComboBox>
                    </td>
                </tr>
                <tr>
...
{2}">
  ...
  _aspxGetElementById('lblPath').innerHTML = e.callbackData;
                ...
                <tr>
                    <td style="text-align: center">
                        <asp:AccessDataSource ID="dsData" runat="server" DataFile="DB/UploadFilesPaths.mdb" SelectCommand="SELECT [Id], [FileInformation] FROM [UploadFileInfo]"></asp:AccessDataSource>
                    </td>
                </tr>
            </table>
