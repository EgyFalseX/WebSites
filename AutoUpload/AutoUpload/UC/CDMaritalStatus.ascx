...
s.cpShowPopup = undefined;
            ...
            <asp:AccessDataSource ID="DSData" runat="server" DataFile="~/App_Data/ETST.mdb" 
                DeleteCommand="DELETE FROM [CDMaritalStatus] WHERE [MaritalStatusId] = ?" InsertCommand="INSERT INTO [CDMaritalStatus] ([MaritalStatusId], [MaritalStatus]) VALUES 
(?, ?)" SelectCommand="SELECT [MaritalStatusId], [MaritalStatus] FROM [CDMaritalStatus]" 
                UpdateCommand="UPDATE [CDMaritalStatus] SET [MaritalStatus] = ? WHERE [MaritalStatusId] = ?" 
                oninserting="DSData_Inserting">
                <DeleteParameters>
                    <asp:Parameter Name="MaritalStatusId" Type="Byte" />
                </DeleteParameters>
                <InsertParameters>
                    <asp:Parameter Name="MaritalStatusId" />
