...
s.cpShowPopup = undefined;
            ...
            <asp:AccessDataSource ID="DSData" runat="server" DataFile="~/App_Data/ETST.mdb" 
                DeleteCommand="DELETE FROM [CDCompanionType] WHERE [CompanionTypeId] = @CompanionTypeId" InsertCommand="INSERT INTO [CDCompanionType] ([CompanionTypeId], [CompanionType]) VALUES 
(?, ?)" SelectCommand="SELECT [CompanionTypeId], [CompanionType] FROM [CDCompanionType]" 
                UpdateCommand="UPDATE [CDCompanionType] SET [CompanionType] = @CompanionType WHERE [CompanionTypeId] = @CompanionTypeId" 
