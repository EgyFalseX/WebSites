...
<img class="style2" src="" align="middle" /><asp:HyperLink 
        ID="HyperLink1" runat="server" NavigateUrl="~/Indexa.htm" 
        style="font-weight: 700" Target="_self"></asp:HyperLink>
    </p>
