...
public partial class MenuItem : System.Web.UI.UserControl
{
    ...
    private string constr = "Provider=Microsoft.Jet.OLEDB.4.0; Data Source= " + HttpContext.Current.Server.MapPath(@"App_Data/home_work.mdb");
    ...
    {
        return LoadTable(@"SELECT IIF(IsNull(MAX(id)), 1, MAX(id) + 1) AS NewID FROM home_work").Rows[0][0].ToString();
    }
    ...
    protected void GVEditor_RowDeleted(object sender, DevExpress.Web.Data.ASPxDataDeletedEventArgs e)
    {
        ...
        if (System.IO.File.Exists(MapPath(FilesPath + e.Values["id"])))//Delete Data File
            System.IO.File.Delete(MapPath(FilesPath + e.Values["id"]));
    }
    protected void UCpic_FileUploadComplete(object sender, DevExpress.Web.ASPxUploadControl.FileUploadCompleteEventArgs e)
    {
        ...
        //((DevExpress.Web.ASPxEditors.ASPxLabel)UCpic.Parent.FindControl("lblPath")).Text = "../Files/img/" + FName;

        
        //UCpic.UploadButton.Text = "../Files/img/" + FName;
        //GVEditor.JSProperties["cpShowPopup"] = "../Files/img/" + FName;
        //Label1.Text = "../Files/img/" + FName;
    ...
    protected void GVEditor_RowUpdating(object sender, DevExpress.Web.Data.ASPxDataUpdatingEventArgs e)
    {
        ...
        SaveToFile(MapPath(FilesPath + e.NewValues["id"]), e.NewValues["Data_Path"]);
