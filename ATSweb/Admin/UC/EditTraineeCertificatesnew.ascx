<%@ Control Language="C#" AutoEventWireup="true" CodeFile="EditTraineeCertificatesnew.ascx.cs" Inherits="EditTraineeCertificatesnew" %>
 <style type="text/css">
     .style1
     {
         width: 700px;
    ...
    <tr>
        <td>
                    ...
                    <MasterTableView CommandItemDisplay="TopAndBottom" 
                        ...
                        <Columns>
                            <telerik:GridBoundColumn DataField="CourseId" 
                                FilterControlAltText="Filter CourseId column" 
                                UniqueName="CourseId" HeaderText="اسم الدوره" 
                            ...
                            <telerik:GridBoundColumn DataField="TraineeID" 
                                ...
                                HeaderText="اسم المتدرب" 
                                UniqueName="TraineeID" SortExpression="TraineeID">
                                <HeaderStyle HorizontalAlign="Center" />
                                <ItemStyle HorizontalAlign="Center" />
                            </telerik:GridBoundColumn>
                            <telerik:GridBoundColumn DataField="trineer" 
                                FilterControlAltText="Filter trineer column" HeaderText="اسم المدرب" 
                                SortExpression="trineer" UniqueName="trineer">
                                <FooterStyle HorizontalAlign="Center" />
                                <HeaderStyle HorizontalAlign="Center" />
                                <ItemStyle HorizontalAlign="Center" />
                            </telerik:GridBoundColumn>
                            <telerik:GridBoundColumn DataField="UniqueNo" 
                                FilterControlAltText="Filter UniqueNo column" HeaderText="رقم الشهاده" 
                                SortExpression="UniqueNo" UniqueName="UniqueNo">
                                <HeaderStyle HorizontalAlign="Center" />
                                <ItemStyle HorizontalAlign="Center" />
                            </telerik:GridBoundColumn>
                            <telerik:GridDateTimeColumn DataField="ReceiptDate" 
                                DataFormatString="{0:d/M/yyyy}" FilterControlAltText="Filter ReceiptDate column" 
                                HeaderText="تاريخ الاصدار" SortExpression="ReceiptDate" 
                                UniqueName="ReceiptDate" DataType="System.DateTime" 
            ...
            <asp:AccessDataSource ID="DSData"
                ...
                DeleteCommand="DELETE FROM [TBLTraineeCertificatesnew] WHERE [aa] = ? " 
                InsertCommand="INSERT INTO [TBLTraineeCertificatesnew] ([TraineeID], [CourseId], [ReceiptDate], [UniqueNo], [trineer]) VALUES (?, ?, ?, ?, ?)" 
                SelectCommand="SELECT [TraineeID], [CourseId], [ReceiptDate], [UniqueNo], [trineer], [aa] FROM [TBLTraineeCertificatesnew]" 
                UpdateCommand="UPDATE [TBLTraineeCertificatesnew] SET [ReceiptDate] = ?, [UniqueNo] = ?, [trineer] = ?, TraineeID = ?, CourseId = ? WHERE [aa] = ?" 
                onselected="DSData_Selected">
                <DeleteParameters>
                    <asp:Parameter Name="aa" Type="Int32" />
                </DeleteParameters>
                <InsertParameters>
                    <asp:Parameter Name="TraineeID" Type="String" />
                    ...
                    <asp:Parameter Name="trineer" Type="String" />
                </InsertParameters>
                <UpdateParameters>
                    <asp:Parameter Name="ReceiptDate" Type="DateTime" />
                    <asp:Parameter Name="UniqueNo" Type="String" />
