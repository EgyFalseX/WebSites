...
public partial class EditCourse : System.Web.UI.UserControl
{
    ...
    protected void IBAdd_Click(object sender, ImageClickEventArgs e)
    {
        ...
        string ResultMSG = DB.InsertCourse(ref CourseId, TxtAdd.Text, TxtAddInfo.Text, StartDate, EndDate, RNTxtPriceAdd.Text, CBShowOnlineAdd.Checked.ToString());
    ...
    protected void DDLItems_SelectedIndexChanged(object sender, EventArgs e)
    {
        if (DDLItems.SelectedValue == string.Empty)
        {
            ...
            RNTxtPriceEdit.Text = "0";
            CBShowOnlineEdit.Checked = false;
            return;
        }
        ...
        CBShowOnlineEdit.Checked = (bool)row["ShowOnline"];
    ...
    protected void IBEdit_Click(object sender, ImageClickEventArgs e)
    {
        ...
        DB.UpdateCourse(DDLItems.SelectedValue, TxtEdit.Text, TxtEditInfo.Text, StartDate, EndDate, RNTxtPriceEdit.Text, CBShowOnlineEdit.Checked.ToString());
