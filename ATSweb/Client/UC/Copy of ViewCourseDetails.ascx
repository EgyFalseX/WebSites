<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Copy of ViewCourseDetails.ascx.cs" Inherits="ViewCourseDetails" %>
<style type="text/css">
...
<div dir="rtl"> 
    ...
    SelectCommand="SELECT [CourseId], [CourseName] FROM [TBLCourses]">
