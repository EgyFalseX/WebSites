...
public partial class ChangePasswordcalendarUC : System.Web.UI.UserControl
{
    ...
    protected void BtnUpdate_Click(object sender, EventArgs e)
    {
        ...
        OleDbConnection con = new OleDbConnection(ConnectionStr("calendar.mdb"));
        OleDbCommand cmd = new OleDbCommand("", con);
        try
        {
            cmd.CommandText = string.Format(@"Update admin Set pass = '{0}' Where id = {1}", Txtpass1.Text, HttpContext.Current.Session["UserID_calendar"]);
            cmd.ExecuteNonQuery();
