...
public partial class ChangePasswordABOUTUC : System.Web.UI.UserControl
{
    ...
    protected void BtnUpdate_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            cmd.CommandText = string.Format(@"Update admin Set pass = '{0}' Where id = {1}", Txtpass1.Text, HttpContext.Current.Session["UserID_ABOUT"]);
            con.Open();
            cmd.ExecuteNonQuery();
