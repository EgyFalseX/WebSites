...
public partial class AchievementsAdmin : System.Web.UI.UserControl
{
    ...
    protected void RBtnUpdate_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            cmd.CommandText = String.Format(@"Update engaz Set imageline1 = '../images/{0}' Where vid = {1}", NewFileName, RCBID.SelectedValue);
            con.Open();
            cmd.ExecuteNonQuery();
