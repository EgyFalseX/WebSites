<%@ Control Language="C#" AutoEventWireup="true" CodeFile="SchoolInBriefAdmin.ascx.cs" Inherits="SchoolInBriefAdmin" %>
    ...
    <tr>
        <td style="text-align: center">
                ...
                <telerik:RadComboBox ID="RCBID" Runat="server" 
                    ...
                    DataValueField="vid" 
                    onselectedindexchanged="RCBID_SelectedIndexChanged" Skin="Forest" 
