...
public partial class Logincalendar : Page
{
    ...
    protected void BtnLogin_Click(object sender, EventArgs e)
    {
        ...
        HttpContext.Current.Session["UserID_calendar"] = userData.Rows[0]["id"].ToString();
        if (CBPass.Checked)
            Response.Redirect("ChangePasswordcalendar.aspx");
        else
    ...
    public static DataTable LoadDataTable(string CommandString)//Load Table From Database
    {
        ...
        using (OleDbDataAdapter DA = new OleDbDataAdapter(CommandString, ConnectionStr("calendar.mdb")))
        {
