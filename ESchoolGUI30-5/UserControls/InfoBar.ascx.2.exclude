<%@ Control Language="C#" AutoEventWireup="true" CodeFile="InfoBar.ascx.cs" Inherits="UserControls_InfoBar" %>
    <div id="plcholddiv" style="position:absolute; left:85px; top:36px; margin:0px; width:237px; height:256px; overflow:hidden;"></div>
