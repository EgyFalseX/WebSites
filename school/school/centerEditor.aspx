...
{2}" notallowedfileextensionerrortext="امتداد الملف غير مسموح به">
                    ...
                    <dx:GridViewDataTextColumn Caption="الموضوع" FieldName="ItemName" 
                        VisibleIndex="2">
                    ...
                    <dx:GridViewDataHyperLinkColumn Caption="التفاصيل" FieldName="ItemID" 
                        VisibleIndex="5">
                        <PropertiesHyperLinkEdit NavigateUrlFormatString="CreatePage.aspx?id={0}" 
                            TextFormatString="التفاصيل">
                        </PropertiesHyperLinkEdit>
                        <EditFormSettings Visible="False" />
                    </dx:GridViewDataHyperLinkColumn>
                    <dx:GridViewDataComboBoxColumn Caption="مدرسة" FieldName="schoolid" VisibleIndex="1">
                        <PropertiesComboBox DataSourceID="DSDataSchoolId" ValueField="schoolid" TextField="schoolname">
                            <Columns>
            ...
            <asp:AccessDataSource ID="DSData" runat="server" 
                ...
                InsertCommand="INSERT INTO [MenuItem] ( [ItemName],  [Data_Path], [ItemInfo], [ItemPic], schoolid) VALUES (  ?, ?, ?, ?, ?)" 
                SelectCommand="SELECT ItemID, ItemName, Show_Hide, Data_Path, ItemInfo, ItemPic, schoolid FROM MenuItem" 
                UpdateCommand="UPDATE [MenuItem] SET [ItemName] = ?,  [Data_Path] = ?, [ItemInfo] = ?, [ItemPic] = ?, schoolid = ? WHERE [ItemID] = ?" 
            ...
            <asp:AccessDataSource ID="DSDataSchoolId" runat="server" 
                DataFile="Data/FlexibleData.mdb" 
