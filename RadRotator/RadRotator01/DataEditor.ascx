    ...
    <tr>
        <td>
                    ...
                    <MasterTableView CommandItemDisplay="TopAndBottom" DataKeyNames="ID" HorizontalAlign="NotSet" 
                        ...
                        <Columns>
                            ...
                            <telerik:GridBoundColumn DataField="Link" 
                                FilterControlAltText="Filter Link column" HeaderText="المسار" 
            ...
            <asp:AccessDataSource ID="DSData"
                ...
                InsertCommand="INSERT INTO [RotatorData] ([Caption], [Contain], [ImageLink], [Link], [viewpage]) VALUES (?, ?, ?, ?, ?)" 
                SelectCommand="SELECT [ID], [Caption], [Contain], [ImageLink], [Link], [viewpage] FROM [RotatorData]" 
                
                UpdateCommand="UPDATE [RotatorData] SET [Caption] = ?, [Contain] = ?, [ImageLink] = ?, [Link] = ?, [viewpage] = ? WHERE [ID] = ?" 
