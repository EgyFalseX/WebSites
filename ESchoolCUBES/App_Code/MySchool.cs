...
public class MySchool
{
    ...
    public static OleDbConnection SLConnection
    {
        get
        {
            OleDbConnection SLCon = new OleDbConnection(ConnectionStr(@"dlib\SL.mdb"));
    ...
    public static OleDbConnection LibraryConnection
    {
        get
        {
            OleDbConnection con1 = new OleDbConnection(ConnectionStr1(@"dlib\library.mdb"));
            return con1;
        }
    ...
    public static OleDbConnection LibraryCodeConnection
    {
        get
        {
            OleDbConnection con1 = new OleDbConnection(ConnectionStr1(@"dlib\libcode.mdb"));
            return con1;
        }

    }
    public static OleDbConnection QAConnection
    {
        get
        {
            OleDbConnection con1 = new OleDbConnection(ConnectionStr1(@"QA\QualityAssurance.mdb"));
            return con1;
        }

    }
    public static OleDbConnection feedbackConnection
    {
        get
        {
            OleDbConnection con1 = new OleDbConnection(ConnectionStr1(@"feedback.mdb"));
            return con1;
        }
