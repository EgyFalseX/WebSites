...
<dx:ASPxUploadControl ID="imageASPxUploadControl" runat="server" ClientInstanceName="imageASPxUploadControl" EnableTheming="True" FileUploadMode="OnPageLoad" Theme="Glass" Width="280px">
    <ValidationSettings AllowedFileExtensions=".jpg, .jpeg" MaxFileSize="100000">
    </ValidationSettings>
    <ClientSideEvents FileUploadComplete="function(s, e) {
	msgUploadASPxLabel.SetText('Uploaded Succesfully');     
}" />
    <BrowseButton Text="قم بإختيار صورة">
    </BrowseButton>
</dx:ASPxUploadControl>
<dx:ASPxButton ID="uploadASPxButton" runat="server" AutoPostBack="False" ClientInstanceName="uploadASPxButton" EnableTheming="True" Font-Bold="True" OnClick="uploadASPxButton_Click" Text="حفظ" Theme="Glass" CausesValidation="False">
