<%@ Control Language="C#" AutoEventWireup="true" CodeFile="FriendPersonalDataUserControl.ascx.cs" Inherits="FriendPersonalDataUserControl" %>
...
<center>
                    <table width="780">
                        <tr>
                            <td>
                                <strong>تعديل البيانات الشخصية</strong></td>
                        </tr>
                        <tr>
                            <td>
                                ...
                                <table dir="ltr" >
                                       <tr>
                            <td style="direction: rtl" class="style8" rowspan="4"><asp:Label ID="Label14" runat="server" Text="صورة شخصية * :" 
                            ...
                            <td style="direction: rtl" class="style8" colspan="2" >
                                <asp:Image ID="Image1" runat="server" Height="150px" ImageUrl='<%# "../"+Eval("EventImage") %>' Width="150px" />
                        ...
                        <tr>
                            ...
                            <td  align="right">
                                <dx:ASPxComboBox ID="RCBCityId" runat="server" DataSourceID="DSCdCity" TextField="City" Theme="Glass" ValueField="CityID" ValueType="System.Int32" Width="203px">
                                    <Columns>
                                        <dx:ListBoxColumn Caption="المحافظة" FieldName="City" />
                                    </Columns>
                                </dx:ASPxComboBox>
                                ...
                                <asp:Label ID="Label9" runat="server" Font-Bold="True" ForeColor="black">البريد الكتروني * :</asp:Label>
                                       ...
                                       <tr>
                                           <td class="style8" style="direction: rtl">
                                               &nbsp;</td>
                                           <td class="style8" style="direction: rtl">
                                               <dx:ASPxTextBox ID="userASPxTextBox" runat="server" ClientIDMode="AutoID" CssFilePath="~/App_Themes/PlasticBlue/{0}/styles.css" CssPostfix="PlasticBlue" MaxLength="15" SpriteCssFilePath="~/App_Themes/PlasticBlue/{0}/sprite.css" Width="200px" ReadOnly="True">
                                           ...
                                           <td style="direction: rtl">
                                <asp:Label ID="Label15" runat="server" Font-Bold="True" ForeColor="Black">اسم المستخدم * :</asp:Label>
                                           </td>
                                       </tr>
                                       <tr>
                                           <td class="style8" style="direction: rtl">
...
<%--    
            ...
            <dx:ASPxPopupControl ID="readMsgASPxPopupControl" runat="server" 
                ...
                Modal="True" PopupElementID="deleteASPxButton" 
                ClientInstanceName="deleteMsgASPxPopupControl" 
                HeaderText="تم التعديل " Theme="Glass" RightToLeft="True" PopupHorizontalAlign="WindowCenter" PopupVerticalAlign="Middle" Font-Bold="True">
                <ContentStyle VerticalAlign="Top">
                </ContentStyle>
                <SizeGripImage Height="12px" Width="12px" />
                <ContentCollection>
