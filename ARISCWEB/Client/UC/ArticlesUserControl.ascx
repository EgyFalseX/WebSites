	...
	cursor: pointer;
        ...
        <dx:ASPxGridView ID="ASPxGridView1" runat="server" AutoGenerateColumns="False" ClientInstanceName="ASPxGridView1" CssFilePath="~/App_Themes/Office2010Black/{0}/styles.css" CssPostfix="Office2010Black" DataSourceID="DSCdArticles" EnableTheming="True" KeyFieldName="ArticleID" OnBeforePerformDataSelect="ASPxGridView1_BeforePerformDataSelect" OnCustomButtonCallback="ASPxGridView1_CustomButtonCallback" Theme="Glass" Font-Bold="True" OnCustomCallback="ASPxGridView1_CustomCallback" OnCancelRowEditing="ASPxGridView1_CancelRowEditing">
            ...
            <Columns>
                ...
                <dx:GridViewDataTextColumn FieldName="TimeIn" ToolTip="الاسم انجليزي" VisibleIndex="3" Caption="التاريخ">
...
<%--                                    <dx:ASPxImage ID="ASPxImage2" runat="server" Height="30px" ImageUrl='<%# Convert.ToString(Eval("Readed")) != "" ? "~/contactsite/Images/read.png" : "~/contactsite/Images/unread.png" %>'  Width="30px">
                ...
                <dx:GridViewDataMemoColumn Caption="عرض" VisibleIndex="38">
                    <PropertiesMemoEdit>
                ...
                <dx:GridViewDataTextColumn Caption="هل تم قراءة الرد" FieldName="UserReaded" ReadOnly="True" VisibleIndex="37" Visible="False">
                </dx:GridViewDataTextColumn>
                ...
                <dx:GridViewDataTextColumn FieldName="ArticleID" VisibleIndex="35" Visible="False">
                </dx:GridViewDataTextColumn>
                <dx:GridViewDataTextColumn FieldName="UserName" VisibleIndex="2" Caption="الكاتب">
                </dx:GridViewDataTextColumn>
            </Columns>
            ...
            <StylesEditors ButtonEditCellSpacing="0">
                <ProgressBar Height="21px">
                                ...
                                <asp:AccessDataSource ID="DSCdArticles" runat="server" DataFile="~/App_Data/AriscFriend.mdb" SelectCommand="SELECT ArticleID, ArticleTitle, ArticleDetailsFile, Notes, IsDisplay, ArticleImage, UserName, TimeIn FROM TBLFriendsArticles WHERE (IsDisplay = true)">
