<%@ Control Language="C#" AutoEventWireup="true" CodeFile="UploadFileUserControl.ascx.cs" Inherits="UploadFileUserControl" %>
...
<dx:ASPxUploadControl ID="imageASPxUploadControl" runat="server" ClientInstanceName="imageASPxUploadControl" EnableTheming="True" FileUploadMode="OnPageLoad" Theme="Glass" Width="280px">
    <ValidationSettings AllowedFileExtensions=".docx, .doc, .pdf, .rar, .zip" MaxFileSize="100000" MaxFileSizeErrorText="حجم الملف يزيد عن المسموح" NotAllowedFileExtensionErrorText="نوع الملف غير مسموح">
    </ValidationSettings>
