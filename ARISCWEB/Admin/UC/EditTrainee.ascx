    ...
    <tr>
        <td>
                ...
                <telerik:RadGrid ID="RadGridEdit" GridLines="None" runat="server" 
                    ...
                    <MasterTableView CommandItemDisplay="TopAndBottom" DataKeyNames="TraineeID" HorizontalAlign="NotSet" 
                        ...
                        <Columns>
                            ...
                            <telerik:GridDropDownColumn DataField="GenderID" DataSourceID="DSCdGender" FilterControlAltText="Filter Gender column" HeaderText="النوع" ListTextField="Gender" ListValueField="GenderID" SortExpression="GenderID" UniqueName="Gender" Display="False">
                            </telerik:GridDropDownColumn>
                            <telerik:GridBoundColumn DataField="OtherJob" FilterControlAltText="Filter OtherJob column" HeaderText="الوظيفة" SortExpression="OtherJob" UniqueName="OtherJob">
                            </telerik:GridBoundColumn>
                            ...
                            <telerik:GridBoundColumn DataField="Mobile" 
                                FilterControlAltText="Filter Mobile column" HeaderText="الموبايل" 
                            ...
                            <telerik:GridBoundColumn DataField="CourseName" FilterControlAltText="Filter CourseName column" HeaderText="اسم الدورة" ReadOnly="True" SortExpression="CourseName" UniqueName="CourseName">
                            </telerik:GridBoundColumn>
                            <telerik:GridDateTimeColumn DataField="TimeIn" FilterControlAltText="Filter TimeIn column" HeaderText="تاريخ التسجيل" ReadOnly="True" SortExpression="TimeIn" UniqueName="TimeIn" DataType="System.DateTime">
            ...
            <asp:AccessDataSource ID="DSData"
                ...
                VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, NOW(), ?, ?, ?)" 
                SelectCommand="SELECT TBLTrainee.TraineeID, TBLTrainee.TraineeName, TBLTrainee.NameInEnglish, TBLTrainee.NationalityId, TBLTrainee.Mobile, TBLTrainee.Email, TBLTrainee.City, TBLTrainee.Address, 
Format (TBLTrainee.TimeIn, &quot;Short Date&quot;) AS TimeIn
, TBLTrainee.mony, TBLTrainee.accname, TBLTrainee.countryId, TBLTrainee.GenderID, TBLTrainee.OtherJob, TBLCourses.CourseName FROM (TBLCourses INNER JOIN TBLTrainee ON TBLCourses.CourseId = TBLTrainee.CourseId)
ORDER BY TBLTrainee.TimeIn DESC" 
            ...
            <asp:AccessDataSource ID="DSCdGender"
                runat="server" 
                SelectCommand="SELECT GenderID, Gender FROM CdGender" 
                DataFile="~/App_Data/AATSWEB.mdb"></asp:AccessDataSource>
