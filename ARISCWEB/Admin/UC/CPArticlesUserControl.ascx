<%@ Control Language="C#" AutoEventWireup="true" CodeFile="CPArticlesUserControl.ascx.cs" Inherits="CPArticlesUserControl" %>
...
<%--	background: #E2F0FF url('<%=WebResource("DevExpress.Web.ASPxThemes.App_Themes.Aqua.Editors.edtButtonBack.gif")%>') repeat-x top;--%>
	...
	cursor: pointer;
        ...
        <dx:ASPxGridView ID="ASPxGridView1" runat="server" AutoGenerateColumns="False" ClientInstanceName="ASPxGridView1" CssFilePath="~/App_Themes/Office2010Black/{0}/styles.css" CssPostfix="Office2010Black" DataSourceID="articlesSqlDataSource" EnableTheming="True" KeyFieldName="ArticleID" OnBeforePerformDataSelect="ASPxGridView1_BeforePerformDataSelect" OnCustomButtonCallback="ASPxGridView1_CustomButtonCallback" Theme="Glass" Font-Bold="True" OnCustomCallback="ASPxGridView1_CustomCallback" OnCancelRowEditing="ASPxGridView1_CancelRowEditing">
            ...
            <Columns>
                <dx:GridViewDataMemoColumn Caption="العنوان" FieldName="ArticleTitle" ToolTip="الاسم عربي" VisibleIndex="1">
                    <PropertiesMemoEdit>
                        <ValidationSettings>
...
<%--                                    <dx:ASPxImage ID="ASPxImage2" runat="server" Height="30px" ImageUrl='<%# Convert.ToString(Eval("Readed")) != "" ? "~/contactsite/Images/read.png" : "~/contactsite/Images/unread.png" %>'  Width="30px">
                ...
                <dx:GridViewDataMemoColumn Caption="التفاصيل" VisibleIndex="36">
                    <PropertiesMemoEdit>
                ...
                <dx:GridViewDataTextColumn FieldName="Notes" VisibleIndex="27" Caption="ملاحظات">
                </dx:GridViewDataTextColumn>
                <dx:GridViewDataImageColumn Caption="الصورة" FieldName="ArticleImage" VisibleIndex="29" Name="IMG">
                    <DataItemTemplate>
                        ...
                        <uc1:UploadImageUserControl2 ID="UploadImageUserControl21" runat="server"  MFileSize="50000" PathID="2"/>
                        <dx:ASPxButton ID="saveASPxButton" runat="server" OnClick="saveASPxButton_Click" Text="حفظ" Theme="PlasticBlue">
                        </dx:ASPxButton>
                    </DataItemTemplate>
                </dx:GridViewDataImageColumn>
                <dx:GridViewDataCheckColumn Caption="هل يظهر" VisibleIndex="17" ReadOnly="True">
                    <DataItemTemplate>
                        <dx:ASPxCheckBox ID="isActiveASPxCheckBox" runat="server" AutoPostBack="True" CheckState="Unchecked" OnCheckedChanged="isActiveASPxCheckBox_CheckedChanged" Value='<%# Eval("IsDisplay") %>'>
                        </dx:ASPxCheckBox>
                        <asp:HiddenField ID="msgIDHiddenField" runat="server" Value='<%# Eval("ArticleID") %>' />
                    </DataItemTemplate>
                ...
                <dx:GridViewDataTextColumn FieldName="ArticleID" VisibleIndex="31" Visible="False">
                </dx:GridViewDataTextColumn>
            </Columns>
...
<asp:SqlDataSource ID="articlesSqlDataSource" runat="server" ConnectionString="Provider=Microsoft.Jet.OLEDB.4.0;Data Source=|DataDirectory|\AriscFriend.mdb;Persist Security Info=True" ProviderName="System.Data.OleDb" SelectCommand="SELECT TBLFriendsArticles.* FROM TBLFriendsArticles" OnInserted="SqlDataSource2_Inserted">
</asp:SqlDataSource>
