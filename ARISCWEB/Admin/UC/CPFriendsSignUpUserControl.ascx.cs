...
public partial class CPFriendsSignUpUserControl : System.Web.UI.UserControl
    {
    UploadImageUserControl2 up = null;
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                UploadImageUserControl2 up = (UploadImageUserControl2)ASPxGridView1.FindEditRowCellTemplateControl((GridViewDataColumn)ASPxGridView1.Columns["PhotoImage"], "UploadImageUserControl21");
        ...
        {
            HiddenField ImageTextBox = (HiddenField)ASPxGridView1.FindEditRowCellTemplateControl(ASPxGridView1.Columns["PhotoImage"] as GridViewDataColumn, "imgPathHiddenField");
        ...
        protected void isActiveASPxCheckBox_CheckedChanged(object sender, EventArgs e)
        {
            ...
            string id = ASPxGridView1.GetRowValues(ASPxGridView1.FocusedRowIndex, "FriendID").ToString();
            friendsSqlDataSource.UpdateCommand = "update TBLFriends set isactive=" + ch.Checked + " where FriendID=" + id;
        ...
        protected void saveASPxButton_Click(object sender, EventArgs e)
        {
            string id = ASPxGridView1.GetRowValues(ASPxGridView1.FocusedRowIndex, "FriendID").ToString();
            HiddenField ImageTextBox = (HiddenField)ASPxGridView1.FindEditRowCellTemplateControl(ASPxGridView1.Columns["PhotoImage"] as GridViewDataColumn, "imgPathHiddenField");
            friendsSqlDataSource.UpdateCommand = "update TBLFriends set photo='" + ImageTextBox.Value + "' where FriendID=" + id;
            friendsSqlDataSource.Update();
        }
}
