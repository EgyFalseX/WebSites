<%@ Control Language="C#" AutoEventWireup="true" CodeFile="enasadminLoginUserControl.ascx.cs" Inherits="enasadminLoginUserControl" %>
...
<PanelCollection>
        ...
        runat="server" Width="200px" BackColor="White" 
                                HeaderText="" Theme="PlasticBlue" EnableTheming="True">
...
<dx:PanelContent runat="server" SupportsDisabledAttribute="True">
    ...
    Font-Bold="True" HeaderText="Sign In" EnableDefaultAppearance="False" 
        GroupBoxCaptionOffsetX="6px" Theme="PlasticBlue" EnableTheming="True">
        ...
        <tr>
            ...
            <td>
                <dx:ASPxButton ID="submitASPxButton" runat="server" 
                    ...
                    ValidationGroup="signInVG" Font-Bold="True" EnableTheming="True" Theme="PlasticBlue" OnClick="vSubmitASPxButton_Click">
