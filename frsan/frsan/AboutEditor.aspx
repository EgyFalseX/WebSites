<%@ Page Title="" Language="C#" MasterPageFile="master.master" AutoEventWireup="true" CodeFile="AboutEditor.aspx.cs" Inherits="AboutEditor" %>
    ...
    <tr>
        <td>
            <dx:ASPxGridView ID="GVEditor" runat="server" AutoGenerateColumns="False" 
                ...
                onrowinserted="GVEditor_RowInserted" Font-Bold="True" Theme="iOS" OnCancelRowEditing="GVEditor_CancelRowEditing" OnRowDeleting="GVEditor_RowDeleting" OnStartRowEditing="GVEditor_StartRowEditing">
...
s.cpShowPopup = undefined;
                ...
                <Columns>
                    ...
                    <dx:GridViewDataTextColumn Caption="العنوان" FieldName="address" VisibleIndex="1">
                    ...
                    <dx:GridViewDataTextColumn Caption="الصورة" FieldName="primg" VisibleIndex="5">
                        ...
                        <EditFormSettings CaptionLocation="Top" />
                        <DataItemTemplate>
                            <dx:ASPxImage ID="ASPxImage1" runat="server" Height="32px" ImageUrl='<%# Eval("primg", "AboutPhoto/{0}") %>' Width="32px">
                            </dx:ASPxImage>
                        </DataItemTemplate>
                        <EditItemTemplate>
...
{2}" notallowedfileextensionerrortext="امتداد الملف غير مسموح به">
                    ...
                    <dx:GridViewDataHyperLinkColumn Caption="التفاصيل" FieldName="aboutid" VisibleIndex="11">
                        <PropertiesHyperLinkEdit NavigateUrlFormatString="AboutCreatePage.aspx?id={0}" TextFormatString="التفاصيل">
            ...
            <asp:AccessDataSource ID="DSData" runat="server" 
                ...
                DeleteCommand="DELETE FROM [about] WHERE [aboutid] = ?" 
                InsertCommand="INSERT INTO [about] ([address], [smallinfo], [primg], [Data_Path]) VALUES ( ?, ?, ?, ?)" 
                SelectCommand="SELECT [aboutid], [address], [smallinfo], [primg], [Data_Path] FROM [about] ORDER BY [aboutid] DESC" 
                UpdateCommand="UPDATE [about] SET [address] = ?, [smallinfo] = ?, [primg] = ?, [Data_Path] = ? WHERE [aboutid] = ?" OnInserting="DSData_Inserting" OnUpdating="DSData_Updating">
                <DeleteParameters>
