<%@ Page Title="" Language="C#" MasterPageFile="master.master" AutoEventWireup="true" CodeFile="DetailEditor.aspx.cs" Inherits="DetailEditor" %>
...
<table align="center">
    ...
    <tr>
        <td style="text-align: center">
            <asp:HyperLink ID="HyperLink1" runat="server" Font-Size="Large" NavigateUrl="~/frsan/ProjectEditor.aspx">رجوع للمشروعات</asp:HyperLink>
        </td>
    </tr>
    <tr>
        <td>
            <dx:ASPxGridView ID="GVEditor" runat="server" AutoGenerateColumns="False" 
                ...
                KeyFieldName="subjectid" RightToLeft="True" 
...
s.cpShowPopup = undefined;
                ...
                <Columns>
                    ...
                    <dx:GridViewDataTextColumn Caption="الموضوع" FieldName="subject" VisibleIndex="2">
            ...
            <asp:AccessDataSource ID="DSData" runat="server" 
                ...
                DeleteCommand="DELETE FROM [tblsubject] WHERE [subjectid] = ?" 
                InsertCommand="INSERT INTO [tblsubject] ( [subject], [projectid]) VALUES ( ?, ?)" 
                SelectCommand="SELECT [subjectid], [subject], [projectid] FROM [tblsubject] WHERE ([projectid] = ?)" 
                UpdateCommand="UPDATE [tblsubject] SET [subject] = ? WHERE [subjectid] = ?">
                <DeleteParameters>
