...
public partial class AboutCreatePage : System.Web.UI.Page
{
    #region -   Variables   -
    ...
    public string LoadPage()
    {
        ...
        OleDbCommand CMD = new OleDbCommand("SELECT Data_Path FROM about Where aboutid = " + Request.QueryString["id"].ToString(), Con);
        try
        {
            Con.Open();
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["id"] != null)
        {
            ...
            Response.Redirect("AboutEditor.aspx");
    ...
    protected void BtnSave_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            CMD.CommandText = String.Format("Update about Set Data_Path = '{0}' Where aboutid = {1}", Path, Request.QueryString["id"]);
            Con.Open();
            CMD.ExecuteNonQuery();
            Path = MapPath(Path);
