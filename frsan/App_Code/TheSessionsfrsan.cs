...
public class TheSessionsfrsan
{
    ...
    public static string UserStudentID
    {
        get
        {
            if (HttpContext.Current.Session["UserStudentIDfrsan"] != null)
                return HttpContext.Current.Session["UserStudentIDfrsan"].ToString();
            else return null;
        }
        set
        {
            HttpContext.Current.Session["UserStudentIDfrsan"] = value;
        }
    }
