...
{
    // Paths
    public static string constr = "Data Source=.;Persist Security Info=True;User ID=sa;Password=123456;Initial Catalog=eschool";    // No Express
    //string constr = "Data Source=.\\SQLEXPRESS;Persist Security Info=True;User ID=sa;Password=123456;Initial Catalog=eschool";    // With Express
