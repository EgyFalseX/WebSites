<%@ Control Language="C#" AutoEventWireup="true" CodeFile="CDAlhasas.ascx.cs" Inherits="CDAlhasas" %>
...
<ValidationSettings CommandsToValidate="Insert,Update"></ValidationSettings>
        ...
        <MasterTableView datakeynames="hasa_code" datasourceid="SqlDataSourceCodez" 
...
<CommandItemStyle Font-Bold="False"></CommandItemStyle>
        ...
        <HeaderStyle Width="20px" ForeColor="Black"></HeaderStyle>
            ...
            <Columns>
                <telerik:GridBoundColumn DataField="hasa_name" 
                    HeaderText="اسم الحصص بالعربيه" SortExpression="hasa_name" 
                    UniqueName="hasa_name">
                    <HeaderStyle HorizontalAlign="Center" />
                    <ItemStyle HorizontalAlign="Center" />
                </telerik:GridBoundColumn>
                <telerik:GridBoundColumn DataField="hasa_name_e" 
                    HeaderText="اسم الحصص بالانجليزيه" SortExpression="hasa_name_e" 
                    UniqueName="hasa_name_e">
                    <HeaderStyle HorizontalAlign="Center" />
                    <ItemStyle HorizontalAlign="Center" />
                </telerik:GridBoundColumn>
