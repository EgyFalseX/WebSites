<%@ Control Language="C#" AutoEventWireup="true" CodeFile="CDHaletalked.ascx.cs" Inherits="CDHaletalked" %>
...
<ValidationSettings CommandsToValidate="Insert,Update"></ValidationSettings>
        ...
        <MasterTableView datakeynames="haletalked_code" datasourceid="SqlDataSourceCodez" 
...
<CommandItemStyle Font-Bold="False"></CommandItemStyle>
        ...
        <HeaderStyle Width="20px" ForeColor="Black"></HeaderStyle>
            ...
            <Columns>
                <telerik:GridBoundColumn DataField="haletalked_name" 
                    HeaderText="اسم حالة القيد بالعربيه" SortExpression="haletalked_name" 
                    UniqueName="haletalked_name">
                    <HeaderStyle HorizontalAlign="Center" />
                    <ItemStyle HorizontalAlign="Center" />
                </telerik:GridBoundColumn>
                <telerik:GridBoundColumn DataField="haletalked_name_e" 
                    HeaderText="اسم حالة القيد بالانجليزيه" SortExpression="haletalked_name_e" 
                    UniqueName="haletalked_name_e">
                    <HeaderStyle HorizontalAlign="Center" />
                    <ItemStyle HorizontalAlign="Center" />
                </telerik:GridBoundColumn>
...
<StatusBarSettings ReadyText="جاهز" LoadingText="تحميل....."></StatusBarSettings>
                ...
                <asp:SqlDataSource ID="SqlDataSourceCodez" runat="server" 
                    ...
                    DeleteCommand="DELETE FROM [CDHaletalked] WHERE [haletalked_code] = @original_haletalked_code" 
                    InsertCommand="INSERT INTO [CDHaletalked] ([haletalked_code], [haletalked_name], [haletalked_name_e]) Select (Select ISNULL(MAX(haletalked_code) + 1, 1) From CDHaletalked), @haletalked_name, @haletalked_name_e" 
                    OldValuesParameterFormatString="original_{0}" ProviderName="System.Data.SqlClient" 
                    SelectCommand="SELECT [haletalked_code], [haletalked_name], [haletalked_name_e] FROM [CDHaletalked]" 
                    
                    
                    
                    
                    UpdateCommand="UPDATE [CDHaletalked] SET [haletalked_name] = @haletalked_name, [haletalked_name_e] = @haletalked_name_e WHERE [haletalked_code] = @original_haletalked_code">
                    <DeleteParameters>
                        <asp:Parameter Name="original_haletalked_code" Type="Byte" />
                    </DeleteParameters>
                    <InsertParameters>
                        <asp:Parameter Name="haletalked_name" Type="String" />
                        <asp:Parameter Name="haletalked_name_e" Type="String" />
                    </InsertParameters>
                    <UpdateParameters>
                        <asp:Parameter Name="haletalked_name" Type="String" />
                        <asp:Parameter Name="haletalked_name_e" Type="String" />
