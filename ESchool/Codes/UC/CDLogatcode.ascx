<%@ Control Language="C#" AutoEventWireup="true" CodeFile="CDLogatcode.ascx.cs" Inherits="CDLogatcode" %>
        ...
        <tr>
            <td>
                ...
                <telerik:RadGrid ID="RadGridEditor" runat="server" DataSourceID="SqlDataSourceCodez" 
                    ...
                    onneeddatasource="RadGridEditor_NeedDataSource">
...
<ValidationSettings CommandsToValidate="Insert,Update"></ValidationSettings>
        ...
        <MasterTableView datakeynames="loga_code" datasourceid="SqlDataSourceCodez" 
...
<CommandItemStyle Font-Bold="False"></CommandItemStyle>
        ...
        <HeaderStyle Width="20px" ForeColor="Black"></HeaderStyle>
            ...
            <Columns>
                <telerik:GridBoundColumn DataField="loga_name" 
                    HeaderText="اكواد اللغات بالعربيه" SortExpression="loga_name" 
                    UniqueName="loga_name">
                    <HeaderStyle HorizontalAlign="Center" />
                    <ItemStyle HorizontalAlign="Center" />
                </telerik:GridBoundColumn>
                <telerik:GridBoundColumn DataField="loga_name_e" 
                    HeaderText="اكواد اللغات بالانجليزيه" SortExpression="loga_name_e" 
                    UniqueName="loga_name_e">
                    <HeaderStyle HorizontalAlign="Center" />
                    <ItemStyle HorizontalAlign="Center" />
                </telerik:GridBoundColumn>
...
<StatusBarSettings ReadyText="جاهز" LoadingText="تحميل....."></StatusBarSettings>
                ...
                <asp:SqlDataSource ID="SqlDataSourceCodez" runat="server" 
                    ...
                    DeleteCommand="DELETE FROM [CDLogatcode] WHERE [loga_code] = @original_loga_code" 
                    InsertCommand="INSERT INTO [CDLogatcode] ([loga_code], [loga_name], [loga_name_e]) Select (Select ISNULL(MAX(loga_code) + 1, 1) From CDLogatcode), @loga_name, @loga_name_e" 
                    OldValuesParameterFormatString="original_{0}" ProviderName="System.Data.SqlClient" 
                    SelectCommand="SELECT [loga_code], [loga_name], [loga_name_e] FROM [CDLogatcode]" 
                    
                    
                    
                    
                    UpdateCommand="UPDATE [CDLogatcode] SET [loga_name] = @loga_name, [loga_name_e] = @loga_name_e WHERE [loga_code] = @original_loga_code">
                    <DeleteParameters>
                        <asp:Parameter Name="original_loga_code" Type="Byte" />
                    </DeleteParameters>
                    <InsertParameters>
                        <asp:Parameter Name="loga_name" Type="String" />
                        <asp:Parameter Name="loga_name_e" Type="String" />
                    </InsertParameters>
                    <UpdateParameters>
                        <asp:Parameter Name="loga_name" Type="String" />
                        <asp:Parameter Name="loga_name_e" Type="String" />
