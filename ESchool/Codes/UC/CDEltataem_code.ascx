<%@ Control Language="C#" AutoEventWireup="true" CodeFile="CDEltataem_code.ascx.cs" Inherits="CDEltataem_code" %>
...
<ValidationSettings CommandsToValidate="Insert,Update"></ValidationSettings>
        ...
        <MasterTableView datakeynames="code_eltataem" datasourceid="SqlDataSourceCodez" 
...
<CommandItemStyle Font-Bold="False"></CommandItemStyle>
        ...
        <HeaderStyle Width="20px" ForeColor="Black"></HeaderStyle>
            ...
            <Columns>
                <telerik:GridBoundColumn DataField="name_eltataem" 
                    HeaderText="اسم التطعيم بالعربيه" SortExpression="name_eltataem" 
                    UniqueName="name_eltataem">
                    <HeaderStyle HorizontalAlign="Center" />
                    <ItemStyle HorizontalAlign="Center" />
                </telerik:GridBoundColumn>
                <telerik:GridBoundColumn DataField="name_eltataem_e" 
                    HeaderText="اسم التطعيم بالانجليزيه" SortExpression="name_eltataem_e" 
                    UniqueName="name_eltataem_e">
                    <HeaderStyle HorizontalAlign="Center" />
                    <ItemStyle HorizontalAlign="Center" />
                </telerik:GridBoundColumn>
...
<StatusBarSettings ReadyText="جاهز" LoadingText="تحميل....."></StatusBarSettings>
                ...
                <asp:SqlDataSource ID="SqlDataSourceCodez" runat="server" 
                    ...
                    DeleteCommand="DELETE FROM [CDEltataem_code] WHERE [code_eltataem] = @original_code_eltataem" 
                    InsertCommand="INSERT INTO [CDEltataem_code] ([code_eltataem], [name_eltataem], [name_eltataem_e]) Select (Select ISNULL(MAX(code_eltataem) + 1, 1) From CDEltataem_code), @name_eltataem, @name_eltataem_e" 
                    OldValuesParameterFormatString="original_{0}" ProviderName="System.Data.SqlClient" 
                    SelectCommand="SELECT [code_eltataem], [name_eltataem], [name_eltataem_e] FROM [CDEltataem_code]" 
                    
                    
                    
                    
                    UpdateCommand="UPDATE [CDEltataem_code] SET [name_eltataem] = @name_eltataem, [name_eltataem_e] = @name_eltataem_e WHERE [code_eltataem] = @original_code_eltataem">
                    <DeleteParameters>
                        <asp:Parameter Name="original_code_eltataem" Type="Byte" />
                    </DeleteParameters>
                    <InsertParameters>
                        <asp:Parameter Name="code_eltataem" Type="Byte" />
                        <asp:Parameter Name="name_eltataem" Type="String" />
                        <asp:Parameter Name="name_eltataem_e" Type="String" />
                    </InsertParameters>
                    <UpdateParameters>
                        <asp:Parameter Name="name_eltataem" Type="String" />
                        <asp:Parameter Name="name_eltataem_e" Type="String" />
