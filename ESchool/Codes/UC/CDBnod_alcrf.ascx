<%@ Control Language="C#" AutoEventWireup="true" CodeFile="CDBnod_alcrf.ascx.cs" Inherits="CDBnod_alcrf" %>
...
<ValidationSettings CommandsToValidate="Insert,Update"></ValidationSettings>
        ...
        <MasterTableView datakeynames="code_band_alcrf" datasourceid="SqlDataSourceCodez" 
...
<CommandItemStyle Font-Bold="False"></CommandItemStyle>
        ...
        <HeaderStyle Width="20px" ForeColor="Black"></HeaderStyle>
            ...
            <Columns>
                <telerik:GridBoundColumn DataField="name_band_alcrf" 
                    HeaderText="اسم بند الصرف" SortExpression="name_band_alcrf" 
                    UniqueName="name_band_alcrf">
...
<StatusBarSettings ReadyText="جاهز" LoadingText="تحميل....."></StatusBarSettings>
                ...
                <asp:SqlDataSource ID="SqlDataSourceCodez" runat="server" 
                    ...
                    DeleteCommand="DELETE FROM [CDBnod_alcrf] WHERE [code_band_alcrf] = @original_code_band_alcrf" 
                    InsertCommand="INSERT INTO [CDBnod_alcrf] ([code_band_alcrf], [name_band_alcrf]) Select (Select ISNULL(MAX(code_band_alcrf) + 1, 1) From CDBnod_alcrf), @name_band_alcrf" 
                    OldValuesParameterFormatString="original_{0}" ProviderName="System.Data.SqlClient" 
                    SelectCommand="SELECT [code_band_alcrf], [name_band_alcrf] FROM [CDBnod_alcrf]" 
                    
                    
                    
                    
                    UpdateCommand="UPDATE [CDBnod_alcrf] SET [name_band_alcrf] = @name_band_alcrf WHERE [code_band_alcrf] = @original_code_band_alcrf">
                    <DeleteParameters>
                        <asp:Parameter Name="original_code_band_alcrf" Type="Byte" />
                    </DeleteParameters>
                    <InsertParameters>
                        <asp:Parameter Name="code_band_alcrf" Type="Byte" />
                        <asp:Parameter Name="name_band_alcrf" Type="String" />
                    </InsertParameters>
                    <UpdateParameters>
                        <asp:Parameter Name="name_band_alcrf" Type="String" />
                        <asp:Parameter Name="original_code_band_alcrf" Type="Byte" />
