<%@ Control Language="C#" AutoEventWireup="true" CodeFile="CDFaslDrasy.ascx.cs" Inherits="CDFaslDrasy" %>
...
<ValidationSettings CommandsToValidate="Insert,Update"></ValidationSettings>
        ...
        <MasterTableView datakeynames="code_al_fasl" datasourceid="SqlDataSourceCodez" 
...
<CommandItemStyle Font-Bold="False"></CommandItemStyle>
        ...
        <HeaderStyle Width="20px" ForeColor="Black"></HeaderStyle>
            ...
            <Columns>
                <telerik:GridBoundColumn DataField="name_al_fasl" 
                    HeaderText="اسم الفصل الدراسي بالعربيه" SortExpression="name_al_fasl" 
                    UniqueName="name_al_fasl">
                    <HeaderStyle HorizontalAlign="Center" />
                    <ItemStyle HorizontalAlign="Center" />
                </telerik:GridBoundColumn>
                <telerik:GridBoundColumn DataField="name_al_fasl_e" 
                    HeaderText="اسم الفصل الدراسي بالانجليزيه" SortExpression="name_al_fasl_e" 
                    UniqueName="name_al_fasl_e">
                    <HeaderStyle HorizontalAlign="Center" />
                    <ItemStyle HorizontalAlign="Center" />
                </telerik:GridBoundColumn>
...
<StatusBarSettings ReadyText="جاهز" LoadingText="تحميل....."></StatusBarSettings>
                ...
                <asp:SqlDataSource ID="SqlDataSourceCodez" runat="server" 
                    ...
                    DeleteCommand="DELETE FROM [CDFaslDrasy] WHERE [code_al_fasl] = @original_code_al_fasl" 
                    InsertCommand="INSERT INTO [CDFaslDrasy] ([code_al_fasl], [name_al_fasl], [name_al_fasl_e]) Select (Select ISNULL(MAX(code_al_fasl) + 1, 1) From CDFaslDrasy), @name_al_fasl, @name_al_fasl_e" 
                    OldValuesParameterFormatString="original_{0}" ProviderName="System.Data.SqlClient" 
                    SelectCommand="SELECT [code_al_fasl], [name_al_fasl], [name_al_fasl_e] FROM [CDFaslDrasy]" 
                    
                    
                    
                    
                    UpdateCommand="UPDATE [CDFaslDrasy] SET [name_al_fasl] = @name_al_fasl, [name_al_fasl_e] = @name_al_fasl_e WHERE [code_al_fasl] = @original_code_al_fasl">
                    <DeleteParameters>
                        <asp:Parameter Name="original_code_al_fasl" Type="Byte" />
                    </DeleteParameters>
                    <InsertParameters>
                        <asp:Parameter Name="name_al_fasl" Type="String" />
                        <asp:Parameter Name="name_al_fasl_e" Type="String" />
                    </InsertParameters>
                    <UpdateParameters>
                        <asp:Parameter Name="name_al_fasl" Type="String" />
                        <asp:Parameter Name="name_al_fasl_e" Type="String" />
