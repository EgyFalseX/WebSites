<%@ Control Language="C#" AutoEventWireup="true" CodeFile="CDColekeyat.ascx.cs" Inherits="CDColekeyat" %>
...
<ValidationSettings CommandsToValidate="Insert,Update"></ValidationSettings>
        ...
        <MasterTableView datakeynames="colekeyat_code" datasourceid="SqlDataSourceCodez" 
...
<CommandItemStyle Font-Bold="False"></CommandItemStyle>
        ...
        <HeaderStyle Width="20px" ForeColor="Black"></HeaderStyle>
            ...
            <Columns>
                <telerik:GridBoundColumn DataField="colekeyat_name" 
                    HeaderText="اسم السلوك بالعربيه" SortExpression="colekeyat_name" 
                    UniqueName="colekeyat_name">
                </telerik:GridBoundColumn>
                <telerik:GridBoundColumn DataField="colekeyat_name_e" 
                    HeaderText="اسم السلوك بالانجليزيه" SortExpression="colekeyat_name_e" 
                    UniqueName="colekeyat_name_e">
                </telerik:GridBoundColumn>
...
<StatusBarSettings ReadyText="جاهز" LoadingText="تحميل....."></StatusBarSettings>
                ...
                <asp:SqlDataSource ID="SqlDataSourceCodez" runat="server" 
                    ...
                    DeleteCommand="DELETE FROM [CDColekeyat] WHERE [colekeyat_code] = @original_colekeyat_code" 
                    InsertCommand="INSERT INTO [CDColekeyat] ([colekeyat_code], [colekeyat_name], [colekeyat_name_e]) Select (Select ISNULL(MAX(colekeyat_code) + 1, 1) From CDColekeyat), @colekeyat_name, @colekeyat_name_e" 
                    OldValuesParameterFormatString="original_{0}" ProviderName="System.Data.SqlClient" 
                    SelectCommand="SELECT [colekeyat_code], [colekeyat_name], [colekeyat_name_e] FROM [CDColekeyat]" 
                    ...
                    UpdateCommand="UPDATE [CDColekeyat] SET [colekeyat_name] = @colekeyat_name, [colekeyat_name_e] = @colekeyat_name_e WHERE [colekeyat_code] = @original_colekeyat_code">
                    <DeleteParameters>
                        <asp:Parameter Name="original_colekeyat_code" Type="Byte" />
                    </DeleteParameters>
                    <InsertParameters>
                        <asp:Parameter Name="colekeyat_code" Type="Byte" />
                        <asp:Parameter Name="colekeyat_name" Type="String" />
                        <asp:Parameter Name="colekeyat_name_e" Type="String" />
                    </InsertParameters>
                    <UpdateParameters>
                        <asp:Parameter Name="colekeyat_name" Type="String" />
                        <asp:Parameter Name="colekeyat_name_e" Type="String" />
