<%@ Control Language="C#" AutoEventWireup="true" CodeFile="CDTakdeer.ascx.cs" Inherits="CDTakdeer" %>
...
<ValidationSettings CommandsToValidate="Insert,Update"></ValidationSettings>
        ...
        <MasterTableView datakeynames="TakdeerId" datasourceid="SqlDataSourceCodez" 
...
<CommandItemStyle Font-Bold="False"></CommandItemStyle>
        ...
        <HeaderStyle Width="20px" ForeColor="Black"></HeaderStyle>
            ...
            <Columns>
                <telerik:GridBoundColumn DataField="TakdeerName" 
                    HeaderText="اسم التقدير بالعربيه" SortExpression="TakdeerName" 
                    UniqueName="TakdeerName">
                    <HeaderStyle HorizontalAlign="Center" />
                    <ItemStyle HorizontalAlign="Center" />
                </telerik:GridBoundColumn>
                <telerik:GridBoundColumn DataField="TakdeerName_e" 
                    HeaderText="اسم التقدير بالانجليزيه" SortExpression="TakdeerName_e" 
                    UniqueName="TakdeerName_e">
                    <HeaderStyle HorizontalAlign="Center" />
                    <ItemStyle HorizontalAlign="Center" />
                </telerik:GridBoundColumn>
...
<StatusBarSettings ReadyText="جاهز" LoadingText="تحميل....."></StatusBarSettings>
                ...
                <asp:SqlDataSource ID="SqlDataSourceCodez" runat="server" 
                    ...
                    DeleteCommand="DELETE FROM [CDTakdeer] WHERE [TakdeerId] = @original_TakdeerId" 
                    InsertCommand="INSERT INTO [CDTakdeer] ([TakdeerId], [TakdeerName], [TakdeerName_e]) Select(Select ISNULL(MAX(TakdeerId) + 1, 1) From CDTakdeer), @TakdeerName, @TakdeerName_e" 
                    OldValuesParameterFormatString="original_{0}" ProviderName="System.Data.SqlClient" 
                    SelectCommand="SELECT [TakdeerId], [TakdeerName], [TakdeerName_e] FROM [CDTakdeer]" 
                    
                    
                    
                    
                    UpdateCommand="UPDATE [CDTakdeer] SET [TakdeerName] = @TakdeerName, [TakdeerName_e] = @TakdeerName_e WHERE [TakdeerId] = @original_TakdeerId">
                    <DeleteParameters>
                        <asp:Parameter Name="original_TakdeerId" Type="Byte" />
                    </DeleteParameters>
                    <InsertParameters>
                        <asp:Parameter Name="TakdeerName" Type="String" />
                        <asp:Parameter Name="TakdeerName_e" Type="String" />
                    </InsertParameters>
                    <UpdateParameters>
                        <asp:Parameter Name="TakdeerName" Type="String" />
                        <asp:Parameter Name="TakdeerName_e" Type="String" />
