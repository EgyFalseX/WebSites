<%@ Control Language="C#" AutoEventWireup="true" CodeFile="CDEmpJop.ascx.cs" Inherits="CDEmpJop" %>
...
<ValidationSettings CommandsToValidate="Insert,Update"></ValidationSettings>
        ...
        <MasterTableView datakeynames="EmpJopId" datasourceid="SqlDataSourceCodez" 
...
<CommandItemStyle Font-Bold="False"></CommandItemStyle>
        ...
        <HeaderStyle Width="20px" ForeColor="Black"></HeaderStyle>
            ...
            <Columns>
                <telerik:GridBoundColumn DataField="EmpJopName" 
                    HeaderText="اسم الوظيفه بالعربيه" SortExpression="EmpJopName" 
                    UniqueName="EmpJopName">
                    <HeaderStyle HorizontalAlign="Center" />
                    <ItemStyle HorizontalAlign="Center" />
                </telerik:GridBoundColumn>
                <telerik:GridBoundColumn DataField="EmpJopName_e" 
                    HeaderText="اسم الوظيفه بالانجليزيه" SortExpression="EmpJopName_e" 
                    UniqueName="EmpJopName_e">
                    <HeaderStyle HorizontalAlign="Center" />
                    <ItemStyle HorizontalAlign="Center" />
                </telerik:GridBoundColumn>
...
<StatusBarSettings ReadyText="جاهز" LoadingText="تحميل....."></StatusBarSettings>
                ...
                <asp:SqlDataSource ID="SqlDataSourceCodez" runat="server" 
                    ...
                    DeleteCommand="DELETE FROM [CDEmpJop] WHERE [EmpJopId] = @original_EmpJopId" 
                    InsertCommand="INSERT INTO [CDEmpJop] ([EmpJopId], [EmpJopName], [EmpJopName_e]) Select (Select ISNULL(MAX(EmpJopId) + 1, 1) From CDEmpJop), @EmpJopName, @EmpJopName_e" 
                    OldValuesParameterFormatString="original_{0}" ProviderName="System.Data.SqlClient" 
                    SelectCommand="SELECT [EmpJopId], [EmpJopName], [EmpJopName_e] FROM [CDEmpJop]" 
                    
                    
                    
                    
                    UpdateCommand="UPDATE [CDEmpJop] SET [EmpJopName] = @EmpJopName, [EmpJopName_e] = @EmpJopName_e WHERE [EmpJopId] = @original_EmpJopId">
                    <DeleteParameters>
                        <asp:Parameter Name="original_EmpJopId" Type="Byte" />
                    </DeleteParameters>
                    <InsertParameters>
                        <asp:Parameter Name="EmpJopName" Type="String" />
                        <asp:Parameter Name="EmpJopName_e" Type="String" />
                    </InsertParameters>
                    <UpdateParameters>
                        <asp:Parameter Name="EmpJopName" Type="String" />
                        <asp:Parameter Name="EmpJopName_e" Type="String" />
