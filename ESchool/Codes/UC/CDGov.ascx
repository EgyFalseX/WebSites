...
<ValidationSettings CommandsToValidate="Insert,Update"></ValidationSettings>
        ...
        <MasterTableView datakeynames="GOV_CD" datasourceid="SqlDataSourceCodez" 
        ...
        <HeaderStyle Width="20px" ForeColor="Black"></HeaderStyle>
            ...
            <Columns>
                <telerik:GridBoundColumn DataField="GOV" 
                    HeaderText="اسم المحافظه بالعربيه" SortExpression="GOV" 
                    UniqueName="GOV">
                </telerik:GridBoundColumn>
                <telerik:GridBoundColumn DataField="GOVe" 
                    HeaderText="اسم المحافظه بالانجليزيه" SortExpression="GOVe" 
                    UniqueName="GOVe">
                </telerik:GridBoundColumn>
...
<StatusBarSettings ReadyText="جاهز" LoadingText="تحميل....."></StatusBarSettings>
                ...
                <asp:SqlDataSource ID="SqlDataSourceCodez" runat="server" 
                    ...
                    DeleteCommand="DELETE FROM [CDGov] WHERE [GOV_CD] = @original_GOV_CD" 
                    InsertCommand="INSERT INTO [CDGov] ([GOV_CD], [GOV], [GOVe]) Select (Select ISNULL(MAX(GOV_CD) + 1, 1) From CDGov), @GOV, @GOVe" 
                    ...
                    UpdateCommand="UPDATE [CDGov] SET [GOV] = @GOV, [GOVe] = @GOVe WHERE [GOV_CD] = @original_GOV_CD">
                    <DeleteParameters>
                        <asp:Parameter Name="original_GOV_CD" Type="Byte" />
                    </DeleteParameters>
                    <InsertParameters>
                        <asp:Parameter Name="GOV" Type="String" />
                        <asp:Parameter Name="GOVe" Type="String" />
                    </InsertParameters>
                    <UpdateParameters>
                        <asp:Parameter Name="GOV" Type="String" />
                        <asp:Parameter Name="GOVe" Type="String" />
