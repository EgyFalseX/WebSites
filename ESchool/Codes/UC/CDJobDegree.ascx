<%@ Control Language="C#" AutoEventWireup="true" CodeFile="CDJobDegree.ascx.cs" Inherits="CDJobDegree" %>
...
<ValidationSettings CommandsToValidate="Insert,Update"></ValidationSettings>
        ...
        <MasterTableView datakeynames="JobGegreeId" datasourceid="SqlDataSourceCodez" 
...
<CommandItemStyle Font-Bold="False"></CommandItemStyle>
        ...
        <HeaderStyle Width="20px" ForeColor="Black"></HeaderStyle>
            ...
            <Columns>
                <telerik:GridBoundColumn DataField="JobGegreeName" 
                    HeaderText="أسم الدرجه الوظيفيه بالعربيه" SortExpression="JobGegreeName" 
                    UniqueName="JobGegreeName">
                    <HeaderStyle HorizontalAlign="Center" />
                    <ItemStyle HorizontalAlign="Center" />
                </telerik:GridBoundColumn>
                <telerik:GridBoundColumn DataField="JobGegreeName_e" 
                    HeaderText="أسم الدرجه الوظيفيه بالانجليزيه" SortExpression="JobGegreeName_e" 
                    UniqueName="JobGegreeName_e">
                    <HeaderStyle HorizontalAlign="Center" />
                    <ItemStyle HorizontalAlign="Center" />
                </telerik:GridBoundColumn>
...
<StatusBarSettings ReadyText="جاهز" LoadingText="تحميل....."></StatusBarSettings>
                ...
                <asp:SqlDataSource ID="SqlDataSourceCodez" runat="server" 
                    ...
                    DeleteCommand="DELETE FROM [CDJobDegree] WHERE [JobGegreeId] = @original_JobGegreeId" 
                    InsertCommand="INSERT INTO [CDJobDegree] ([JobGegreeId], [JobGegreeName], [JobGegreeName_e]) Select (Select ISNULL(MAX(JobGegreeId) + 1, 1) From CDJobDegree), @JobGegreeName, @JobGegreeName_e" 
                    OldValuesParameterFormatString="original_{0}" ProviderName="System.Data.SqlClient" 
                    SelectCommand="SELECT [JobGegreeId], [JobGegreeName], [JobGegreeName_e] FROM [CDJobDegree]" 
                    
                    
                    
                    
                    UpdateCommand="UPDATE [CDJobDegree] SET [JobGegreeName] = @JobGegreeName, [JobGegreeName_e] = @JobGegreeName_e WHERE [JobGegreeId] = @original_JobGegreeId">
                    <DeleteParameters>
                        <asp:Parameter Name="original_JobGegreeId" Type="Byte" />
                    </DeleteParameters>
                    <InsertParameters>
                        <asp:Parameter Name="JobGegreeName" Type="String" />
                        <asp:Parameter Name="JobGegreeName_e" Type="String" />
                    </InsertParameters>
                    <UpdateParameters>
                        <asp:Parameter Name="JobGegreeName" Type="String" />
                        <asp:Parameter Name="JobGegreeName_e" Type="String" />
