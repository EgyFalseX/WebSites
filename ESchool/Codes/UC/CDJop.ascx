<%@ Control Language="C#" AutoEventWireup="true" CodeFile="CDJop.ascx.cs" Inherits="CDJop" %>
...
<ValidationSettings CommandsToValidate="Insert,Update"></ValidationSettings>
        ...
        <MasterTableView datakeynames="jop_code" datasourceid="SqlDataSourceCodez" 
...
<CommandItemStyle Font-Bold="False"></CommandItemStyle>
        ...
        <HeaderStyle Width="20px" ForeColor="Black"></HeaderStyle>
            ...
            <Columns>
                <telerik:GridBoundColumn DataField="jop_name" 
                    HeaderText="اسم الوظيفه بالعربيه" SortExpression="jop_name" 
                    UniqueName="jop_name">
                    <HeaderStyle HorizontalAlign="Center" />
                    <ItemStyle HorizontalAlign="Center" />
                </telerik:GridBoundColumn>
                <telerik:GridBoundColumn DataField="jop_name_e" 
                    HeaderText="اسم الوظيفه بالانجليزيه" SortExpression="jop_name_e" 
                    UniqueName="jop_name_e">
                    <HeaderStyle HorizontalAlign="Center" />
                    <ItemStyle HorizontalAlign="Center" />
                </telerik:GridBoundColumn>
...
<StatusBarSettings ReadyText="جاهز" LoadingText="تحميل....."></StatusBarSettings>
                ...
                <asp:SqlDataSource ID="SqlDataSourceCodez" runat="server" 
                    ...
                    DeleteCommand="DELETE FROM [CDJop] WHERE [jop_code] = @original_jop_code" 
                    InsertCommand="INSERT INTO [CDJop] ([jop_code], [jop_name], [jop_name_e]) Select (Select ISNULL(MAX(jop_code) + 1, 1) From CDJop), @jop_name, @jop_name_e" 
                    OldValuesParameterFormatString="original_{0}" ProviderName="System.Data.SqlClient" 
                    SelectCommand="SELECT [jop_code], [jop_name], [jop_name_e] FROM [CDJop]" 
                    
                    
                    
                    
                    UpdateCommand="UPDATE [CDJop] SET [jop_name] = @jop_name, [jop_name_e] = @jop_name_e WHERE [jop_code] = @original_jop_code">
                    <DeleteParameters>
                        <asp:Parameter Name="original_jop_code" Type="Int32" />
                    </DeleteParameters>
                    <InsertParameters>
                        <asp:Parameter Name="jop_name" Type="String" />
                        <asp:Parameter Name="jop_name_e" Type="String" />
                    </InsertParameters>
                    <UpdateParameters>
                        <asp:Parameter Name="jop_name" Type="String" />
                        <asp:Parameter Name="jop_name_e" Type="String" />
