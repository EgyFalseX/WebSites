...
<ValidationSettings CommandsToValidate="Insert,Update"></ValidationSettings>
        ...
        <MasterTableView datakeynames="bankID" datasourceid="SqlDataSourceCodez" 
        ...
        <HeaderStyle Width="20px" ForeColor="Black"></HeaderStyle>
            ...
            <Columns>
                <telerik:GridBoundColumn DataField="bankname" 
                    HeaderText="اسم البنك بالعربيه" SortExpression="bankname" 
                    UniqueName="bankname">
                    <HeaderStyle HorizontalAlign="Center" />
                    <ItemStyle HorizontalAlign="Center" />
                </telerik:GridBoundColumn>
                <telerik:GridBoundColumn DataField="bankname_E" 
                    HeaderText="اسم البنك بالانجليزيه" SortExpression="bankname_E" 
                    UniqueName="bankname_E">
                    <HeaderStyle HorizontalAlign="Center" />
                    <ItemStyle HorizontalAlign="Center" />
                </telerik:GridBoundColumn>
...
<StatusBarSettings ReadyText="جاهز" LoadingText="تحميل....."></StatusBarSettings>
                ...
                <asp:SqlDataSource ID="SqlDataSourceCodez" runat="server" 
                    ...
                    DeleteCommand="DELETE FROM [CDBank] WHERE [bankID] = @original_bankID" 
                    InsertCommand="INSERT INTO [CDBank] ([bankID], [bankname], [bankname_E]) Select(Select ISNULL(MAX(bankID) + 1, 1) From CDBank), @bankname, @bankname_E" 
                    OldValuesParameterFormatString="original_{0}" ProviderName="System.Data.SqlClient" 
                    SelectCommand="SELECT [bankID], [bankname], [bankname_E] FROM [CDBank]" 
                    
                    
                    
                    
                    UpdateCommand="UPDATE [CDBank] SET [bankname] = @bankname, [bankname_E] = @bankname_E WHERE [bankID] = @original_bankID">
                    <DeleteParameters>
                        <asp:Parameter Name="original_bankID" Type="Byte" />
                    </DeleteParameters>
                    <InsertParameters>
                        <asp:Parameter Name="bankID" Type="Byte" />
                        <asp:Parameter Name="bankname" Type="String" />
                        <asp:Parameter Name="bankname_E" Type="String" />
                    </InsertParameters>
                    <UpdateParameters>
                        <asp:Parameter Name="bankname" Type="String" />
                        <asp:Parameter Name="bankname_E" Type="String" />
