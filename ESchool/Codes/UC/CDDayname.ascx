<%@ Control Language="C#" AutoEventWireup="true" CodeFile="CDDayname.ascx.cs" Inherits="CDDayname" %>
...
<ValidationSettings CommandsToValidate="Insert,Update"></ValidationSettings>
        ...
        <MasterTableView datakeynames="daycode" datasourceid="SqlDataSourceCodez" 
...
<CommandItemStyle Font-Bold="False"></CommandItemStyle>
        ...
        <HeaderStyle Width="20px" ForeColor="Black"></HeaderStyle>
            ...
            <Columns>
                <telerik:GridBoundColumn DataField="dayname" 
                    HeaderText="اسم اليوم بالعربيه" SortExpression="dayname" 
                    UniqueName="dayname">
                    <HeaderStyle HorizontalAlign="Center" />
                    <ItemStyle HorizontalAlign="Center" />
                </telerik:GridBoundColumn>
                <telerik:GridBoundColumn DataField="dayname_e" 
                    HeaderText="اسم اليوم بالانجليزيه" SortExpression="dayname_e" 
                    UniqueName="dayname_e">
                    <HeaderStyle HorizontalAlign="Center" />
                    <ItemStyle HorizontalAlign="Center" />
                </telerik:GridBoundColumn>
...
<StatusBarSettings ReadyText="جاهز" LoadingText="تحميل....."></StatusBarSettings>
                ...
                <asp:SqlDataSource ID="SqlDataSourceCodez" runat="server" 
                    ...
                    DeleteCommand="DELETE FROM [CDDayname] WHERE [daycode] = @original_daycode" 
                    InsertCommand="INSERT INTO [CDDayname] ([daycode], [dayname], [dayname_e]) Select (Select ISNULL(MAX(daycode) + 1, 1) From CDDayname), @dayname, @dayname_e" 
                    ...
                    UpdateCommand="UPDATE [CDDayname] SET [dayname] = @dayname, [dayname_e] = @dayname_e WHERE [daycode] = @original_daycode">
                    <DeleteParameters>
                        <asp:Parameter Name="original_daycode" Type="Int32" />
                    </DeleteParameters>
                    <InsertParameters>
                        <asp:Parameter Name="dayname" Type="String" />
                        <asp:Parameter Name="dayname_e" Type="String" />
                    </InsertParameters>
                    <UpdateParameters>
                        <asp:Parameter Name="dayname" Type="String" />
                        <asp:Parameter Name="dayname_e" Type="String" />
