<%@ Control Language="C#" AutoEventWireup="true" CodeFile="CDAlokobat.ascx.cs" Inherits="CDAlokobat" %>
...
<ValidationSettings CommandsToValidate="Insert,Update"></ValidationSettings>
        ...
        <MasterTableView datakeynames="code_alokobat" datasourceid="SqlDataSourceCodez" 
...
<CommandItemStyle Font-Bold="False"></CommandItemStyle>
        ...
        <HeaderStyle Width="20px" ForeColor="Black"></HeaderStyle>
            ...
            <Columns>
                <telerik:GridBoundColumn DataField="name_alokobat" 
                    HeaderText="اسم العقوبه بالعربيه" SortExpression="name_alokobat" 
                    UniqueName="name_alokobat">
                    <HeaderStyle HorizontalAlign="Center" />
                    <ItemStyle HorizontalAlign="Center" />
                </telerik:GridBoundColumn>
                <telerik:GridBoundColumn DataField="name_alokobat_e" 
                    HeaderText="اسم العقوبه بالانجليزيه" SortExpression="name_alokobat_e" 
                    UniqueName="name_alokobat_e">
                    <HeaderStyle HorizontalAlign="Center" />
                    <ItemStyle HorizontalAlign="Center" />
                </telerik:GridBoundColumn>
...
<StatusBarSettings ReadyText="جاهز" LoadingText="تحميل....."></StatusBarSettings>
                ...
                <asp:SqlDataSource ID="SqlDataSourceCodez" runat="server" 
                    ...
                    DeleteCommand="DELETE FROM [CDAlokobat] WHERE [code_alokobat] = @original_code_alokobat" 
                    InsertCommand="INSERT INTO [CDAlokobat] ([code_alokobat], [name_alokobat], [name_alokobat_e]) Select (Select ISNULL(MAX(code_alokobat) + 1, 1) From CDAlokobat), @name_alokobat, @name_alokobat_e" 
                    OldValuesParameterFormatString="original_{0}" ProviderName="System.Data.SqlClient" 
                    SelectCommand="SELECT [code_alokobat], [name_alokobat], [name_alokobat_e] FROM [CDAlokobat]" 
                    ...
                    UpdateCommand="UPDATE [CDAlokobat] SET [name_alokobat] = @name_alokobat, [name_alokobat_e] = @name_alokobat_e WHERE [code_alokobat] = @original_code_alokobat">
                    <DeleteParameters>
                        <asp:Parameter Name="original_code_alokobat" Type="Byte" />
                    </DeleteParameters>
                    <InsertParameters>
                        <asp:Parameter Name="name_alokobat" Type="String" />
                        <asp:Parameter Name="name_alokobat_e" Type="String" />
                    </InsertParameters>
                    <UpdateParameters>
                        <asp:Parameter Name="name_alokobat" Type="String" />
                        <asp:Parameter Name="name_alokobat_e" Type="String" />
