<%@ Control Language="C#" AutoEventWireup="true" CodeFile="CDJOBCases.ascx.cs" Inherits="CDJOBCases" %>
...
<ValidationSettings CommandsToValidate="Insert,Update"></ValidationSettings>
        ...
        <MasterTableView datakeynames="JOBCaseID" datasourceid="SqlDataSourceCodez" 
...
<CommandItemStyle Font-Bold="False"></CommandItemStyle>
        ...
        <HeaderStyle Width="20px" ForeColor="Black"></HeaderStyle>
            ...
            <Columns>
                <telerik:GridBoundColumn DataField="JOBCaseName" 
                    HeaderText="اسم الحاله الوظيفيه بالعربيه" SortExpression="JOBCaseName" 
                    UniqueName="JOBCaseName">
                    <HeaderStyle HorizontalAlign="Center" />
                    <ItemStyle HorizontalAlign="Center" />
                </telerik:GridBoundColumn>
                <telerik:GridBoundColumn DataField="JOBCaseName_e" 
                    HeaderText="اسم الحاله الوظيفيه بالانجليزيه" SortExpression="JOBCaseName_e" 
                    UniqueName="JOBCaseName_e">
                    <HeaderStyle HorizontalAlign="Center" />
                    <ItemStyle HorizontalAlign="Center" />
                </telerik:GridBoundColumn>
...
<StatusBarSettings ReadyText="جاهز" LoadingText="تحميل....."></StatusBarSettings>
                ...
                <asp:SqlDataSource ID="SqlDataSourceCodez" runat="server" 
                    ...
                    DeleteCommand="DELETE FROM [CDJOBCases] WHERE [JOBCaseID] = @original_JOBCaseID" 
                    InsertCommand="INSERT INTO [CDJOBCases] ([JOBCaseID], [JOBCaseName], [JOBCaseName_e]) Select (Select ISNULL(MAX(JOBCaseID) + 1, 1) From CDJOBCases), @JOBCaseName, @JOBCaseName_e" 
                    OldValuesParameterFormatString="original_{0}" ProviderName="System.Data.SqlClient" 
                    SelectCommand="SELECT [JOBCaseID], [JOBCaseName], [JOBCaseName_e] FROM [CDJOBCases]" 
                    
                    
                    
                    
                    UpdateCommand="UPDATE [CDJOBCases] SET [JOBCaseName] = @JOBCaseName, [JOBCaseName_e] = @JOBCaseName_e WHERE [JOBCaseID] = @original_JOBCaseID">
                    <DeleteParameters>
                        <asp:Parameter Name="original_JOBCaseID" Type="Byte" />
                    </DeleteParameters>
                    <InsertParameters>
                        <asp:Parameter Name="JOBCaseName" Type="String" />
                        <asp:Parameter Name="JOBCaseName_e" Type="String" />
                    </InsertParameters>
                    <UpdateParameters>
                        <asp:Parameter Name="JOBCaseName" Type="String" />
                        <asp:Parameter Name="JOBCaseName_e" Type="String" />
