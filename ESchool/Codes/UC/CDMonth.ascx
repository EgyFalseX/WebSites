<%@ Control Language="C#" AutoEventWireup="true" CodeFile="CDMonth.ascx.cs" Inherits="CDMonth" %>
...
<ValidationSettings CommandsToValidate="Insert,Update"></ValidationSettings>
        ...
        <MasterTableView datakeynames="month_code" datasourceid="SqlDataSourceCodez" 
        ...
        <HeaderStyle Width="20px" ForeColor="Black"></HeaderStyle>
            ...
            <Columns>
                <telerik:GridBoundColumn DataField="month_name" 
                    HeaderText="اسم الشهر بالعربيه" SortExpression="month_name" 
                    UniqueName="month_name">
                    <HeaderStyle HorizontalAlign="Center" />
                    <ItemStyle HorizontalAlign="Center" />
                </telerik:GridBoundColumn>
                <telerik:GridBoundColumn DataField="month_name_e" 
                    HeaderText="اسم الشهر بالانجليزيه" SortExpression="month_name_e" 
                    UniqueName="month_name_e">
                    <HeaderStyle HorizontalAlign="Center" />
                    <ItemStyle HorizontalAlign="Center" />
                </telerik:GridBoundColumn>
...
<StatusBarSettings ReadyText="جاهز" LoadingText="تحميل....."></StatusBarSettings>
                ...
                <asp:SqlDataSource ID="SqlDataSourceCodez" runat="server" 
                    ...
                    DeleteCommand="DELETE FROM [CDMonth] WHERE [month_code] = @original_month_code" 
                    InsertCommand="INSERT INTO [CDMonth] ([month_code], [month_name], [month_name_e]) Select (Select ISNULL(MAX(month_code) + 1, 1) From CDMonth), @month_name, @month_name_e" 
                    OldValuesParameterFormatString="original_{0}" ProviderName="System.Data.SqlClient" 
                    SelectCommand="SELECT [month_code], [month_name], [month_name_e] FROM [CDMonth]" 
                    
                    
                    
                    
                    UpdateCommand="UPDATE [CDMonth] SET [month_name] = @month_name, [month_name_e] = @month_name_e WHERE [month_code] = @original_month_code">
                    <DeleteParameters>
                        <asp:Parameter Name="original_month_code" Type="Byte" />
                    </DeleteParameters>
                    <InsertParameters>
                        <asp:Parameter Name="month_name" Type="String" />
                        <asp:Parameter Name="month_name_e" Type="String" />
                    </InsertParameters>
                    <UpdateParameters>
                        <asp:Parameter Name="month_name" Type="String" />
                        <asp:Parameter Name="month_name_e" Type="String" />
