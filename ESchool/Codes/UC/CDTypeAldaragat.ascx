<%@ Control Language="C#" AutoEventWireup="true" CodeFile="CDTypeAldaragat.ascx.cs" Inherits="CDTypeAldaragat" %>
...
<ValidationSettings CommandsToValidate="Insert,Update"></ValidationSettings>
        ...
        <MasterTableView datakeynames="code_type_aldaragat" datasourceid="SqlDataSourceCodez" 
...
<CommandItemStyle Font-Bold="False"></CommandItemStyle>
        ...
        <HeaderStyle Width="20px" ForeColor="Black"></HeaderStyle>
            ...
            <Columns>
                <telerik:GridBoundColumn DataField="nametypealdaragat" 
                    HeaderText="اسم نوع الدرجه بالعربيه" SortExpression="nametypealdaragat" 
                    UniqueName="nametypealdaragat">
                    <HeaderStyle HorizontalAlign="Center" />
                    <ItemStyle HorizontalAlign="Center" />
                </telerik:GridBoundColumn>
                <telerik:GridBoundColumn DataField="nametypealdaragat_e" 
                    HeaderText="اسم نوع الدرجه بالانجليزيه" SortExpression="nametypealdaragat_e" 
                    UniqueName="nametypealdaragat_e">
                    <HeaderStyle HorizontalAlign="Center" />
                    <ItemStyle HorizontalAlign="Center" />
                </telerik:GridBoundColumn>
...
<StatusBarSettings ReadyText="جاهز" LoadingText="تحميل....."></StatusBarSettings>
                ...
                <asp:SqlDataSource ID="SqlDataSourceCodez" runat="server" 
                    ...
                    DeleteCommand="DELETE FROM [CDTypeAldaragat] WHERE [code_type_aldaragat] = @original_code_type_aldaragat" 
                    InsertCommand="INSERT INTO [CDTypeAldaragat] ([code_type_aldaragat], [nametypealdaragat], [nametypealdaragat_e]) Select (Select ISNULL(MAX(code_type_aldaragat) + 1, 1) From CDTypeAldaragat), @nametypealdaragat, @nametypealdaragat_e" 
                    OldValuesParameterFormatString="original_{0}" ProviderName="System.Data.SqlClient" 
                    SelectCommand="SELECT [code_type_aldaragat], [nametypealdaragat], [nametypealdaragat_e] FROM [CDTypeAldaragat]" 
                    
                    
                    
                    
                    UpdateCommand="UPDATE [CDTypeAldaragat] SET [nametypealdaragat] = @nametypealdaragat, [nametypealdaragat_e] = @nametypealdaragat_e WHERE [code_type_aldaragat] = @original_code_type_aldaragat">
                    <DeleteParameters>
                        <asp:Parameter Name="original_code_type_aldaragat" Type="Byte" />
                    </DeleteParameters>
                    <InsertParameters>
                        <asp:Parameter Name="nametypealdaragat" Type="String" />
                        <asp:Parameter Name="nametypealdaragat_e" Type="String" />
                    </InsertParameters>
                    <UpdateParameters>
                        <asp:Parameter Name="nametypealdaragat" Type="String" />
                        <asp:Parameter Name="nametypealdaragat_e" Type="String" />
