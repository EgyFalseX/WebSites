<%@ Page Title="" Language="C#" MasterPageFile="master.master" AutoEventWireup="true" CodeFile="cdtblhedeEditor.aspx.cs" Inherits="cdtblhedeEditor" %>
    ...
    <tr>
        <td>
            <dx:ASPxGridView ID="GVEditor" runat="server" AutoGenerateColumns="False" 
                ...
                KeyFieldName="hederid" RightToLeft="True" 
...
s.cpShowPopup = undefined;
                ...
                <Columns>
                    ...
                    <dx:GridViewDataTextColumn Caption="الوزارة" FieldName="wezara" 
                        VisibleIndex="2" Width="150px">
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataTextColumn Caption="الادارة" FieldName="edara" VisibleIndex="3">
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataTextColumn Caption="الدولة" FieldName="dawla" VisibleIndex="1">
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataTextColumn Caption="القسم" FieldName="dept" VisibleIndex="4">
                    </dx:GridViewDataTextColumn>
                </Columns>
            ...
            <asp:AccessDataSource ID="DSData" runat="server" 
                ...
                SelectCommand="SELECT [hederid], [dawla], [wezara], [edara], [dept] FROM [cdtblhede]" 
                DeleteCommand="DELETE FROM [cdtblhede] WHERE [hederid] = ?" 
                InsertCommand="INSERT INTO [cdtblhede] ([dawla], [wezara], [edara], [dept]) VALUES (?, ?, ?, ?)" 
                UpdateCommand="UPDATE [cdtblhede] SET [dawla] = ?, [wezara] = ?, [edara] = ?, [dept] = ? WHERE [hederid] = ?">
                <DeleteParameters>
                    <asp:Parameter Name="hederid" Type="Int32" />
                </DeleteParameters>
                <InsertParameters>
                    <asp:Parameter Name="dawla" Type="String" />
                    <asp:Parameter Name="wezara" Type="String" />
                    <asp:Parameter Name="edara" Type="String" />
