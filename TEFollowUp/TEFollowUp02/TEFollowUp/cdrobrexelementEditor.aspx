<%@ Page Title="" Language="C#" MasterPageFile="master.master" AutoEventWireup="true" CodeFile="cdrobrexelementEditor.aspx.cs" Inherits="cdrobrexelementEditor" %>
    ...
    <tr>
        <td>
            <dx:ASPxGridView ID="GVEditor" runat="server" AutoGenerateColumns="False" 
                ...
                KeyFieldName="robrexeid" RightToLeft="True" 
...
s.cpShowPopup = undefined;
                ...
                <Columns>
                    ...
                    <dx:GridViewDataComboBoxColumn Caption="بند التقييم" FieldName="elementtakeemid" VisibleIndex="1">
                        <PropertiesComboBox DataSourceID="DSelementtakeemid" DropDownStyle="DropDown" EnableCallbackMode="True" IncrementalFilteringMode="StartsWith" TextField="elementwaytakeem" ValueField="elementtakeemid">
                            <Columns>
                                <dx:ListBoxColumn FieldName="elementwaytakeem" />
                            </Columns>
                        </PropertiesComboBox>
            ...
            <asp:AccessDataSource ID="DSData" runat="server" 
                ...
                SelectCommand="SELECT [robrexeid], [elementtakeemid], [robrexe] FROM [cdrobrexelement]" 
                DeleteCommand="DELETE FROM [cdrobrexelement] WHERE [robrexeid] = ?" 
                InsertCommand="INSERT INTO [cdrobrexelement] ( [elementtakeemid], [robrexe]) VALUES ( ?, ?)" 
                UpdateCommand="UPDATE [cdrobrexelement] SET [elementtakeemid] = ?, [robrexe] = ? WHERE [robrexeid] = ?">
                <DeleteParameters>
                    <asp:Parameter Name="robrexeid" Type="Int32" />
                </DeleteParameters>
                <InsertParameters>
                    <asp:Parameter Name="elementtakeemid" Type="Byte" />
                    <asp:Parameter Name="robrexe" Type="String" />
