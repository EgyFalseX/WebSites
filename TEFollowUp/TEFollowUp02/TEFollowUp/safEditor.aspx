<%@ Page Title="" Language="C#" MasterPageFile="master.master" AutoEventWireup="true" CodeFile="safEditor.aspx.cs" Inherits="UserEditor" %>
    ...
    <tr>
        <td>
            <dx:ASPxGridView ID="GVEditor" runat="server" AutoGenerateColumns="False" 
                ...
                KeyFieldName="safid" RightToLeft="True" 
...
s.cpShowPopup = undefined;
                ...
                <Columns>
                    ...
                    <dx:GridViewDataTextColumn Caption="الصف الدراسي" FieldName="saf" 
            ...
            <asp:AccessDataSource ID="DSData" runat="server" 
                ...
                DeleteCommand="DELETE FROM [cdsaf] WHERE [safid] = ?" 
                InsertCommand="INSERT INTO [cdsaf] ([saf]) VALUES ( ?)" 
                SelectCommand="SELECT [safid], [saf] FROM [cdsaf]" 
                
                UpdateCommand="UPDATE [cdsaf] SET [saf] = ? WHERE [safid] = ?">
                <DeleteParameters>
                    <asp:Parameter Name="safid" Type="Int32" />
                </DeleteParameters>
                <InsertParameters>
                  <asp:Parameter Name="saf" Type="String" />
