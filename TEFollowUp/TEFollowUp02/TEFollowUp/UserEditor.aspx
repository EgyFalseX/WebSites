...
s.cpShowPopup = undefined;
            ...
            <asp:AccessDataSource ID="DSData" runat="server" 
                ...
                InsertCommand="INSERT INTO [FollowupUsers] ([UserID], [UserName], [Password], [IsAdmin]) VALUES (?, ?, ?, ?)" 
                SelectCommand="SELECT [UserID], [UserName], [Password], [IsAdmin] FROM [FollowupUsers]" 
                UpdateCommand="UPDATE [FollowupUsers] SET [UserName] = ?, [Password] = ?, [IsAdmin] = ? WHERE [UserID] = ?" OnInserting="DSData_Inserting">
                <DeleteParameters>
