<%@ Page Title="" Language="C#" MasterPageFile="master.master" AutoEventWireup="true" CodeFile="yearEditor.aspx.cs" Inherits="UserEditor" %>
    ...
    <tr>
        <td>
            <dx:ASPxGridView ID="GVEditor" runat="server" AutoGenerateColumns="False" 
                ...
                KeyFieldName="yearid" RightToLeft="True" 
...
s.cpShowPopup = undefined;
                ...
                <Columns>
                    ...
                    <dx:GridViewDataTextColumn Caption="العام الدراسي" FieldName="yearname" 
            ...
            <asp:AccessDataSource ID="DSData" runat="server" 
                ...
                DeleteCommand="DELETE FROM [cdyear] WHERE [yearid] = ?" 
                InsertCommand="INSERT INTO [cdyear] ([yearname]) VALUES (?)" 
                UpdateCommand="UPDATE [cdyear] SET [yearname] = ? WHERE [yearid] = ?">
                <DeleteParameters>
