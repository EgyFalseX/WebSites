<%@ Page Title="" Language="C#" MasterPageFile="master.master" AutoEventWireup="true" CodeFile="hesaEditor.aspx.cs" Inherits="UserEditor" %>
    ...
    <tr>
        <td>
            <dx:ASPxGridView ID="GVEditor" runat="server" AutoGenerateColumns="False" 
                ...
                KeyFieldName="hesaid" RightToLeft="True" 
...
s.cpShowPopup = undefined;
                ...
                <Columns>
                    ...
                    <dx:GridViewDataTextColumn Caption="الحصص" FieldName="hesa" 
            ...
            <asp:AccessDataSource ID="DSData" runat="server" 
                ...
                DeleteCommand="DELETE FROM [cdhesa] WHERE [hesaid] = ?" 
                InsertCommand="INSERT INTO [cdhesa] ([hesa]) VALUES (?)" 
                SelectCommand="SELECT [hesaid], [hesa] FROM [cdhesa]" 
                
                UpdateCommand="UPDATE [cdhesa] SET [hesa] = ? WHERE [hesaid] = ?">
                <DeleteParameters>
                    <asp:Parameter Name="hesaid" Type="Int32" />
                </DeleteParameters>
                <InsertParameters>
                  <asp:Parameter Name="hesa" Type="String" />
