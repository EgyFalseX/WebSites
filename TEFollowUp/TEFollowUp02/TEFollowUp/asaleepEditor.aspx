<%@ Page Title="" Language="C#" MasterPageFile="master.master" AutoEventWireup="true" CodeFile="asaleepEditor.aspx.cs" Inherits="UserEditor" %>
    ...
    <tr>
        <td>
            <dx:ASPxGridView ID="GVEditor" runat="server" AutoGenerateColumns="False" 
                ...
                KeyFieldName="esaleepid" RightToLeft="True" 
...
s.cpShowPopup = undefined;
                ...
                <Columns>
                    ...
                    <dx:GridViewDataTextColumn Caption="الاحتياجات التدريبية" FieldName="esaleep" 
            ...
            <asp:AccessDataSource ID="DSData" runat="server" 
                ...
                DeleteCommand="DELETE FROM [cdesaleep] WHERE [esaleepid] = ?" 
                InsertCommand="INSERT INTO [cdesaleep] ( [esaleep]) VALUES ( ?)" 
                SelectCommand="SELECT [esaleepid], [esaleep] FROM [cdesaleep]" 
                
                UpdateCommand="UPDATE [cdesaleep] SET [esaleep] = ? WHERE [esaleepid] = ?">
                <DeleteParameters>
                    <asp:Parameter Name="esaleepid" Type="Int32" />
                </DeleteParameters>
                <InsertParameters>
                    <asp:Parameter Name="esaleep" Type="String" />
                </InsertParameters>
                <UpdateParameters>
                    <asp:Parameter Name="esaleep" Type="String" />
                    <asp:Parameter Name="esaleepid" Type="Int32" />
