<%@ Page Title="" Language="C#" MasterPageFile="master.master" AutoEventWireup="true" CodeFile="tblweklytasksEditor.aspx.cs" Inherits="tblweklytasksEditor" %>
    ...
    <tr>
        <td>
            <dx:ASPxGridView ID="GVEditor" runat="server" AutoGenerateColumns="False" 
                ...
                KeyFieldName="taskid" RightToLeft="True" 
...
s.cpShowPopup = undefined;
                ...
                <Columns>
                    ...
                    <dx:GridViewDataDateColumn FieldName="datetask" VisibleIndex="2" Caption="التاريخ">
                        <PropertiesDateEdit DisplayFormatString="d/M/yyyy">
                        </PropertiesDateEdit>
                    </dx:GridViewDataDateColumn>
                    <dx:GridViewDataTextColumn FieldName="task" VisibleIndex="3" Caption="المهمة">
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataSpinEditColumn Caption="فترة التكليف" FieldName="taskfatra" VisibleIndex="4">
                        <PropertiesSpinEdit DisplayFormatString="g">
                        </PropertiesSpinEdit>
                    </dx:GridViewDataSpinEditColumn>
                    <dx:GridViewDataTextColumn FieldName="taskplace" VisibleIndex="5" Caption="مكان التكليف">
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataTextColumn FieldName="taskgeha" VisibleIndex="6" Caption="جهة التكليف">
                    </dx:GridViewDataTextColumn>
            ...
            <asp:AccessDataSource ID="DSData" runat="server" 
                ...
                DeleteCommand="DELETE FROM [tblweklytasks] WHERE [taskid] = ?" 
                InsertCommand="INSERT INTO [tblweklytasks] ([empid], [datetask], [task], [taskfatra], [taskplace], [taskgeha], [userin], [datein]) VALUES (?, ?, ?, ?, ?, ?, ?, Date())" 
                SelectCommand="SELECT [taskid], [empid], [datetask], [task], [taskfatra], [taskplace], [taskgeha], [userin], [datein] FROM [tblweklytasks]
WHERE ([empid] = ?)
OR (SELECT IsAdmin FROM FollowupUsers WHERE UserID = ?) = true" 
                UpdateCommand="UPDATE [tblweklytasks] SET [datetask] = ?, [empid] = ?, [task] = ?, [taskfatra] = ?, [taskplace] = ?, [taskgeha] = ?, [userin] = ?, [datein] = Date() WHERE [taskid] = ?">
                <DeleteParameters>
                    <asp:Parameter Name="taskid" Type="Int32" />
                </DeleteParameters>
                <InsertParameters>
                    <asp:Parameter Name="empid" />
                    <asp:Parameter Name="datetask" Type="DateTime" />
                    <asp:Parameter Name="task" Type="String" />
                    <asp:Parameter Name="taskfatra" Type="Int32" />
                    <asp:Parameter Name="taskplace" Type="String" />
                    <asp:Parameter Name="taskgeha" Type="String" />
            ...
            <asp:AccessDataSource ID="DSempid" runat="server" 
                DataFile="Data/TEFollow-up.mdb" 
                DeleteCommand="DELETE FROM [tblweklytasks] WHERE [taskid] = ?" 
                InsertCommand="INSERT INTO [tblweklytasks] ([datetask], [task], [taskfatra], [taskplace], [taskgeha], [userin], [datein]) VALUES (?, ?, ?, ?, ?, ?, Date())" 
                SelectCommand="SELECT [empid], [empname] FROM [tblempdata] WHERE
([moshref] = true)
AND
(empid = ? OR(SELECT IsAdmin FROM FollowupUsers WHERE UserID = ?) = true)" 
                UpdateCommand="UPDATE [tblweklytasks] SET [datetask] = ?, [task] = ?, [taskfatra] = ?, [taskplace] = ?, [taskgeha] = ?, [userin] = ?, [datein] = Date() WHERE [taskid] = ?">
                <DeleteParameters>
                    <asp:Parameter Name="taskid" Type="Int32" />
                </DeleteParameters>
                <InsertParameters>
