                        ...
                        <dx:LayoutItem Caption="اختر مادة">
                            <LayoutItemNestedControlCollection>
                                <dx:LayoutItemNestedControlContainer runat="server" SupportsDisabledAttribute="True">
                                    <dx:ASPxComboBox ID="cbData" runat="server" AutoPostBack="True" DataSourceID="DSData" DropDownStyle="DropDown" EnableCallbackMode="True" EnableIncrementalFiltering="True" IncrementalFilteringMode="StartsWith" OnSelectedIndexChanged="cbData_SelectedIndexChanged" RightToLeft="True" ValueField="temeetingid" Width="250px">
                                        <Columns>
