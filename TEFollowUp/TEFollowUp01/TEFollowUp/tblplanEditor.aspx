...
s.cpShowPopup = undefined;
            ...
            <asp:AccessDataSource ID="DSData" runat="server" 
                ...
                InsertCommand="INSERT INTO [tblplan] ([schoolid], [safid], [faslid], [datef], [empid], [hesaid], [userin], [datein]) VALUES (?, ?, ?, ?, ?, ?, ?, Date())" 
                SelectCommand="SELECT [planid], [schoolid], [safid], [faslid], [datef], [empid], [hesaid], [userin], [datein] FROM [tblplan]" 
                UpdateCommand="UPDATE       tblplan
SET                schoolid = ?, safid = ?, faslid = ?, datef = ?, empid = ?, hesaid = ?, userin = ?, datein = DATE ()
WHERE        planid = ?">
                <DeleteParameters>
