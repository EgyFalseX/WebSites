...
s.cpShowPopup = undefined;
                ...
                <Columns>
                    ...
                    <dx:GridViewDataComboBoxColumn Caption="احتياج 1" FieldName="eh1" VisibleIndex="4">
                        <PropertiesComboBox DataSourceID="DSehteagatid" DropDownStyle="DropDown" EnableCallbackMode="True" IncrementalFilteringMode="StartsWith" TextField="ehteagat" ValueField="ehteagatid">
                        </PropertiesComboBox>
                    </dx:GridViewDataComboBoxColumn>
                    ...
                    <dx:GridViewDataComboBoxColumn Caption="اسلوب 1" FieldName="es1" VisibleIndex="10">
                        <PropertiesComboBox DataSourceID="DSesaleepid" DropDownStyle="DropDown" EnableCallbackMode="True" IncrementalFilteringMode="StartsWith" TextField="esaleep" ValueField="esaleepid">
                        </PropertiesComboBox>
                    </dx:GridViewDataComboBoxColumn>
