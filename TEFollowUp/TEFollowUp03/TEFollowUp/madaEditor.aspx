<%@ Page Title="" Language="C#" MasterPageFile="master.master" AutoEventWireup="true" CodeFile="madaEditor.aspx.cs" Inherits="UserEditor" %>
    ...
    <tr>
        <td>
            <dx:ASPxGridView ID="GVEditor" runat="server" AutoGenerateColumns="False" 
                ...
                KeyFieldName="madaid" RightToLeft="True" 
...
s.cpShowPopup = undefined;
                ...
                <Columns>
                    ...
                    <dx:GridViewDataTextColumn Caption="المادة" FieldName="madaname" 
            ...
            <asp:AccessDataSource ID="DSData" runat="server" 
                ...
                DeleteCommand="DELETE FROM [cdmada] WHERE [madaid] = ?" 
                InsertCommand="INSERT INTO [cdmada] ([madaname]) VALUES ( ?)" 
                SelectCommand="SELECT [madaid], [madaname] FROM [cdmada]" 
                
                UpdateCommand="UPDATE [cdmada] SET [madaname] = ? WHERE [madaid] = ?">
                <DeleteParameters>
                    <asp:Parameter Name="madaid" Type="Int32" />
                </DeleteParameters>
                <InsertParameters>
                  <asp:Parameter Name="madaname" Type="String" />
