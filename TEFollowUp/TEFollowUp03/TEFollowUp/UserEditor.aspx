<%@ Page Title="" Language="C#" MasterPageFile="master.master" AutoEventWireup="true" CodeFile="UserEditor.aspx.cs" Inherits="UserEditor" %>
...
s.cpShowPopup = undefined;
                ...
                <Columns>
                    ...
                    <dx:GridViewDataTextColumn Caption="كلمة المرور" FieldName="Password" VisibleIndex="2" Visible="False">
                        <EditFormSettings Visible="True" />
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataCheckColumn Caption="مدير موقع" FieldName="IsAdmin" VisibleIndex="3">
                    </dx:GridViewDataCheckColumn>
                    <dx:GridViewDataCheckColumn Caption="التعديل" FieldName="read_writ" VisibleIndex="6">
                    </dx:GridViewDataCheckColumn>
                    ...
                    <dx:GridViewDataCheckColumn Caption="للعرض فقط" FieldName="guest" VisibleIndex="8">
                    </dx:GridViewDataCheckColumn>
                </Columns>
            ...
            <asp:AccessDataSource ID="DSData" runat="server" 
                ...
                DeleteCommand="DELETE FROM [FollowupUsers] WHERE [UserID] = ?" 
                InsertCommand="INSERT INTO [FollowupUsers] ([UserID], [UserName], [Password], [IsAdmin], [empid], [read_writ], guest) VALUES (?, ?, ?, ?, ?, ?, ?)" 
                SelectCommand="SELECT [UserID], [UserName], [Password], [IsAdmin], [empid], [read_writ], guest FROM [FollowupUsers]" 
                UpdateCommand="UPDATE [FollowupUsers] SET [UserName] = ?, [Password] = ?, [IsAdmin] = ?, [empid] = ?, [read_writ] = ?, guest = ? WHERE 
[UserID] = ?" OnInserting="DSData_Inserting">
                <DeleteParameters>
                ...
                <InsertParameters>
                    ...
                    <asp:Parameter Name="read_writ" Type="Boolean" />
            ...
            <asp:AccessDataSource ID="DSEmpid" runat="server" 
                DataFile="Data/TEFollow-up.mdb" 
                SelectCommand="SELECT [empid], [empname] FROM [tblempdata]" OnInserting="DSData_Inserting">
            </asp:AccessDataSource>
