...
s.cpShowPopup = undefined;
                ...
                <Columns>
                    ...
                    <dx:GridViewDataComboBoxColumn Caption="المدرس" FieldName="empid" VisibleIndex="2" SortIndex="0" SortOrder="Ascending">
            ...
            <asp:AccessDataSource ID="DSData" runat="server" 
                ...
                SelectCommand="SELECT planid, schoolid, safid, faslid, datef, empid, hesaid, userin, datein, moshref 
FROM tblplan 
