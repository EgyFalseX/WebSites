<%@ Page Title="" Language="C#" MasterPageFile="master.master" AutoEventWireup="true" CodeFile="takasosEditor.aspx.cs" Inherits="UserEditor" %>
    ...
    <tr>
        <td>
            <dx:ASPxGridView ID="GVEditor" runat="server" AutoGenerateColumns="False" 
                ...
                KeyFieldName="takasosid" RightToLeft="True" 
...
s.cpShowPopup = undefined;
                ...
                <Columns>
                    ...
                    <dx:GridViewDataTextColumn Caption="التخصص" FieldName="takasosname" 
            ...
            <asp:AccessDataSource ID="DSData" runat="server" 
                ...
                DeleteCommand="DELETE FROM cdtakasos WHERE (takasosid = ?)" 
                InsertCommand="INSERT INTO cdtakasos(takasosid, takasosname) VALUES (?, ?)" 
                SelectCommand="SELECT takasosid, takasosname FROM cdtakasos" 
                
                UpdateCommand="UPDATE cdtakasos SET takasosname = ? WHERE (takasosid = ?)" 
                ...
                <InsertParameters>
                    <asp:Parameter Name="takasosid" Type="Int32" />
                  <asp:Parameter Name="takasosname" Type="String" />
