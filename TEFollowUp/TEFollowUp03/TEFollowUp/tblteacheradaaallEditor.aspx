<%@ Page Title="" Language="C#" MasterPageFile="master.master" AutoEventWireup="true" CodeFile="tblteacheradaaallEditor.aspx.cs" Inherits="tblteacheradaaallEditor" %>
...
s.cpShowPopup = undefined;
                ...
                <Columns>
                    ...
                    <dx:GridViewDataMemoColumn Caption="ملاحظات" FieldName="remmoder" VisibleIndex="33">
                        <PropertiesMemoEdit Height="100px">
                        </PropertiesMemoEdit>
                        <EditFormSettings ColumnSpan="2" />
                    </dx:GridViewDataMemoColumn>
                    <dx:GridViewDataSpinEditColumn Caption="تقييم الفصل الأول" FieldName="moderterm1" VisibleIndex="2">
                        <PropertiesSpinEdit DisplayFormatString="g">
                        </PropertiesSpinEdit>
                    </dx:GridViewDataSpinEditColumn>
                    <dx:GridViewDataSpinEditColumn Caption="تقييم الفصل الثاني" FieldName="moderterm2" VisibleIndex="29">
                        <PropertiesSpinEdit DisplayFormatString="g">
                        </PropertiesSpinEdit>
                    </dx:GridViewDataSpinEditColumn>
                </Columns>
            ...
            <asp:AccessDataSource ID="DSData" runat="server" 
                ...
                DeleteCommand="DELETE FROM [tblteacheradaaall] WHERE tblallid = ?" 
                InsertCommand="INSERT INTO [tblteacheradaaall] ([empid], [yearid], [moderterm1], [moderterm2], [remmoder], [userin], [datein]) VALUES (?, ?, ?, ?, ?, ?, Date())" 
                SelectCommand="SELECT tblteacheradaaall.tblallid, tblteacheradaaall.empid, tblteacheradaaall.yearid, tblteacheradaaall.moderterm1, tblteacheradaaall.moderterm2, tblteacheradaaall.remmoder, tblteacheradaaall.userin, tblteacheradaaall.datein FROM (tblteacheradaaall LEFT OUTER JOIN tblempdata ON tblteacheradaaall.empid = tblempdata.empid) WHERE 
(SELECT IsAdmin FROM FollowupUsers WHERE UserID = ?) = true
OR tblempdata.schoolid = ?" 
                UpdateCommand="UPDATE [tblteacheradaaall] SET [empid] = ?, [yearid] = ?, [moderterm1] = ?, [moderterm2] = ?, [remmoder] = ?, [userin] = ?, [datein] = Date() WHERE [tblallid] = ?">
                <DeleteParameters>
                ...
                <InsertParameters>
                    ...
                    <asp:Parameter Name="moderterm1" Type="Byte" />
                    <asp:Parameter Name="moderterm2" Type="Byte" />
                    <asp:Parameter Name="remmoder" Type="String" />
