<%@ Page Title="" Language="C#" MasterPageFile="master.master" AutoEventWireup="true" CodeFile="ehteagatEditor.aspx.cs" Inherits="UserEditor" %>
    ...
    <tr>
        <td>
            <dx:ASPxGridView ID="GVEditor" runat="server" AutoGenerateColumns="False" 
                ...
                KeyFieldName="ehteagatid" RightToLeft="True" 
...
s.cpShowPopup = undefined;
                ...
                <Columns>
                    ...
                    <dx:GridViewDataTextColumn Caption="الاحتياجات التدريبية" FieldName="ehteagat" 
            ...
            <asp:AccessDataSource ID="DSData" runat="server" 
                ...
                DeleteCommand="DELETE FROM [cdehteagat] WHERE [ehteagatid] = ?" 
                InsertCommand="INSERT INTO [cdehteagat] ( [ehteagat]) VALUES ( ?)" 
                SelectCommand="SELECT [ehteagatid], [ehteagat] FROM [cdehteagat]" 
                
                UpdateCommand="UPDATE [cdehteagat] SET [ehteagat] = ? WHERE [ehteagatid] = ?">
                <DeleteParameters>
                    <asp:Parameter Name="ehteagatid" Type="Int32" />
                </DeleteParameters>
                <InsertParameters>
                    <asp:Parameter Name="ehteagat" Type="String" />
                </InsertParameters>
                <UpdateParameters>
                    <asp:Parameter Name="ehteagat" Type="String" />
                    <asp:Parameter Name="ehteagatid" Type="Int32" />
