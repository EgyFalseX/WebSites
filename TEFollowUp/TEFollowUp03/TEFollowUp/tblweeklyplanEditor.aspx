...
s.cpShowPopup = undefined;
                ...
                <Columns>
                    ...
                    <dx:GridViewDataCheckColumn FieldName="nasheed" VisibleIndex="30" Caption="النشيد الوطني(نفذ ام لا)" Visible="False">
...
(empid = ?) " 
                ...
                <SelectParameters>
                    ...
                    <asp:SessionParameter Name="empid" SessionField="empidTEFollowUp" Type="Int32" />
                </SelectParameters>
                <UpdateParameters>
                    <asp:Parameter Name="empid" Type="Int32" />
                    <asp:Parameter Name="schoolid" />
