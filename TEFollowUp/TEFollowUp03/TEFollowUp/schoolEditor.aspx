<%@ Page Title="" Language="C#" MasterPageFile="master.master" AutoEventWireup="true" CodeFile="schoolEditor.aspx.cs" Inherits="UserEditor" %>
...
s.cpShowPopup = undefined;
                ...
                <Columns>
                    ...
                    <dx:GridViewDataTextColumn Caption="جهة العمل" FieldName="schoolname" 
                        VisibleIndex="1" Width="150px">
                        <HeaderStyle Font-Bold="True" HorizontalAlign="Center" />
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataMemoColumn Caption="بريد اليكتروني" FieldName="schoolmail" 
                        VisibleIndex="3">
                        <HeaderStyle Font-Bold="True" HorizontalAlign="Center" />
                    </dx:GridViewDataMemoColumn>
                    <dx:GridViewDataTextColumn Caption="المدير" FieldName="schoolmanager" 
                        VisibleIndex="2">
                        <HeaderStyle Font-Bold="True" HorizontalAlign="Center" />
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataTextColumn Caption="تليفون" FieldName="schoolphone" 
                        VisibleIndex="4">
                        <HeaderStyle Font-Bold="True" HorizontalAlign="Center" />
                    </dx:GridViewDataTextColumn>
                </Columns>
            ...
            <asp:AccessDataSource ID="DSData" runat="server" 
                ...
                DeleteCommand="DELETE FROM [cdschool] WHERE [schoolid] = ?" 
                InsertCommand="INSERT INTO cdschool(schoolid , schoolname, schoolmanager, schoolmail, schoolphone) VALUES (?,?, ?, ?, ?)" 
                SelectCommand="SELECT schoolid, schoolname, schoolmanager,  schoolmail, schoolphone FROM cdschool" 
                
                UpdateCommand="UPDATE cdschool SET schoolname = ?, schoolmanager = ?, schoolmail = ?, schoolphone = ? WHERE (schoolid = ?)" 
                ...
                <InsertParameters>
                  ...
                  <asp:Parameter Name="schoolname" Type="String" />
                    <asp:Parameter Name="schoolmanager" Type="String" />
                <asp:Parameter Name="schoolmail" Type="String" />
