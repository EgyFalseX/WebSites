    ...
    <table align="center" class="auto-style1">
        ...
        <tr>
            ...
            <asp:AccessDataSource ID="DSData" runat="server" 
                ...
                <dx:ASPxComboBox ID="cbMoshref" runat="server" AutoPostBack="True" 
                    DataSourceID="DSData" DropDownStyle="DropDown" EnableCallbackMode="True" 
                    Font-Size="Large" IncrementalFilteringMode="StartsWith" 
                    OnSelectedIndexChanged="cbMoshref_SelectedIndexChanged" RightToLeft="True" 
                    TextField="schoolname" ValueField="schoolid" Width="250px" 
                    EnableIncrementalFiltering="True" Theme="PlasticBlue" >
                    <Columns>
