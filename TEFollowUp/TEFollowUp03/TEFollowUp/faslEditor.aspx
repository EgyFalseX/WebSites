<%@ Page Title="" Language="C#" MasterPageFile="master.master" AutoEventWireup="true" CodeFile="faslEditor.aspx.cs" Inherits="UserEditor" %>
    ...
    <tr>
        <td>
            <dx:ASPxGridView ID="GVEditor" runat="server" AutoGenerateColumns="False" 
                ...
                KeyFieldName="faslid" RightToLeft="True" 
...
s.cpShowPopup = undefined;
                ...
                <Columns>
                    ...
                    <dx:GridViewDataTextColumn Caption="الفصول" FieldName="fasl" 
            ...
            <asp:AccessDataSource ID="DSData" runat="server" 
                ...
                DeleteCommand="DELETE FROM [cdfasl] WHERE [faslid] = ?" 
                InsertCommand="INSERT INTO [cdfasl] ( [fasl]) VALUES (?)" 
                SelectCommand="SELECT [faslid], [fasl] FROM [cdfasl]" 
                
                UpdateCommand="UPDATE [cdfasl] SET [fasl] = ? WHERE [faslid] = ?">
                <DeleteParameters>
                    <asp:Parameter Name="faslid" Type="Int32" />
                </DeleteParameters>
                <InsertParameters>
                  <asp:Parameter Name="fasl" Type="String" />
