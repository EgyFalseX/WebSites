...
/// <summary>
/// Summary description for XtraReport04B
/// </summary>
public class XtraReport04B : DevExpress.XtraReports.UI.XtraReport
{
	...
	private void InitializeComponent() {
            string resourceFileName = "XtraReport04B.resx";
            ...
            this.lblSchoolName = new DevExpress.XtraReports.UI.XRLabel();
            ...
            new DevExpress.XtraReports.UI.XRBinding("Text", null, "XRep04.moshrefname")});
            ...
            this.xrTableCell40.Text = "اسم المشرف";
            ...
            this.xrTableCell8.Text = "خطة المدرسة";
            ...
            // lblSchoolName
            // 
            this.lblSchoolName.LocationFloat = new DevExpress.Utils.PointFloat(10.00001F, 0F);
            this.lblSchoolName.Name = "lblSchoolName";
            this.lblSchoolName.Padding = new DevExpress.XtraPrinting.PaddingInfo(2, 2, 0, 0, 100F);
            this.lblSchoolName.SizeF = new System.Drawing.SizeF(279.9999F, 23F);
            this.lblSchoolName.StylePriority.UseTextAlignment = false;
            this.lblSchoolName.TextAlignment = DevExpress.XtraPrinting.TextAlignment.MiddleCenter;
            // 
            // xrTableCell26
            // 
    ...
    {
        if (System.Web.HttpContext.Current.Session["XRep04BID"] != null)
        {
            int id = Convert.ToInt32(System.Web.HttpContext.Current.Session["XRep04BID"]);
            xRep04TableAdapter1.FillByschoolid(dsTEFollowUp1.XRep04, id);
        }
        if (System.Web.HttpContext.Current.Session["XRep04BName"] != null)
            lblSchoolName.Text = System.Web.HttpContext.Current.Session["XRep04BName"].ToString();
