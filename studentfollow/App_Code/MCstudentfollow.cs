...
public class MCstudentfollow
{
    ...
    public static string LoginDatabasePath
    {
        get
        {
            ...
            return sv.MapPath(@"~/desoft/database/2/dstudent/dataschool.mdb");
        }
    }
    static string ConnectionString()
    {
        string constr = "Provider=Microsoft.Jet.OLEDB.4.0; Data Source= ";
        HttpServerUtility sv = HttpContext.Current.Server;
        constr += sv.MapPath(@"Data/studentfollow.mdb");
        return constr;
    }
    public static string ConnectionStringdataschool()
    {
        string constr = "Provider=Microsoft.Jet.OLEDB.4.0; Data Source= ";
        HttpServerUtility sv = HttpContext.Current.Server;
        constr += sv.MapPath(@"~/desoft/database/2/dstudent/dataschool.mdb");
        return constr;
    }
    public static string ConnectionStringasase()
    {
        string constr = "Provider=Microsoft.Jet.OLEDB.4.0; Data Source= ";
        HttpServerUtility sv = HttpContext.Current.Server;
        constr += sv.MapPath(@"~/desoft/code/asase.mdb");
        return constr;
    }
