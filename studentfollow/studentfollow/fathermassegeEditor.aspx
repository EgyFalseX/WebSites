<%@ Page Title="" Language="C#" MasterPageFile="master.master" AutoEventWireup="true" CodeFile="fathermassegeEditor.aspx.cs" Inherits="fathermassegeEditor" %>
    ...
    <tr>
        <td>
            <dx:ASPxGridView ID="GVEditor" runat="server" AutoGenerateColumns="False" 
                ...
                KeyFieldName="massegeid" RightToLeft="True" 
                SummaryText="الملخص" CssFilePath="../App_Themes/PlasticBlue/{0}/styles.css" 
                CssPostfix="PlasticBlue" EnableTheming="True" 
                onrowdeleted="GVEditor_RowDeleted" onrowupdated="GVEditor_RowUpdated" 
                onrowinserted="GVEditor_RowInserted" Font-Bold="True" Theme="SoftOrange" OnCommandButtonInitialize="GVEditor_CommandButtonInitialize">
...
s.cpShowPopup = undefined;
                ...
                <Columns>
                    ...
                    <dx:GridViewDataDateColumn Caption="التاريخ" FieldName="massegedate" VisibleIndex="2">
                    ...
                    <dx:GridViewDataComboBoxColumn Caption="الطالب" FieldName="studentid" VisibleIndex="3">
                        <PropertiesComboBox DataSourceID="DSStudent" DropDownStyle="DropDown" EnableCallbackMode="True" IncrementalFilteringMode="Contains" TextField="stu_name" ValueField="stu_code">
                            <Columns>
                    ...
                    <dx:GridViewDataMemoColumn Caption="الرسالة" FieldName="massegetext" VisibleIndex="4">
                        <EditFormSettings Visible="False" />
                    </dx:GridViewDataMemoColumn>
                    <dx:GridViewDataCheckColumn Caption="تم الرد" FieldName="reply_code" VisibleIndex="5">
                        <EditFormSettings Visible="False" />
                    </dx:GridViewDataCheckColumn>
                    <dx:GridViewDataMemoColumn Caption="رد المدرسة" FieldName="massegereply" VisibleIndex="6">
                        <PropertiesMemoEdit Height="120px">
                        </PropertiesMemoEdit>
                        <EditFormSettings ColumnSpan="2" />
                    </dx:GridViewDataMemoColumn>
                    <dx:GridViewDataDateColumn Caption="تاريخ الرد" FieldName="replydate" VisibleIndex="7">
                        <PropertiesDateEdit DisplayFormatString="d/M/yyyy">
                        </PropertiesDateEdit>
                        <EditFormSettings Visible="False" />
                    </dx:GridViewDataDateColumn>
            ...
            <asp:AccessDataSource ID="DSData" runat="server" 
                ...
                DeleteCommand="DELETE FROM [fathermassege] WHERE [massegeid] = ?" 
                SelectCommand="SELECT [massegeid], [asase_code], [massegedate], [studentid], [massegetext], [massegereply], [reply_code], [replydate], [id] FROM [fathermassege]" 
                UpdateCommand="UPDATE [fathermassege] SET  [massegereply] = ?, [reply_code] = -1, [replydate] = Date(), [id] = ? WHERE [massegeid] = ?">
                <DeleteParameters>
                    <asp:Parameter Name="massegeid" Type="Int32" />
                </DeleteParameters>
                <UpdateParameters>
                    <asp:Parameter Name="massegereply" Type="String" />
