...
s.cpShowPopup = undefined;
                ...
                <Columns>
                    ...
                    <dx:GridViewDataTextColumn Caption="اسم المستخدم" FieldName="user" VisibleIndex="1">
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataTextColumn Caption="كلمة المرور" FieldName="pass" VisibleIndex="2">
                        <PropertiesTextEdit Password="True">
                        </PropertiesTextEdit>
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataTextColumn Caption="الاسم الكامل" FieldName="realname" VisibleIndex="3">
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataTextColumn Caption="الوظيفة" FieldName="job" VisibleIndex="4">
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataCheckColumn Caption="مدير" FieldName="isadmin" VisibleIndex="5">
            ...
            <asp:AccessDataSource ID="DSData" runat="server" 
                ...
                DeleteCommand="DELETE FROM adminfollow WHERE (id = ?)" 
                InsertCommand="INSERT INTO adminfollow([user], pass, realname, job, isadmin) VALUES (?, ?, ?, ?, ?)" 
                SelectCommand="SELECT [id], [user], [pass], [realname], [job], [isadmin] FROM [adminfollow]" 
                UpdateCommand="UPDATE adminfollow SET [user] = ?, pass = ?, realname = ?, job = ?, isadmin = ? WHERE (id = ?)">
                <DeleteParameters>
