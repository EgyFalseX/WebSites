<%@ Control Language="C#" AutoEventWireup="true" CodeFile="filepathViewer.ascx.cs" Inherits="filepathViewer" %>
    ...
    <tr>
        <td>
            <dx:ASPxGridView ID="GVEditor" runat="server" AutoGenerateColumns="False" 
                ...
                KeyFieldName="fileid" RightToLeft="True" 
...
s.cpShowPopup = undefined;
                ...
                <Columns>
                    ...
                    <dx:GridViewDataHyperLinkColumn Caption="المسار" FieldName="fllepath" 
                        VisibleIndex="4">
                        <PropertiesHyperLinkEdit NavigateUrlFormatString="~/{0}" 
                            Text="تحميــــــــــــــــل">
                        </PropertiesHyperLinkEdit>
                    </dx:GridViewDataHyperLinkColumn>
                    <dx:GridViewDataTextColumn Caption="اسم الملف" FieldName="filename" 
                        VisibleIndex="1">
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataDateColumn Caption="التاريخ" FieldName="filedate" 
                        VisibleIndex="2">
            ...
            <asp:AccessDataSource ID="DSData" runat="server" 
               DataFile="../../App_Data/retdatalogin.mdb" 
                SelectCommand="SELECT [fileid], [SyndicateId], [filename], [fllepath], [filedate] FROM [filepath] WHERE ([SyndicateId] = ?)" 
                OnSelecting="DSData_Selecting">
                <SelectParameters>
                    <asp:SessionParameter DefaultValue="0" Name="SyndicateId" 
