<%@ Control Language="C#" AutoEventWireup="true" CodeFile="tblwarasa.ascx.cs" Inherits="tblwarasa" %>
...
s.cpShowPopup = undefined;
                ...
                <Columns>
                    ...
                    <dx:GridViewDataComboBoxColumn Caption="اللجنة النقابية" 
                        FieldName="SubCommitteId" VisibleIndex="3">
                    ...
                    <dx:GridViewDataMemoColumn Caption="ملاحظات" FieldName="remm" VisibleIndex="5">
                    ...
                    <dx:GridViewDataHyperLinkColumn Caption="بيانات الورثة" ReadOnly="True" 
                        VisibleIndex="9" FieldName="memberid">
                        <PropertiesHyperLinkEdit NavigateUrlFormatString="../tblwarasason.aspx?id={0}" 
                            TextFormatString="بيانات الورثة">
            ...
            <asp:AccessDataSource ID="DSData" runat="server" 
               DataFile="../../App_Data/7.mdb"
                ...
                SelectCommand="SELECT [memberid], [membername], [sarfno], [SyndicateId], [SubCommitteId], [useredit], [dateedit], [delmember], [remm] FROM [tblwarasa]" 
                UpdateCommand="UPDATE [tblwarasa] SET [membername] = ?, [sarfno] = ?, [SubCommitteId] = ?, [useredit] = ?, [dateedit] = DATE(), [delmember] = ?, [remm] = ? WHERE ([memberid] = ?)" 
