<%@ Control Language="C#" AutoEventWireup="true" CodeFile="stopsarf.ascx.cs" Inherits="stopsarf" %>
...
s.cpShowPopup = undefined;
                ...
                <Columns>
                    ...
                    <dx:GridViewDataMemoColumn Caption="ملاحظات" FieldName="remark" VisibleIndex="11">
                    </dx:GridViewDataMemoColumn>
                    <dx:GridViewDataTextColumn Caption="اسم الوريث" FieldName="sonname" VisibleIndex="2" ReadOnly="True">
                    </dx:GridViewDataTextColumn>
            ...
            <asp:AccessDataSource ID="DSData" runat="server" 
               DataFile="../../App_Data/retdatalogin.mdb" 
                SelectCommand="SELECT [rid], [sonid], [sonname], [SyndicateId], [SubCommitteId], [sarfnumber], [remark], [membername] FROM [stopsarf] WHERE ([SyndicateId] = ?)" 
