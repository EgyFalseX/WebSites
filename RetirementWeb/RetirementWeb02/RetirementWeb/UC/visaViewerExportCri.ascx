<%@ Control Language="C#" AutoEventWireup="true" CodeFile="visaViewerExportCri.ascx.cs" Inherits="visaViewerExportCri" %>
...
<table align="center">
    <tr>
        <td dir="ltr" style="text-align: center">
            <dx:ASPxHyperLink ID="ASPxHyperLink1" runat="server" NavigateUrl="../visaViewerExportCri.aspx" Text="الي التصدير" />
        </td>
    </tr>
    <tr>
        <td dir="ltr">
