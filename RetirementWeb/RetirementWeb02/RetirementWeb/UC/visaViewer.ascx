<%@ Control Language="C#" AutoEventWireup="true" CodeFile="visaViewer.ascx.cs" Inherits="visaViewer" %>
...
s.cpShowPopup = undefined;
                ...
                <Columns>
                    ...
                    <dx:GridViewDataDateColumn Caption="تاريخ الحافظة" FieldName="datehafza" VisibleIndex="1">
            ...
            <asp:AccessDataSource ID="DSData" runat="server" 
               DataFile="../../App_Data/visacard.mdb"
                ...
                SelectCommand="SELECT visa.memberid, visa.datehafza, visa.memname, visa.sarf, visa.visacard, visa.hafza, visa.hafzadate, visa.mnid, cdSyndicate.Syndicate, cdSubCommitte.SubCommitte FROM ((visa INNER JOIN cdSyndicate ON visa.SyndicateId = cdSyndicate.SyndicateId) INNER JOIN cdSubCommitte ON visa.SubCommitteId = cdSubCommitte.SubCommitteId) WHERE (visa.SyndicateId = ?)" 
