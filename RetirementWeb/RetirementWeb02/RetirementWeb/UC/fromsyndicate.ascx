<%@ Control Language="C#" AutoEventWireup="true" CodeFile="fromsyndicate.ascx.cs" Inherits="fromsyndicate" %>
...
s.cpShowPopup = undefined;
                ...
                <Columns>
                    ...
                    <dx:GridViewDataTextColumn Caption="رقم الصرف" FieldName="sarfnumber" 
                        VisibleIndex="4" ReadOnly="True">
                        <EditFormSettings Visible="False" />
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataTextColumn Caption="اسم الوريث" FieldName="sonname" VisibleIndex="3">
                        <EditFormSettings Visible="False" />
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataTextColumn Caption="اللجنة" FieldName="SubCommitte" VisibleIndex="7">
                        <EditFormSettings Visible="False" />
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataTextColumn Caption="نوع العضو" FieldName="ttype" VisibleIndex="11">
                        <EditFormSettings Visible="False" />
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataTextColumn Caption="رقم قومي" FieldName="memnid" VisibleIndex="1">
                    </dx:GridViewDataTextColumn>
                </Columns>
            ...
            <asp:AccessDataSource ID="DSData" runat="server" 
               DataFile="../../App_Data/retdatalogin.mdb" 
                SelectCommand="SELECT fromsyndicate.rid, fromsyndicate.membername, fromsyndicate.sonname, fromsyndicate.sarfnumber, fromsyndicate.ttype, fromsyndicate.memnid, cdSyndicate.Syndicate, cdSubCommitte.SubCommitte FROM ((fromsyndicate INNER JOIN cdSyndicate ON fromsyndicate.SyndicateId = cdSyndicate.SyndicateId) INNER JOIN cdSubCommitte ON fromsyndicate.SubCommitteId = cdSubCommitte.SubCommitteId) WHERE (fromsyndicate.SyndicateId = ?)" 
                UpdateCommand="UPDATE fromsyndicate SET memnid = ? WHERE (rid = ?)" 
                OnSelecting="DSData_Selecting">
                <SelectParameters>
                    <asp:SessionParameter DefaultValue="0" Name="?" SessionField="RetirementWebSyndicateId" />
                </SelectParameters>
                <UpdateParameters>
                    <asp:Parameter Name="memnid" />
