<%@ Control Language="C#" AutoEventWireup="true" CodeFile="visaViewerw.ascx.cs" Inherits="visaViewer" %>
...
<table align="center">
    <tr>
        <td dir="ltr" style="text-align: center">
            <dx:ASPxHyperLink ID="ASPxHyperLink1" runat="server" NavigateUrl="../visaViewerwExportCri.aspx" Text="الي التصدير" />
        </td>
    </tr>
    <tr>
        <td dir="ltr">
...
s.cpShowPopup = undefined;
                ...
                <Columns>
                    ...
                    <dx:GridViewDataTextColumn Caption="ملاحظات هامة" FieldName="mnid" VisibleIndex="9">
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataTextColumn Caption="الفرعية" FieldName="Syndicate" VisibleIndex="7">
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataTextColumn Caption="اللجنة" FieldName="SubCommitte" VisibleIndex="8">
                    </dx:GridViewDataTextColumn>
            ...
            <asp:AccessDataSource ID="DSData" runat="server" 
               DataFile="../../App_Data/visacardw.mdb"
