...
public class mcRetirementWeb
{
    ...
    public static string constr
    {
        get
        {
            return System.Configuration.ConfigurationManager.ConnectionStrings["retdataloginConnectionString"].ConnectionString.Replace("retdatalogin.mdb", sessionRetirementWeb.DatabaseName);
        }
    }
