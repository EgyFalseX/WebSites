<%@ Page Title="" Language="C#" MasterPageFile="~/updata/master.master" AutoEventWireup="true" CodeFile="EditMessage.aspx.cs" Inherits="EditMessage" %>
    ...
    <tr>
        <td>
            <dx:ASPxGridView ID="GVEditor" runat="server" AutoGenerateColumns="False" 
                ...
                ondatabinding="GVEditor_DataBinding" Theme="iOS" OnCommandButtonInitialize="GVEditor_CommandButtonInitialize">
...
s.cpShowPopup = undefined;
                ...
                <Columns>
                    ...
                    <dx:GridViewDataComboBoxColumn Caption="المهمة" 
                        FieldName="taskid" VisibleIndex="1">
                    ...
                    <dx:GridViewDataMemoColumn Caption="التقرير" FieldName="taskdonedetails" VisibleIndex="2">
                    </dx:GridViewDataMemoColumn>
                    <dx:GridViewDataDateColumn Caption="التاريخ" FieldName="datein" ReadOnly="True" VisibleIndex="5">
            ...
            <asp:AccessDataSource ID="DSData" runat="server" 
               DataFile="../App_Data/team.mdb" 
                SelectCommand="SELECT [wid], [userid], [taskid], [taskdonedetails], [taskpath], [datein], [adminreplay], [admindate] FROM [workdone] WHERE ([userid] = ?)" 
                UpdateCommand="UPDATE [workdone] SET [taskdonedetails] = ?, [taskpath] = ?, [datein] = Date(), taskid = ? WHERE [wid] = ?" 
                ...
                <SelectParameters>
                    <asp:SessionParameter DefaultValue="0" Name="userid" SessionField="updataUserID" Type="Int32" />
                </SelectParameters>
                <UpdateParameters>
                    <asp:Parameter Name="taskdonedetails" Type="String" />
                    <asp:Parameter Name="taskpath" Type="String" />
