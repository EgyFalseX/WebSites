...
public class mcsynmembers
{
    ...
    public static string constr
    {
        get
        {
            return System.Configuration.ConfigurationManager.ConnectionStrings["synloginConnectionString"].ConnectionString.Replace("synlogin.mdb", sessionsynmembers.DatabaseName);
        }
    }
