...
s.cpShowPopup = undefined;
                ...
                <Columns>
                    ...
                    <dx:GridViewDataTextColumn Caption="رقم العضوية" FieldName="membership" 
                        VisibleIndex="4">
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataComboBoxColumn Caption="اللجنة النقابية" 
                        FieldName="SubCommitteId" VisibleIndex="1">
                    ...
                    <dx:GridViewDataTextColumn Caption="المستلم " FieldName="mostalem" 
                        VisibleIndex="6">
                        <PropertiesTextEdit MaxLength="14">
                            <MaskSettings Mask="00000000000000" />
                        </PropertiesTextEdit>
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataDateColumn Caption="تاريخ الاستلام" FieldName="datee" VisibleIndex="8">
                        <PropertiesDateEdit DisplayFormatString="d/M/yyyy" EditFormat="Custom" EditFormatString="d/M/yyyy">
                        </PropertiesDateEdit>
                    </dx:GridViewDataDateColumn>
                    <dx:GridViewDataTextColumn Caption="الاسم" FieldName="membername" VisibleIndex="2">
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataTextColumn Caption="رقم القيد" FieldName="kedno" 
                        VisibleIndex="3">
                    </dx:GridViewDataTextColumn>
                </Columns>
            ...
            <asp:AccessDataSource ID="DSData" runat="server" 
               DataFile="~/synmembers/DataSource/s1.mdb"
                DeleteCommand="DELETE FROM [tblmember] WHERE (([memberid] = ?) OR ([memberid] IS NULL AND ? IS NULL))" 
                InsertCommand="INSERT INTO [tblmember] ([memberid], [membername], [kedno], [membership], [SyndicateId], [SubCommitteId], [mostalem], [datee]) VALUES (?, ?, ?, ?, ?, ?, ?, ?)" 
                SelectCommand="SELECT [memberid], [membername], [kedno], [membership], [SyndicateId], [SubCommitteId], [mostalem], [datee] FROM [tblmember] WHERE ([SyndicateId] = ?) ORDER BY [SubCommitteId], [membername]" 
                UpdateCommand="UPDATE [tblmember] SET [membername] = ?, [kedno] = ?, [membership] = ?, [SyndicateId] = ?, [SubCommitteId] = ?, [mostalem] = ?, [datee] = ? WHERE (([memberid] = ?) OR ([memberid] IS NULL AND ? IS NULL))" 
                ...
                <InsertParameters>
                    ...
                    <asp:Parameter Name="kedno" Type="Int32" />
                    ...
                    <asp:Parameter Name="mostalem" Type="String" />
                    <asp:Parameter Name="datee" Type="DateTime" />
                </InsertParameters>
                <SelectParameters>
                    <asp:SessionParameter DefaultValue="-1" Name="SyndicateId" SessionField="synmembersSyndicateId" Type="Int32" />
                </SelectParameters>
                <UpdateParameters>
                    <asp:Parameter Name="membername" Type="String" />
                    <asp:Parameter Name="kedno" Type="Int32" />
            ...
            <asp:AccessDataSource ID="DScdSubCommitte" runat="server" 
                ...
                <SelectParameters>
                    <asp:SessionParameter Name="SyndicateId" 
                        SessionField="synmembersSyndicateId" Type="Int32" DefaultValue="-1" />
                </SelectParameters>
            </asp:AccessDataSource>
