<%@ Page Title="" Language="C#" MasterPageFile="AdminMasterPage.master" AutoEventWireup="true" CodeFile="RolesEditor.aspx.cs" Inherits="RolesEditor" %>
    ...
    <tr>
        <td>
            <dx:ASPxGridView ID="GVEditor" runat="server" AutoGenerateColumns="False" 
                ...
                KeyFieldName="RoleID" RightToLeft="True" 
...
s.cpShowPopup = undefined;
                ...
                <Columns>
                    ...
                    <dx:GridViewDataTextColumn Caption="الاسم" FieldName="RoleName" 
                        VisibleIndex="1">
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataTextColumn Caption="تعليق" FieldName="RoleDesc" VisibleIndex="2">
                    </dx:GridViewDataTextColumn>
                </Columns>
            ...
            <asp:AccessDataSource ID="DSData" runat="server" DataFile="../App_Data/contact.mdb" SelectCommand="SELECT [RoleID], [RoleName], [RoleDesc] FROM [Roles]" DeleteCommand="DELETE FROM [Roles] WHERE ([RoleID] = ?)" InsertCommand="INSERT INTO [Roles] ([RoleID], [RoleName], [RoleDesc]) VALUES (?, ?, ?)" UpdateCommand="UPDATE [Roles] SET [RoleName] = ?, [RoleDesc] = ? WHERE ([RoleID] = ?)" OnInserting="DSData_Inserting">
                <DeleteParameters>
