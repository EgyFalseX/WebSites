<%@ Page Title="" Language="C#" MasterPageFile="AdminMasterPage.master" AutoEventWireup="true" CodeFile="CDtitleEditor.aspx.cs" Inherits="CDtitleEditor" %>
    ...
    <tr>
        <td>
            <dx:ASPxGridView ID="GVEditor" runat="server" AutoGenerateColumns="False" 
                ...
                KeyFieldName="titleId" RightToLeft="True" 
...
s.cpShowPopup = undefined;
                ...
                <Columns>
                    ...
                    <dx:GridViewDataTextColumn Caption="الاسم" FieldName="titleName" 
                        VisibleIndex="1">
            ...
            <asp:AccessDataSource ID="DSData" runat="server" DataFile="../App_Data/contact.mdb" SelectCommand="SELECT [titleId], [titleName] FROM [CDtitle]" DeleteCommand="DELETE FROM [CDtitle] WHERE ([titleId] = ?)" InsertCommand="INSERT INTO [CDtitle] ([titleId], [titleName]) VALUES (?, ?)" OnInserting="DSData_Inserting" UpdateCommand="UPDATE [CDtitle] SET [titleName] = ? WHERE [titleId] = ?">
                <DeleteParameters>
