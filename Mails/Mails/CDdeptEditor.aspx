<%@ Page Title="" Language="C#" MasterPageFile="AdminMasterPage.master" AutoEventWireup="true" CodeFile="CDdeptEditor.aspx.cs" Inherits="CDdeptEditor" %>
...
s.cpShowPopup = undefined;
                ...
                <Columns>
                    ...
                    <dx:GridViewDataTextColumn Caption="الاسم" FieldName="deptName" 
                        VisibleIndex="1">
            ...
            <asp:AccessDataSource ID="DSData" runat="server" DataFile="../App_Data/contact.mdb" SelectCommand="SELECT [deptId], [deptName] FROM [CDdept]" DeleteCommand="DELETE FROM [CDdept] WHERE ([deptId] = ?)" InsertCommand="INSERT INTO [CDdept] ([deptId], [deptName]) VALUES (?, ?)" UpdateCommand="UPDATE [CDdept] SET [deptName] = ? WHERE ([deptId] = ?) " OnInserting="DSData_Inserting">
                <DeleteParameters>
