<%@ Page Title="" Language="C#" MasterPageFile="master.master" AutoEventWireup="true" CodeFile="cdhay.aspx.cs" Inherits="cdhay" %>
        ...
        <tr>
            <td>
                <dx:ASPxGridView ID="GVEditor" runat="server" AutoGenerateColumns="False"
                    ...
                    KeyFieldName="hayid" RightToLeft="True"
...
s.cpShowPopup = undefined;
                    ...
                    <Columns>
                        ...
                        <dx:GridViewDataComboBoxColumn Caption="المحافظة" FieldName="govid" VisibleIndex="2">
                            <PropertiesComboBox DataSourceID="DScdgov" TextField="gov" ValueField="govid">
                                <Columns>
                                    <dx:ListBoxColumn Caption="اسم المحافظة" FieldName="gov" />
                                </Columns>
                            </PropertiesComboBox>
                ...
                <asp:AccessDataSource ID="DSData" runat="server" DataFile="~/App_Data/schools.mdb"
                    DeleteCommand="DELETE FROM [cdhay] WHERE [hayid] = ?" InsertCommand="INSERT INTO [cdhay] ([hayid], [govid], [hay]) VALUES (?, ?, ?)"
                    SelectCommand="SELECT [hayid], [govid], [hay] FROM [cdhay]"
                    UpdateCommand="UPDATE [cdhay] SET [govid] = ?, [hay] = ? WHERE hayid = ?" OnInserting="DSData_Inserting">
                    <DeleteParameters>
                        <asp:Parameter Name="hayid" Type="Byte" />
                    </DeleteParameters>
                    <InsertParameters>
                        <asp:Parameter Name="hayid" Type="Byte" />
                        <asp:Parameter Name="govid" Type="Byte" />
                        <asp:Parameter Name="hay" Type="String" />
                    </InsertParameters>
                    <UpdateParameters>
                        <asp:Parameter Name="govid" Type="Byte" />
                        <asp:Parameter Name="hay" Type="String" />
                ...
                <asp:AccessDataSource ID="DScdgov" runat="server" DataFile="~/App_Data/schools.mdb"
