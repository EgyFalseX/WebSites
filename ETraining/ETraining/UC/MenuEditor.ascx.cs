...
public partial class UserControls_MenuEditor : System.Web.UI.UserControl
{
    ...
    private void LoadData()
    {
        ...
        OleDbDataAdapter DA = new OleDbDataAdapter("SELECT PairntID, PairntName FROM MPairntID", ET_Lib.E_trainingConnection);
        try
        {
            DA.Fill(DTMenus);
    ...
    protected void BtnEditMenu_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            OleDbCommand CMD = new OleDbCommand("UPDATE MPairntID SET PairntName = '" + TxtMenuEdit.Text + "' Where PairntID=" + DDLAllMenus.SelectedValue.ToString(), ET_Lib.E_trainingConnection);
            Con.Open();
            CMD.ExecuteNonQuery();
    ...
    protected void BtnAddElement_Click(object sender, EventArgs e)
    {
        ...
        FileUploadImage.SaveAs(HttpContext.Current.Server.MapPath("Images\\MenuElementsImages\\") + SavingFileName);
        SavingFileName = "~/Images/MenuElementsImages/" + SavingFileName;
        OleDbConnection Con = ET_Lib.E_trainingConnection;
