...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <dx:ASPxDataView ID="ASPxDataView1" runat="server" DataSourceID="DataSourceAccess" Theme="SoftOrange" Width="900px">
        <ItemTemplate>
            <table align="right" class="auto-style1">
                ...
                <tr>
                    <td style="text-align: right">
                        <dx:ASPxLabel ID="lblDetails" runat="server" Text="<%# bind('ItemInfo') %>" Font-Bold="False" Font-Size="Medium" style="text-align: justify; direction: rtl">
                        </dx:ASPxLabel>
                    </td>
                </tr>
                <tr>
                    <td style="text-align: center">
                        <dx:ASPxHyperLink ID="linkDetails" runat="server" NavigateUrl="<%# bind('ItemID', 'ViewDetails.aspx?id={0}') %>" Text="التفاصيل" Font-Size="Medium" />
                    </td>
                </tr>
                <tr>
                    <td style="text-align: center">
