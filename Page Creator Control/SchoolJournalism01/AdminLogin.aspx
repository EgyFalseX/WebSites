<%@ Page Title="" Language="C#" MasterPageFile="MasterPage1.master" AutoEventWireup="true" CodeFile="AdminLogin.aspx.cs" Inherits="Login" %>
    ...
    <asp:Panel ID="PnlLogin" runat="server" Visible="False">
        <table class="style2" dir="rtl" align="center" border="1">
            ...
            <tr>
                <td>&nbsp;</td>
                <td style="text-align: right">
                    <asp:CheckBox ID="ceChangePassword" runat="server" Text="الدخول لصفحة تغير اسم المستخدم/كلمة المرور" />
                </td>
            </tr>
            <tr>
                <td colspan="2">
