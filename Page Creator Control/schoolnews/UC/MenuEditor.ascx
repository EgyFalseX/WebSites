...
<div>
    <table align="center" class="style1" dir="rtl">
        ...
        <tr>
            <td valign="top" class="style2">
                <asp:Label ID="Label10" runat="server" Text="اسم الصفحه2"></asp:Label>
            </td>
            <td>
                <asp:TextBox ID="Txt2Add" runat="server" Width="300px" TabIndex="3"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td valign="top" class="style2">
                <asp:Label ID="Label11" runat="server" Text="مسار الصوره2"></asp:Label>
            </td>
            <td>
                <asp:TextBox ID="Txt2AddImg" runat="server" Width="300px" TabIndex="4"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td valign="top" class="style2">
                <asp:Label ID="Label12" runat="server" Text="معلومه مختصره2"></asp:Label>
            </td>
            <td>
                <asp:TextBox ID="Txt2AddInfo" runat="server" Width="300px" Height="90px" 
        ...
        <tr>
            ...
            <td>
                <asp:ImageButton ID="IBAdd" runat="server" Height="32px" 
                    ...
                    Width="32px" Enabled="False" TabIndex="7" />
            </td>
        </tr>
        <tr>
            <td class="style2">
        ...
        <tr>
            <td valign="top" class="style2">
                <asp:Label ID="Label13" runat="server" Text="اسم الصفحه2"></asp:Label>
            </td>
            <td>
                <asp:TextBox ID="Txt2Edit" runat="server" Width="300px" TabIndex="12"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td valign="top" class="style2">
                <asp:Label ID="Label14" runat="server" Text="مسار الصوره2"></asp:Label>
            </td>
            <td>
                <asp:TextBox ID="Txt2EditImg" runat="server" Width="300px" TabIndex="13"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td valign="top" class="style2">
                <asp:Label ID="Label15" runat="server" Text="معلومه مختصره2"></asp:Label>
            </td>
            <td>
                <asp:TextBox ID="Txt2EditInfo" runat="server" Width="300px" Height="90px" 
