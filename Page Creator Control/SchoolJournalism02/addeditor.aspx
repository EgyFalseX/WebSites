<%@ Page Title="" Language="C#" MasterPageFile="master.master" AutoEventWireup="true" CodeFile="addeditor.aspx.cs" Inherits="centerEditor" %>
    ...
    <tr>
        <td>
            <dx:ASPxGridView ID="GVEditor" runat="server" AutoGenerateColumns="False" 
                ...
                KeyFieldName="addid" RightToLeft="True" 
...
s.cpShowPopup = undefined;
                ...
                <Columns>
                    ...
                    <dx:GridViewDataTextColumn Caption="العدد" FieldName="addname" 
                        VisibleIndex="1">
                    ...
                    <dx:GridViewDataHyperLinkColumn Caption="موضوعات العدد" FieldName="addid" 
                        VisibleIndex="4">
                        <PropertiesHyperLinkEdit NavigateUrlFormatString="subjectEditor.aspx?id={0}" 
                            TextFormatString="الموضوعات">
            ...
            <asp:AccessDataSource ID="DSData" runat="server" 
                ...
                DeleteCommand="DELETE FROM [addno] WHERE [addid] = ?" 
                InsertCommand="INSERT INTO [addno] ( [addName]) VALUES (  ?)" 
                SelectCommand="SELECT addid, addname FROM addno" 
                UpdateCommand="UPDATE [addno] SET [addname] = ? WHERE [addid] = ?" 
