...
{2}" notallowedfileextensionerrortext="امتداد الملف غير مسموح به">
            ...
            <asp:AccessDataSource ID="DSData" runat="server" 
                ...
                InsertCommand="INSERT INTO [MenuItem] ( [ItemName],  [Data_Path], [ItemInfo], [ItemPic]) VALUES (  ?, ?, ?, ?)" 
                SelectCommand="SELECT [ItemID], [ItemName], [Show_Hide], [Data_Path], [ItemInfo], [ItemPic] FROM [MenuItem]" 
                UpdateCommand="UPDATE [MenuItem] SET [ItemName] = ?,  [Data_Path] = ?, [ItemInfo] = ?, [ItemPic] = ? WHERE [ItemID] = ?" 
