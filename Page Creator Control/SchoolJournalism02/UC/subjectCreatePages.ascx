<%@ Control Language="C#" AutoEventWireup="true" CodeFile="subjectCreatePages.ascx.cs" Inherits="subjectCreatePages" %>
        ...
        <tr>
            <td dir="ltr" style="text-align: center" class="style1">
                <dx:ASPxHtmlEditor ID="txt1" runat="server" Height="518px" Width="700px" 
                    ...
                    <SettingsImageUpload UploadImageFolder="~/about/UC/scholfiles/">
                        <ValidationSettings MaxFileSize="102400" 
                            MaxFileSizeErrorText="حجم الملف لا يجب ان يزيد عن 100ك">
                        </ValidationSettings>
                    </SettingsImageUpload>
        ...
        <tr>
            ...
            <asp:Label ID="LblError" runat="server" Visible="False"></asp:Label>
                ...
                <asp:AccessDataSource ID="dsData" runat="server" 
                    ...
                    SelectCommand="SELECT ItemID, ItemName FROM MenuItem ORDER BY ItemID DESC">
