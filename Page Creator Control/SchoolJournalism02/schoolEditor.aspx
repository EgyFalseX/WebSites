<%@ Page Title="" Language="C#" MasterPageFile="masterschool.master" AutoEventWireup="true" CodeFile="schoolEditor.aspx.cs" Inherits="AboutEditor" %>
...
{2}" notallowedfileextensionerrortext="امتداد الملف غير مسموح به">
                    ...
                    <dx:GridViewDataHyperLinkColumn Caption="التفاصيل" FieldName="aboutid" VisibleIndex="11">
                        <PropertiesHyperLinkEdit NavigateUrlFormatString="schoolCreatePage.aspx?id={0}" TextFormatString="التفاصيل">
            ...
            <asp:AccessDataSource ID="DSData" runat="server" 
                ...
                InsertCommand="INSERT INTO [school] ([address], [smallinfo], [primg], [Data_Path]) VALUES ( ?, ?, ?, ?)" 
                SelectCommand="SELECT aboutid, address, smallinfo, primg, Data_Path, addid FROM school ORDER BY aboutid DESC" 
                
                UpdateCommand="UPDATE [school] SET [address] = ?, [smallinfo] = ?, [primg] = ?, [Data_Path] = ? WHERE [aboutid] = ?" 
