<%@ Page Language="C#" MasterPageFile="MasterPage.master" AutoEventWireup="true" CodeFile="Apply.aspx.cs" Inherits="Apply" Title="بيانات ومعلومات" %>
    ...
    <dx:ASPxFormLayout ID="ASPxFormLayoutMain" runat="server" EnableTheming="True" Font-Size="Medium" RightToLeft="True" Theme="SoftOrange" Width="600px" ColCount="2">
        <Items>
            ...
            <dx:LayoutItem Caption="Layout Item" ShowCaption="False" RowSpan="10" Width="300px">
                <LayoutItemNestedControlCollection>
                    <dx:LayoutItemNestedControlContainer runat="server" SupportsDisabledAttribute="True">
                        <dx:ASPxImage ID="ASPxFormLayoutMain_E1" runat="server" 
                            ImageUrl="images/register.jpg" Width="290px">
                        </dx:ASPxImage>
                    </dx:LayoutItemNestedControlContainer>
                </LayoutItemNestedControlCollection>
            </dx:LayoutItem>
