...
public partial class EditorEmp : System.Web.UI.UserControl
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        SqlDataSourceQua.ConnectionString = Functions.MC.ConnectionStr();
        SqlDataSourceGeha.ConnectionString = Functions.MC.ConnectionStr();
        SqlDataSourceTakder.ConnectionString = Functions.MC.ConnectionStr();
        SqlDataSourceJob.ConnectionString = Functions.MC.ConnectionStr();
        SqlDataSourceJobDesc.ConnectionString = Functions.MC.ConnectionStr();
        SqlDataSourceBranch.ConnectionString = Functions.MC.ConnectionStr();
        SqlDataSourceEdara.ConnectionString = Functions.MC.ConnectionStr();
        SqlDataSourceDepertement.ConnectionString = Functions.MC.ConnectionStr();
        SqlDataSourceSalaryType.ConnectionString = Functions.MC.ConnectionStr();
        SqlDataSourceTakasos.ConnectionString = Functions.MC.ConnectionStr();
    }
