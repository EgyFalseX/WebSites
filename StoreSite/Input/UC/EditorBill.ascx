<%@ Control Language="C#" AutoEventWireup="true" CodeFile="EditorBill.ascx.cs" Inherits="UC_EditorBill" %>
        ...
        <asp:Panel ID="PnlBillGeneral" runat="server" Visible="False">
            <table class="Wardstyle1" dir="rtl" align="center" border="1">
                ...
                <tr>
                    ...
                    <td class="Wardstyle5">
                        <asp:TextBox ID="Txtnotypeout" runat="server" ReadOnly="True" Visible="False" 
                ...
                <tr>
                    <td class="Wardstyle3">
                        <asp:Label ID="Label16" runat="server" Font-Bold="True" Font-Size="14px" 
                            Text="طريقة الدفع" ForeColor="Black"></asp:Label>
                    </td>
                    <td class="Wardstyle5">
                ...
                <tr>
                    <td class="Wardstyle3">
                        <asp:Label ID="Label18" runat="server" Text="العميل" Font-Bold="True" 
                    Font-Size="14px" ForeColor="Black"></asp:Label>
                    </td>
                    <td class="Wardstyle5">
                        <telerik:RadComboBox ID="RadComboBoxCustomerId" Runat="server" Skin="Default" 
                ...
                <td>
                    <telerik:RadGrid ID="RadGridEditor" runat="server" 
                        ...
                        <MasterTableView AllowAutomaticDeletes="True" AllowAutomaticInserts="True" 
                            ...
                            <Columns>
                                <telerik:GridTemplateColumn DataField="MaterialId" HeaderText="اسم الصنف" 
                                ...
                                <telerik:GridTemplateColumn DataField="UnitPriceOut" DataType="System.Double" 
                                    HeaderText="سعر الوحده" SortExpression="UnitPriceOut" UniqueName="UnitPriceOut">
                                    <EditItemTemplate>
                                        <asp:TextBox ID="UnitPriceOutTextBox" runat="server" 
                                            Text='<%# Bind("UnitPriceOut") %>'></asp:TextBox>
                                    </EditItemTemplate>
                                    <ItemTemplate>
                                        <asp:Label ID="UnitPriceOutLabel" runat="server" 
                                            Text='<%# Eval("UnitPriceOut") %>'></asp:Label>
                                    </ItemTemplate>
                                    <HeaderStyle HorizontalAlign="Center" />
                                    <ItemStyle HorizontalAlign="Center" />
                                </telerik:GridTemplateColumn>
                                ...
                                <telerik:GridBoundColumn DataField="kasm" DataType="System.Double" 
                                    HeaderText="الخصم" SortExpression="kasm" UniqueName="kasm">
                                    <HeaderStyle HorizontalAlign="Center" />
                                    <ItemStyle HorizontalAlign="Center" />
                                </telerik:GridBoundColumn>
                    ...
                    <asp:SqlDataSource ID="SqlDataSourceCodez" runat="server" 
                        ...
                        InsertCommand="INSERT INTO [tblOutDetails] ([InvIDOut], [MaterialId], [StoreId], [UnitPriceOut], [OutQty], [kasm], [UserIn], [TimeIn]) VALUES (@InvIDOut, @MaterialId, @StoreId, @UnitPriceOut, @OutQty, @kasm, @UserIn, GETDATE())" 
                        OldValuesParameterFormatString="original_{0}" 
                        onselected="SqlDataSourceCodez_Selected" ProviderName="System.Data.SqlClient" 
                        SelectCommand="SELECT (SELECT Material FROM TblMaterialDetiels WHERE (MaterialId = tblOutDetails.MaterialId)) AS Material, (SELECT CategoryId FROM TblMaterialDetiels AS TblMaterialDetiels_1 WHERE (MaterialId = tblOutDetails.MaterialId)) AS CategoryId, InvIDOut, MaterialId, UnitPriceOut, OutQty, StoreId, kasm, UnitPriceOut * OutQty - (UnitPriceOut * OutQty) * (kasm / 100) AS Total FROM tblOutDetails WHERE (InvIDOut = @InvIDOut)" 
                        UpdateCommand="UPDATE [tblOutDetails] SET [StoreId] = @StoreId, [UnitPriceOut] = @UnitPriceOut, [OutQty] = @OutQty, [kasm] = @kasm, [UserIn] = @UserIn, [TimeIn] = GETDATE() WHERE [InvIDOut] = @original_InvIDOut AND [MaterialId] = @original_MaterialId">
                        <DeleteParameters>
                        ...
                        <InsertParameters>
                            ...
                            <asp:Parameter Name="kasm" Type="Double" />
...
<asp:Panel ID="PnlPop" ScrollBars="Both" Style="display: none"
    ...
    BackColor="White" BorderColor="#3399FF" BorderStyle="Solid"  >
        <telerik:RadTreeView ID="RadTreeViewCat" Runat="server" BorderColor="#507CD1" 
                    BorderStyle="Inset" Height="300px" LoadingMessage="تحميـــــــــل ..." 
                    Skin="Hay" style="text-align: left" Font-Bold="True" 
            Font-Size="14px">
                </telerik:RadTreeView>
        <asp:TextBox ID="TxtItemCatID" runat="server" style="direction: rtl" 
        Width="210px"></asp:TextBox>
        <asp:Button ID="BtnOk" runat="server" Text="موافق" onclick="BtnOk_Click" 
            Width="215px" />
        <asp:Button ID="BtnCancel" runat="server" onclick="BtnCancel_Click" Text="اغلاق" 
            Width="215px" />
</asp:Panel>
