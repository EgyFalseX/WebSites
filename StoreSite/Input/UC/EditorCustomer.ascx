<%@ Control Language="C#" AutoEventWireup="true" CodeFile="EditorCustomer.ascx.cs" Inherits="EditorCustomer" %>
    ...
    <table class="style1" dir="rtl" align="center">
        ...
        <tr>
            <td style="text-align: center">
                ...
                <telerik:RadGrid ID="RadGridEditor" runat="server" DataSourceID="SqlDataSourceCodez" 
                    ...
                    onitemupdated="RadGridEditor_ItemUpdated" PageSize="100">
        ...
        <HeaderStyle Width="20px" ForeColor="Black"></HeaderStyle>
            ...
            <Columns>
                ...
                <telerik:GridBoundColumn DataField="street" Display="False" HeaderText="الشارع" 
                    SortExpression="street" UniqueName="street">
                    <HeaderStyle HorizontalAlign="Center" />
                    <ItemStyle HorizontalAlign="Center" />
                </telerik:GridBoundColumn>
                ...
                <telerik:GridBoundColumn DataField="Customermobil3" Display="False" 
                    HeaderText="موبيل3" SortExpression="Customermobil3" UniqueName="Customermobil3">
                    <HeaderStyle HorizontalAlign="Center" />
                    <ItemStyle HorizontalAlign="Center" />
                </telerik:GridBoundColumn>
                ...
                <telerik:GridBoundColumn DataField="AccountTreeId" 
                    HeaderText="كود الشجره" SortExpression="AccountTreeId" 
                    UniqueName="AccountTreeId" ReadOnly="True">
                    <HeaderStyle HorizontalAlign="Center" />
                    <ItemStyle HorizontalAlign="Center" />
                </telerik:GridBoundColumn>
                <telerik:GridBoundColumn DataField="CustomerUserName" HeaderText="اسم المستخدم" 
                    SortExpression="CustomerUserName" UniqueName="CustomerUserName">
                    <HeaderStyle HorizontalAlign="Center" />
                    <ItemStyle HorizontalAlign="Center" />
                </telerik:GridBoundColumn>
                <telerik:GridBoundColumn DataField="CustomerPass" HeaderText="كلمة المرور" 
                    SortExpression="CustomerPass" UniqueName="CustomerPass">
                    <HeaderStyle HorizontalAlign="Center" />
                    <ItemStyle HorizontalAlign="Center" />
                </telerik:GridBoundColumn>
        ...
        <PopUpSettings ScrollBars="None"></PopUpSettings>
            ...
            <CommandItemStyle Font-Bold="False" />
                ...
                <asp:SqlDataSource ID="SqlDataSourceCodez" runat="server" 
                    ...
                    DeleteCommand="DELETE FROM [TblCustomes] WHERE [CustomerId] = @original_CustomerId" 
                    InsertCommand="INSERT INTO [TblCustomes] ([CustomerId], [Customer], [Customernid], [Customer_phone], [GOVId], [MarkazId], [EhyId], [street], [Customeraddres], [email], [Customermobil1], [Customermobil2], [Customermobil3], [AccountId], [StopWork], [CustomerUserName], [CustomerPass], [TimeIn], [UserIn]) VALUES ((SELECT ISNULL(MAX(CustomerId) + 1, 1) AS NewID FROM TblCustomes), @Customer, @Customernid, @Customer_phone, @GOVId, @MarkazId, @EhyId, @street, @Customeraddres, @email, @Customermobil1, @Customermobil2, @Customermobil3, @AccountId, @StopWork, @CustomerUserName, @CustomerPass, GETDATE(), @UserIn)" 
                    OldValuesParameterFormatString="original_{0}" ProviderName="System.Data.SqlClient" 
                    SelectCommand="SELECT [CustomerId], [Customer], [Customernid], [Customer_phone], [GOVId], [MarkazId], [EhyId], [street], [Customeraddres], [email], [Customermobil1], [Customermobil2], [Customermobil3], [AccountId], [StopWork], [CustomerUserName], [CustomerPass], 
(Select AccountTreeId From TblAccounts Where AccountId = TblCustomes.AccountId) AS AccountTreeId , 
[TimeIn], [UserIn] FROM [TblCustomes]" 
                    
                    
                    UpdateCommand="UPDATE [TblCustomes] SET [Customer] = @Customer, [Customernid] = @Customernid, [Customer_phone] = @Customer_phone, [GOVId] = @GOVId, [MarkazId] = @MarkazId, [EhyId] = @EhyId, [street] = @street, [Customeraddres] = @Customeraddres, [email] = @email, [Customermobil1] = @Customermobil1, [Customermobil2] = @Customermobil2, [Customermobil3] = @Customermobil3, [StopWork] = @StopWork, [CustomerUserName] = @CustomerUserName, [CustomerPass] = @CustomerPass, [TimeIn] = GETDATE(), [UserIn] = @UserIn WHERE [CustomerId] = @original_CustomerId" 
                    ...
                    <InsertParameters>
                        ...
                        <asp:Parameter Name="MarkazId" Type="Int32" />
                        <asp:Parameter Name="EhyId" Type="Int32" />
