<%@ Control Language="C#" AutoEventWireup="true" CodeFile="CdDepartment.ascx.cs" Inherits="CdDepartment" %>
...
<div>
    <table align="center" class="style1" dir="rtl">
        ...
        <MasterTableView datakeynames="DepID" datasourceid="SqlDataSourceCodez" 
        ...
        <HeaderStyle Width="20px" ForeColor="Black"></HeaderStyle>
            ...
            <Columns>
                <telerik:GridBoundColumn DataField="DepName" 
                    HeaderText="اسم القسم" SortExpression="DepName" 
                    UniqueName="DepName">
        ...
        <PopUpSettings ScrollBars="None"></PopUpSettings>
            ...
            <CommandItemStyle Font-Bold="False" />
                ...
                <asp:SqlDataSource ID="SqlDataSourceCodez" runat="server" 
                    ...
                    DeleteCommand="DELETE FROM [CdDepertement] WHERE [DepID] = @original_DepID" 
                    InsertCommand="INSERT INTO [CdDepertement] ([DepID], [DepName]) VALUES ((SELECT ISNULL(MAX(DepID) + 1, 1) AS NewID FROM CdDepertement), @DepName)" 
                    OldValuesParameterFormatString="original_{0}" ProviderName="System.Data.SqlClient" 
                    SelectCommand="SELECT [DepID], [DepName] FROM [CdDepertement]" 
                    
                    
                    UpdateCommand="UPDATE [CdDepertement] SET [DepName] = @DepName WHERE [DepID] = @original_DepID">
                    <DeleteParameters>
