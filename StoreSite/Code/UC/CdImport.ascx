<%@ Control Language="C#" AutoEventWireup="true" CodeFile="CdImport.ascx.cs" Inherits="CdImport" %>
...
<div>
    <table align="center" class="style1" dir="rtl">
        ...
        <MasterTableView datakeynames="importcode" datasourceid="SqlDataSourceCodez" 
        ...
        <HeaderStyle Width="20px" ForeColor="Black"></HeaderStyle>
            ...
            <Columns>
                <telerik:GridBoundColumn DataField="import" 
                    HeaderText="درجة الأهمية" SortExpression="import" 
                    UniqueName="import">
        ...
        <PopUpSettings ScrollBars="None"></PopUpSettings>
            ...
            <CommandItemStyle Font-Bold="False" />
                ...
                <asp:SqlDataSource ID="SqlDataSourceCodez" runat="server" 
                    ...
                    DeleteCommand="DELETE FROM [import] WHERE [importcode] = @original_importcode" 
                    InsertCommand="INSERT INTO [import] ([importcode], [import]) VALUES ((SELECT ISNULL(MAX(importcode) + 1, 1) AS NewID FROM import), @import)" 
                    OldValuesParameterFormatString="original_{0}" ProviderName="System.Data.SqlClient" 
                    SelectCommand="SELECT [importcode], [import] FROM [import]" 
                    
                    
                    UpdateCommand="UPDATE [import] SET [import] = @import WHERE [importcode] = @original_importcode">
                    <DeleteParameters>
                        <asp:Parameter Name="original_importcode" Type="Byte" />
                    </DeleteParameters>
                    <InsertParameters>
                        <asp:Parameter Name="import" Type="String" />
                    </InsertParameters>
                    <UpdateParameters>
                        <asp:Parameter Name="import" Type="String" />
                        <asp:Parameter Name="original_importcode" Type="Byte" />
