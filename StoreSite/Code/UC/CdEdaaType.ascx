<%@ Control Language="C#" AutoEventWireup="true" CodeFile="CdEdaaType.ascx.cs" Inherits="EdaaType" %>
...
<div>
    <table align="center" class="style1" dir="rtl">
        ...
        <MasterTableView datakeynames="edaatype" datasourceid="SqlDataSourceCodez" 
        ...
        <HeaderStyle Width="20px" ForeColor="Black"></HeaderStyle>
            ...
            <Columns>
                <telerik:GridBoundColumn DataField="edaaname" 
                    HeaderText="إسم نوع الإيداع" SortExpression="edaaname" 
                    UniqueName="edaaname">
        ...
        <PopUpSettings ScrollBars="None"></PopUpSettings>
            ...
            <CommandItemStyle Font-Bold="False" />
                ...
                <asp:SqlDataSource ID="SqlDataSourceCodez" runat="server" 
                    ...
                    DeleteCommand="DELETE FROM [CDedaatype] WHERE [edaatype] = @original_edaatype" 
                    InsertCommand="INSERT INTO [CDedaatype] ([edaatype], [edaaname]) VALUES ((SELECT ISNULL(MAX(edaatype) + 1, 1) AS NewID FROM CDedaatype), @edaaname)" 
                    OldValuesParameterFormatString="original_{0}" ProviderName="System.Data.SqlClient" 
                    SelectCommand="SELECT [edaatype], [edaaname] FROM [CDedaatype]" 
                    
                    
                    
                    UpdateCommand="UPDATE [CDedaatype] SET [edaaname] = @edaaname WHERE [edaatype] = @original_edaatype">
                    <DeleteParameters>
                        <asp:Parameter Name="original_edaatype" Type="Byte" />
                    </DeleteParameters>
                    <InsertParameters>
                        <asp:Parameter Name="edaaname" Type="String" />
                    </InsertParameters>
                    <UpdateParameters>
                        <asp:Parameter Name="edaaname" Type="String" />
                        <asp:Parameter Name="original_edaatype" Type="Byte" />
