<%@ Control Language="C#" AutoEventWireup="true" CodeFile="CdCommWay.ascx.cs" Inherits="CdCommWay" %>
...
<div>
    <table align="center" class="style1" dir="rtl">
        ...
        <MasterTableView datakeynames="CommWayId" datasourceid="SqlDataSourceCodez" 
        ...
        <HeaderStyle Width="20px" ForeColor="Black"></HeaderStyle>
            ...
            <Columns>
                <telerik:GridBoundColumn DataField="CommWayName" 
                    HeaderText="طريقة الابلاغ" SortExpression="CommWayName" 
                    UniqueName="CommWayName">
        ...
        <PopUpSettings ScrollBars="None"></PopUpSettings>
            ...
            <CommandItemStyle Font-Bold="False" />
                ...
                <asp:SqlDataSource ID="SqlDataSourceCodez" runat="server" 
                    ...
                    DeleteCommand="DELETE FROM [CdCommWay] WHERE [CommWayId] = @original_CommWayId" 
                    InsertCommand="INSERT INTO [CdCommWay] ([CommWayId], [CommWayName]) VALUES ((SELECT ISNULL(MAX(CommWayId) + 1, 1) AS NewID FROM CdCommWay), @CommWayName)" 
                    OldValuesParameterFormatString="original_{0}" ProviderName="System.Data.SqlClient" 
                    SelectCommand="SELECT [CommWayId], [CommWayName] FROM [CdCommWay]" 
                    
                    
                    
                    UpdateCommand="UPDATE [CdCommWay] SET [CommWayName] = @CommWayName WHERE [CommWayId] = @original_CommWayId">
                    <DeleteParameters>
                        <asp:Parameter Name="original_CommWayId" Type="Byte" />
                    </DeleteParameters>
                    <InsertParameters>
                        <asp:Parameter Name="CommWayName" Type="String" />
                    </InsertParameters>
                    <UpdateParameters>
                        <asp:Parameter Name="CommWayName" Type="String" />
                        <asp:Parameter Name="original_CommWayId" Type="Byte" />
