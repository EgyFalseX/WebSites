<%@ Control Language="C#" AutoEventWireup="true" CodeFile="CdTransferType.ascx.cs" Inherits="CdTransferType" %>
...
<div>
    <table align="center" class="style1" dir="rtl">
        ...
        <MasterTableView datakeynames="TransferTypeId" datasourceid="SqlDataSourceCodez" 
        ...
        <HeaderStyle Width="20px" ForeColor="Black"></HeaderStyle>
            ...
            <Columns>
                <telerik:GridBoundColumn DataField="TransferTypeName" 
                    HeaderText="نوع التحويل" SortExpression="TransferTypeName" 
                    UniqueName="TransferTypeName">
                    <HeaderStyle HorizontalAlign="Center" />
                    <ItemStyle HorizontalAlign="Center" />
                </telerik:GridBoundColumn>
                <telerik:GridCheckBoxColumn DataField="ReplyRequired" DataType="System.Boolean" 
                    HeaderText="يتطلب رد" SortExpression="ReplyRequired" UniqueName="ReplyRequired">
                    <HeaderStyle HorizontalAlign="Center" />
                    <ItemStyle HorizontalAlign="Center" />
        ...
        <PopUpSettings ScrollBars="None"></PopUpSettings>
            ...
            <CommandItemStyle Font-Bold="False" />
                ...
                <asp:SqlDataSource ID="SqlDataSourceCodez" runat="server" 
                    ...
                    DeleteCommand="DELETE FROM [CDTransferType] WHERE [TransferTypeId] = @original_TransferTypeId" 
                    InsertCommand="INSERT INTO [CDTransferType] ([TransferTypeId], [TransferTypeName], [ReplyRequired]) VALUES 
((SELECT ISNULL(MAX(TransferTypeId) + 1, 1) AS NewID FROM CDTransferType)
, @TransferTypeName, @ReplyRequired)" 
                    OldValuesParameterFormatString="original_{0}" ProviderName="System.Data.SqlClient" 
                    SelectCommand="SELECT [TransferTypeId], [TransferTypeName], [ReplyRequired] FROM [CDTransferType]" 
                    
                    
                    
                    UpdateCommand="UPDATE [CDTransferType] SET [TransferTypeName] = @TransferTypeName, [ReplyRequired] = @ReplyRequired WHERE [TransferTypeId] = @original_TransferTypeId">
                    <DeleteParameters>
                        <asp:Parameter Name="original_TransferTypeId" Type="Byte" />
                    </DeleteParameters>
                    <InsertParameters>
                        <asp:Parameter Name="TransferTypeName" Type="String" />
                        <asp:Parameter Name="ReplyRequired" Type="Boolean" />
                    </InsertParameters>
                    <UpdateParameters>
                        <asp:Parameter Name="TransferTypeName" Type="String" />
                        <asp:Parameter Name="ReplyRequired" Type="Boolean" />
