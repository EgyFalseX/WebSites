<%@ Control Language="C#" AutoEventWireup="true" CodeFile="CdPaid.ascx.cs" Inherits="CdPaid" %>
...
<div>
    <table align="center" class="style1" dir="rtl">
        ...
        <MasterTableView datakeynames="PaidId" datasourceid="SqlDataSourceCodez" 
        ...
        <HeaderStyle Width="20px" ForeColor="Black"></HeaderStyle>
            ...
            <Columns>
                <telerik:GridBoundColumn DataField="Paidname" 
                    HeaderText="طريقة الدفع" SortExpression="Paidname" 
                    UniqueName="Paidname">
        ...
        <PopUpSettings ScrollBars="None"></PopUpSettings>
            ...
            <CommandItemStyle Font-Bold="False" />
                ...
                <asp:SqlDataSource ID="SqlDataSourceCodez" runat="server" 
                    ...
                    DeleteCommand="DELETE FROM [codepaid] WHERE [PaidId] = @original_PaidId" 
                    InsertCommand="INSERT INTO [codepaid] ([PaidId], [Paidname]) VALUES ((SELECT ISNULL(MAX(PaidId) + 1, 1) AS NewID FROM codepaid), @Paidname)" 
                    OldValuesParameterFormatString="original_{0}" ProviderName="System.Data.SqlClient" 
                    SelectCommand="SELECT [PaidId], [Paidname] FROM [codepaid]" 
                    
                    
                    UpdateCommand="UPDATE [codepaid] SET [Paidname] = @Paidname WHERE [PaidId] = @original_PaidId">
                    <DeleteParameters>
                        <asp:Parameter Name="original_PaidId" Type="Byte" />
                    </DeleteParameters>
                    <InsertParameters>
                        <asp:Parameter Name="Paidname" Type="String" />
                    </InsertParameters>
                    <UpdateParameters>
                        <asp:Parameter Name="Paidname" Type="String" />
                        <asp:Parameter Name="original_PaidId" Type="Byte" />
