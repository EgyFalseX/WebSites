<%@ Control Language="C#" AutoEventWireup="true" CodeFile="CdQualTakder.ascx.cs" Inherits="CdQualTakder" %>
...
<div>
    <table align="center" class="style1" dir="rtl">
        ...
        <MasterTableView datakeynames="QualTakder" datasourceid="SqlDataSourceCodez" 
        ...
        <HeaderStyle Width="20px" ForeColor="Black"></HeaderStyle>
            ...
            <Columns>
                <telerik:GridBoundColumn DataField="QualTakerName" 
                    HeaderText="إسم تقدير المؤهل" SortExpression="QualTakerName" 
                    UniqueName="QualTakerName">
        ...
        <PopUpSettings ScrollBars="None"></PopUpSettings>
            ...
            <CommandItemStyle Font-Bold="False" />
                ...
                <asp:SqlDataSource ID="SqlDataSourceCodez" runat="server" 
                    ...
                    DeleteCommand="DELETE FROM [CdQualTakder] WHERE [QualTakder] = @original_QualTakder" 
                    InsertCommand="INSERT INTO [CdQualTakder] ([QualTakder], [QualTakerName]) VALUES ((SELECT ISNULL(MAX(QualTakder) + 1, 1) AS NewID FROM CdQualTakder), @QualTakerName)" 
                    OldValuesParameterFormatString="original_{0}" ProviderName="System.Data.SqlClient" 
                    SelectCommand="SELECT [QualTakder], [QualTakerName] FROM [CdQualTakder]" 
                    
                    
                    UpdateCommand="UPDATE [CdQualTakder] SET [QualTakerName] = @QualTakerName WHERE [QualTakder] = @original_QualTakder">
                    <DeleteParameters>
                        <asp:Parameter Name="original_QualTakder" Type="Byte" />
                    </DeleteParameters>
                    <InsertParameters>
                        <asp:Parameter Name="QualTakerName" Type="String" />
                    </InsertParameters>
                    <UpdateParameters>
                        <asp:Parameter Name="QualTakerName" Type="String" />
                        <asp:Parameter Name="original_QualTakder" Type="Byte" />
