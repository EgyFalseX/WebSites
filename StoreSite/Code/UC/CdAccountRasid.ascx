<%@ Control Language="C#" AutoEventWireup="true" CodeFile="CdAccountRasid.ascx.cs" Inherits="CdAccountRasid" %>
...
<ValidationSettings CommandsToValidate="Insert,Update"></ValidationSettings>
        ...
        <MasterTableView datakeynames="AccountRasidId" datasourceid="SqlDataSourceCodez" 
...
<CommandItemStyle Font-Bold="False"></CommandItemStyle>
        ...
        <HeaderStyle Width="20px" ForeColor="Black"></HeaderStyle>
            ...
            <Columns>
                <telerik:GridBoundColumn DataField="AccountRasid" 
                    HeaderText="نوع الرصيـــــد" SortExpression="AccountRasid" 
                    UniqueName="AccountRasid">
...
<StatusBarSettings ReadyText="جاهز" LoadingText="تحميل....."></StatusBarSettings>
                ...
                <asp:SqlDataSource ID="SqlDataSourceCodez" runat="server" 
                    ...
                    DeleteCommand="DELETE FROM [CdAccountRasid] WHERE [AccountRasidId] = @original_AccountRasidId" 
                    InsertCommand="INSERT INTO [CdAccountRasid] ([AccountRasidId], [AccountRasid]) VALUES ((SELECT ISNULL(MAX(AccountRasidId) + 1, 1) AS NewID FROM CdAccountRasid), @AccountRasid)" 
                    OldValuesParameterFormatString="original_{0}" ProviderName="System.Data.SqlClient" 
                    SelectCommand="SELECT [AccountRasidId], [AccountRasid] FROM [CdAccountRasid]" 
                    
                    
                    UpdateCommand="UPDATE [CdAccountRasid] SET [AccountRasid] = @AccountRasid WHERE [AccountRasidId] = @original_AccountRasidId">
                    <DeleteParameters>
                        <asp:Parameter Name="original_AccountRasidId" Type="Byte" />
                    </DeleteParameters>
                    <InsertParameters>
                        <asp:Parameter Name="AccountRasid" Type="String" />
                    </InsertParameters>
                    <UpdateParameters>
                        <asp:Parameter Name="AccountRasid" Type="String" />
                        <asp:Parameter Name="original_AccountRasidId" Type="Byte" />
