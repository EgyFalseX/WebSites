<%@ Control Language="C#" AutoEventWireup="true" CodeFile="CdWazefa.ascx.cs" Inherits="CdWazefa" %>
...
<div>
    <table align="center" class="style1" dir="rtl">
        ...
        <MasterTableView datakeynames="wazefa_code" datasourceid="SqlDataSourceCodez" 
        ...
        <HeaderStyle Width="20px" ForeColor="Black"></HeaderStyle>
            ...
            <Columns>
                <telerik:GridBoundColumn DataField="wazefa_name" HeaderText="إسم الوظيفة" 
                    SortExpression="wazefa_name" UniqueName="wazefa_name">
        ...
        <PopUpSettings ScrollBars="None"></PopUpSettings>
            ...
            <CommandItemStyle Font-Bold="False" />
                ...
                <asp:SqlDataSource ID="SqlDataSourceCodez" runat="server" 
                    ...
                    DeleteCommand="DELETE FROM [wazefa] WHERE [wazefa_code] = @original_wazefa_code" 
                    InsertCommand="INSERT INTO [wazefa] ([wazefa_code], [wazefa_name]) VALUES ((SELECT ISNULL(MAX(wazefa_code) + 1, 1) AS NewID FROM wazefa), @wazefa_name)" 
                    OldValuesParameterFormatString="original_{0}" ProviderName="System.Data.SqlClient" 
                    SelectCommand="SELECT [wazefa_code], [wazefa_name] FROM [wazefa]" 
                    
                    
                    UpdateCommand="UPDATE [wazefa] SET [wazefa_name] = @wazefa_name WHERE [wazefa_code] = @original_wazefa_code">
                    <DeleteParameters>
                        <asp:Parameter Name="original_wazefa_code" Type="Int32" />
                    </DeleteParameters>
                    <InsertParameters>
                        <asp:Parameter Name="wazefa_name" Type="String" />
                    </InsertParameters>
                    <UpdateParameters>
                        <asp:Parameter Name="wazefa_name" Type="String" />
                        <asp:Parameter Name="original_wazefa_code" Type="Int32" />
