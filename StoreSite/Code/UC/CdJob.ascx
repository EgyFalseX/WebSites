<%@ Control Language="C#" AutoEventWireup="true" CodeFile="CdJob.ascx.cs" Inherits="CdJob" %>
...
<div>
    <table align="center" class="style1" dir="rtl">
        ...
        <MasterTableView datakeynames="JobId" datasourceid="SqlDataSourceCodez" 
        ...
        <HeaderStyle Width="20px" ForeColor="Black"></HeaderStyle>
            ...
            <Columns>
                <telerik:GridBoundColumn DataField="JobId1" 
                    HeaderText="اسم الوظيفه" SortExpression="JobId1" 
                    UniqueName="JobId1">
        ...
        <PopUpSettings ScrollBars="None"></PopUpSettings>
            ...
            <CommandItemStyle Font-Bold="False" />
                ...
                <asp:SqlDataSource ID="SqlDataSourceCodez" runat="server" 
                    ...
                    DeleteCommand="DELETE FROM [CdJob] WHERE [JobId] = @original_JobId" 
                    InsertCommand="INSERT INTO [CdJob] ([JobId], [JobId1]) VALUES ((SELECT ISNULL(MAX(JobId) + 1, 1) AS NewID FROM CdJob), @JobId1)" 
                    OldValuesParameterFormatString="original_{0}" ProviderName="System.Data.SqlClient" 
                    SelectCommand="SELECT [JobId], [JobId1] FROM [CdJob]" 
                    
                    
                    UpdateCommand="UPDATE [CdJob] SET [JobId1] = @JobId1 WHERE [JobId] = @original_JobId">
                    <DeleteParameters>
                        <asp:Parameter Name="original_JobId" Type="Int32" />
                    </DeleteParameters>
                    <InsertParameters>
                        <asp:Parameter Name="JobId1" Type="String" />
                    </InsertParameters>
                    <UpdateParameters>
                        <asp:Parameter Name="JobId1" Type="String" />
                        <asp:Parameter Name="original_JobId" Type="Int32" />
