<%@ Control Language="C#" AutoEventWireup="true" CodeFile="CdQualTakasos.ascx.cs" Inherits="CdQualTakasos" %>
...
<div>
    <table align="center" class="style1" dir="rtl">
        ...
        <MasterTableView datakeynames="QualTakasos" datasourceid="SqlDataSourceCodez" 
        ...
        <HeaderStyle Width="20px" ForeColor="Black"></HeaderStyle>
            ...
            <Columns>
                <telerik:GridBoundColumn DataField="QualTakasosName" 
                    HeaderText="إسم تخصص المؤهل" SortExpression="QualTakasosName" 
                    UniqueName="QualTakasosName">
                    <HeaderStyle HorizontalAlign="Center" />
                    <ItemStyle HorizontalAlign="Center" />
                </telerik:GridBoundColumn>
                <telerik:GridDropDownColumn DataField="QualId" DataSourceID="SqlDataSourceQual" 
                    HeaderText="اسم المؤهــــل" ListTextField="QualName" ListValueField="QualID" 
                    SortExpression="QualId" UniqueName="column">
                    <HeaderStyle HorizontalAlign="Center" />
                    <ItemStyle HorizontalAlign="Center" />
        ...
        <PopUpSettings ScrollBars="None"></PopUpSettings>
            ...
            <CommandItemStyle Font-Bold="False" />
                ...
                <asp:SqlDataSource ID="SqlDataSourceCodez" runat="server" 
                    ...
                    DeleteCommand="DELETE FROM [CdQualTakasos] WHERE [QualTakasos] = @original_QualTakasos" 
                    InsertCommand="INSERT INTO [CdQualTakasos] ([QualTakasos], [QualId], [QualTakasosName]) VALUES ((SELECT ISNULL(MAX(QualTakasos) + 1, 1) AS NewID FROM CdQualTakasos), @QualId, @QualTakasosName)" 
                    OldValuesParameterFormatString="original_{0}" ProviderName="System.Data.SqlClient" 
                    SelectCommand="SELECT [QualTakasos], [QualId], [QualTakasosName] FROM [CdQualTakasos]" 
                    
                    
                    
                    UpdateCommand="UPDATE [CdQualTakasos] SET [QualId] = @QualId, [QualTakasosName] = @QualTakasosName WHERE [QualTakasos] = @original_QualTakasos">
                    <DeleteParameters>
                        <asp:Parameter Name="original_QualTakasos" Type="Int32" />
                    </DeleteParameters>
                    <InsertParameters>
                        <asp:Parameter Name="QualId" Type="Int32" />
                        <asp:Parameter Name="QualTakasosName" Type="String" />
                    </InsertParameters>
                    <UpdateParameters>
                        <asp:Parameter Name="QualId" Type="Int32" />
                        <asp:Parameter Name="QualTakasosName" Type="String" />
                ...
                <asp:SqlDataSource ID="SqlDataSourceQual" runat="server" 
                    ConnectionString="Data Source=.;Initial Catalog=E_STORE;Integrated Security=True" 
                    OldValuesParameterFormatString="original_{0}" ProviderName="System.Data.SqlClient" 
                    SelectCommand="SELECT [QualID], [QualName] FROM [CdQual]">
                </asp:SqlDataSource>
            </td>
        </tr>
        <tr>
