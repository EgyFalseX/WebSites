<%@ Control Language="C#" AutoEventWireup="true" CodeFile="CdQual.ascx.cs" Inherits="CdQual" %>
...
<div>
    <table align="center" class="style1" dir="rtl">
        ...
        <HeaderStyle Width="20px" ForeColor="Black"></HeaderStyle>
            ...
            <Columns>
                <telerik:GridBoundColumn DataField="QualName" HeaderText="إسم المؤهل" 
                    SortExpression="QualName" UniqueName="QualName">
        ...
        <PopUpSettings ScrollBars="None"></PopUpSettings>
            ...
            <CommandItemStyle Font-Bold="False" />
                ...
                <asp:SqlDataSource ID="SqlDataSourceCodez" runat="server" 
                    ...
                    DeleteCommand="DELETE FROM [CdQual] WHERE [QualID] = @original_QualID" 
                    InsertCommand="INSERT INTO [CdQual] ([QualID], [QualName]) VALUES ((SELECT ISNULL(MAX(QualID) + 1, 1) AS NewID FROM CdQual), @QualName)" 
                    OldValuesParameterFormatString="original_{0}" ProviderName="System.Data.SqlClient" 
                    SelectCommand="SELECT [QualID], [QualName] FROM [CdQual]" 
                    
                    
                    UpdateCommand="UPDATE [CdQual] SET [QualName] = @QualName WHERE [QualID] = @original_QualID">
                    <DeleteParameters>
