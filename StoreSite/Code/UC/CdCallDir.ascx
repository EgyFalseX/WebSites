<%@ Control Language="C#" AutoEventWireup="true" CodeFile="CdCallDir.ascx.cs" Inherits="CdCallDir" %>
...
<div>
    <table align="center" class="style1" dir="rtl">
        ...
        <MasterTableView datakeynames="CallDirId" datasourceid="SqlDataSourceCodez" 
        ...
        <HeaderStyle Width="20px" ForeColor="Black"></HeaderStyle>
            ...
            <Columns>
                <telerik:GridBoundColumn DataField="CallDirName" 
                    HeaderText="اتجاة الاتصال" SortExpression="CallDirName" 
                    UniqueName="CallDirName">
        ...
        <PopUpSettings ScrollBars="None"></PopUpSettings>
            ...
            <PagerStyle PrevPagesToolTip="الصفحات السابقه" PrevPageToolTip="صفحه السابقه" 
            ...
            <CommandItemStyle Font-Bold="False" />
                ...
                <asp:SqlDataSource ID="SqlDataSourceCodez" runat="server" 
                    ...
                    DeleteCommand="DELETE FROM [CDCallDir] WHERE [CallDirId] = @original_CallDirId" 
                    InsertCommand="INSERT INTO [CDCallDir] ([CallDirId], [CallDirName]) VALUES ((SELECT ISNULL(MAX(CallDirId) + 1, 1) AS NewID FROM CDCallDir), @CallDirName)" 
                    OldValuesParameterFormatString="original_{0}" ProviderName="System.Data.SqlClient" 
                    SelectCommand="SELECT [CallDirId], [CallDirName] FROM [CDCallDir]" 
                    
                    
                    
                    UpdateCommand="UPDATE [CDCallDir] SET [CallDirName] = @CallDirName WHERE [CallDirId] = @original_CallDirId">
                    <DeleteParameters>
                        <asp:Parameter Name="original_CallDirId" Type="Byte" />
                    </DeleteParameters>
                    <InsertParameters>
                        <asp:Parameter Name="CallDirName" Type="String" />
                    </InsertParameters>
                    <UpdateParameters>
                        <asp:Parameter Name="CallDirName" Type="String" />
                        <asp:Parameter Name="original_CallDirId" Type="Byte" />
