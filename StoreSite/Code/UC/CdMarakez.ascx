...
<div>
    <table align="center" class="style1" dir="rtl">
        ...
        <MasterTableView datakeynames="MarkazId" datasourceid="SqlDataSourceCodez" 
        ...
        <HeaderStyle Width="20px" ForeColor="Black"></HeaderStyle>
            ...
            <Columns>
                <telerik:GridBoundColumn DataField="MarkazName" 
                    HeaderText="اسم المركز" SortExpression="MarkazName" 
                    UniqueName="MarkazName">
                    <HeaderStyle HorizontalAlign="Center" />
                    <ItemStyle HorizontalAlign="Center" />
                </telerik:GridBoundColumn>
                <telerik:GridDropDownColumn DataField="GOVId" DataSourceID="SqlDataSourceGov" 
                    HeaderText="اسم المحافظه" ListTextField="GOV" ListValueField="GOVId" 
                    SortExpression="GOVId" UniqueName="GOVId">
                    <HeaderStyle HorizontalAlign="Center" />
                    <ItemStyle HorizontalAlign="Center" />
        ...
        <PopUpSettings ScrollBars="None"></PopUpSettings>
            ...
            <CommandItemStyle Font-Bold="False" />
                ...
                <asp:SqlDataSource ID="SqlDataSourceCodez" runat="server" 
                    ...
                    DeleteCommand="DELETE FROM [CdMarakez] WHERE [MarkazId] = @original_MarkazId" 
                    InsertCommand="INSERT INTO [CdMarakez] ([MarkazId], [MarkazName], [GOVId]) VALUES ((SELECT ISNULL(MAX(MarkazId) + 1, 1) AS NewID FROM CdMarakez), @MarkazName, @GOVId)" 
                    OldValuesParameterFormatString="original_{0}" ProviderName="System.Data.SqlClient" 
                    SelectCommand="SELECT [MarkazId], [MarkazName], [GOVId] FROM [CdMarakez]" 
                    
                    
                    UpdateCommand="UPDATE [CdMarakez] SET [MarkazName] = @MarkazName, [GOVId] = @GOVId WHERE [MarkazId] = @original_MarkazId">
                    <DeleteParameters>
                        <asp:Parameter Name="original_MarkazId" Type="Int32" />
                    </DeleteParameters>
                    <InsertParameters>
                        <asp:Parameter Name="MarkazName" Type="String" />
                ...
                <asp:SqlDataSource ID="SqlDataSourceGov" runat="server" 
                    ConnectionString="Data Source=.;Initial Catalog=E_STORE;Integrated Security=True" 
                    OldValuesParameterFormatString="original_{0}" ProviderName="System.Data.SqlClient" 
