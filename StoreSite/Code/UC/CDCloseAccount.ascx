<%@ Control Language="C#" AutoEventWireup="true" CodeFile="CDCloseAccount.ascx.cs" Inherits="CDCloseAccount" %>
...
<div>
    <table align="center" class="style1" dir="rtl">
        ...
        <MasterTableView datakeynames="CloseAccountID" datasourceid="SqlDataSourceCodez" 
        ...
        <HeaderStyle Width="20px" ForeColor="Black"></HeaderStyle>
            ...
            <Columns>
                <telerik:GridBoundColumn DataField="CloseAccountName" 
                    HeaderText="اسم اغلاق الحساب" SortExpression="CloseAccountName" 
                    UniqueName="CloseAccountName">
        ...
        <PopUpSettings ScrollBars="None"></PopUpSettings>
            ...
            <CommandItemStyle Font-Bold="False" />
                ...
                <asp:SqlDataSource ID="SqlDataSourceCodez" runat="server" 
                    ...
                    DeleteCommand="DELETE FROM [CDCloseAccount] WHERE [CloseAccountID] = @original_CloseAccountID" 
                    InsertCommand="INSERT INTO [CDCloseAccount] ([CloseAccountID], [CloseAccountName]) VALUES ((SELECT ISNULL(MAX(CloseAccountID) + 1, 1) AS NewID FROM CDCloseAccount), @CloseAccountName)" 
                    OldValuesParameterFormatString="original_{0}" ProviderName="System.Data.SqlClient" 
                    SelectCommand="SELECT [CloseAccountID], [CloseAccountName] FROM [CDCloseAccount]" 
                    
                    
                    
                    UpdateCommand="UPDATE [CDCloseAccount] SET [CloseAccountName] = @CloseAccountName WHERE [CloseAccountID] = @original_CloseAccountID">
                    <DeleteParameters>
                        <asp:Parameter Name="original_CloseAccountID" Type="Int32" />
                    </DeleteParameters>
                    <InsertParameters>
                        <asp:Parameter Name="CloseAccountName" Type="String" />
                    </InsertParameters>
                    <UpdateParameters>
                        <asp:Parameter Name="CloseAccountName" Type="String" />
                        <asp:Parameter Name="original_CloseAccountID" Type="Int32" />
