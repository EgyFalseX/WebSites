<%@ Control Language="C#" AutoEventWireup="true" CodeFile="CdTransactionType.ascx.cs" Inherits="CdTransactionType" %>
...
<div>
    <table align="center" class="style1" dir="rtl">
        ...
        <MasterTableView datakeynames="TRTypeID" datasourceid="SqlDataSourceCodez" 
        ...
        <HeaderStyle Width="20px" ForeColor="Black"></HeaderStyle>
            ...
            <Columns>
                <telerik:GridBoundColumn DataField="TRTypeName" 
                    HeaderText="نوع المعامله" SortExpression="TRTypeName" 
                    UniqueName="TRTypeName">
        ...
        <PopUpSettings ScrollBars="None"></PopUpSettings>
            ...
            <CommandItemStyle Font-Bold="False" />
                ...
                <asp:SqlDataSource ID="SqlDataSourceCodez" runat="server" 
                    ...
                    DeleteCommand="DELETE FROM [CdTransactionType] WHERE [TRTypeID] = @original_TRTypeID" 
                    InsertCommand="INSERT INTO [CdTransactionType] ([TRTypeID], [TRTypeName]) VALUES ((SELECT ISNULL(MAX(TRTypeID) + 1, 1) AS NewID FROM CdTransactionType), @TRTypeName)" 
                    OldValuesParameterFormatString="original_{0}" ProviderName="System.Data.SqlClient" 
                    SelectCommand="SELECT [TRTypeID], [TRTypeName] FROM [CdTransactionType]" 
                    
                    
                    UpdateCommand="UPDATE [CdTransactionType] SET [TRTypeName] = @TRTypeName WHERE [TRTypeID] = @original_TRTypeID">
                    <DeleteParameters>
                        <asp:Parameter Name="original_TRTypeID" Type="Byte" />
                    </DeleteParameters>
                    <InsertParameters>
                        <asp:Parameter Name="TRTypeName" Type="String" />
                    </InsertParameters>
                    <UpdateParameters>
                        <asp:Parameter Name="TRTypeName" Type="String" />
                        <asp:Parameter Name="original_TRTypeID" Type="Byte" />
