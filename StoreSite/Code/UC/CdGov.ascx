<%@ Control Language="C#" AutoEventWireup="true" CodeFile="CdGov.ascx.cs" Inherits="CdGov" %>
...
<div>
    <table align="center" class="style1" dir="rtl">
        ...
        <MasterTableView datakeynames="GOVId" datasourceid="SqlDataSourceCodez" 
        ...
        <HeaderStyle Width="20px" ForeColor="Black"></HeaderStyle>
            ...
            <Columns>
                <telerik:GridBoundColumn DataField="GOV" 
                    HeaderText="اسم المحافظه" SortExpression="GOV" 
                    UniqueName="GOV">
        ...
        <PopUpSettings ScrollBars="None"></PopUpSettings>
            ...
            <CommandItemStyle Font-Bold="False" />
                ...
                <asp:SqlDataSource ID="SqlDataSourceCodez" runat="server" 
                    ...
                    DeleteCommand="DELETE FROM [CdGov] WHERE [GOVId] = @original_GOVId" 
                    InsertCommand="INSERT INTO [CdGov] ([GOVId], [GOV]) VALUES ((SELECT ISNULL(MAX(GOVId) + 1, 1) AS NewID FROM CdGov), @GOV)" 
                    OldValuesParameterFormatString="original_{0}" ProviderName="System.Data.SqlClient" 
                    SelectCommand="SELECT [GOVId], [GOV] FROM [CdGov]" 
                    
                    
                    UpdateCommand="UPDATE [CdGov] SET [GOV] = @GOV WHERE [GOVId] = @original_GOVId">
                    <DeleteParameters>
                        <asp:Parameter Name="original_GOVId" Type="Byte" />
                    </DeleteParameters>
                    <InsertParameters>
