...
{2}" notallowedfileextensionerrortext="امتداد الملف غير مسموح به">
            ...
            <asp:AccessDataSource ID="DSData" runat="server" 
                ...
                InsertCommand="INSERT INTO [RotatorData] ([aboutid], [Caption], [ImageLink]) VALUES (?, ?, ? )"  
                SelectCommand="SELECT [ID], [aboutid], [Caption], [ImageLink] FROM [RotatorData] WHERE ([aboutid] = ?)" 
                
                UpdateCommand="UPDATE [RotatorData] SET [Caption] = ?, [ImageLink] = ? WHERE [ID] = ?" 
