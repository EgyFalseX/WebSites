...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderMain" runat="Server">
    <div>
        ...
        <table align="center" class="style1">
            ...
            <tr>
                <td class="auto-style1">
                    <asp:SqlDataSource ID="DSCDSyndicate" runat="server" ConnectionString="<%$ ConnectionStrings:ETSTConnectionString %>"
                        SelectCommand="SELECT [SyndicateId], [Syndicate] FROM [CDSyndicate]" OnSelecting="DSCDSyndicate_Selecting">
                    </asp:SqlDataSource>
                    <asp:SqlDataSource ID="DSData" runat="server" ConnectionString="<%$ ConnectionStrings:ETSTConnectionString %>"
