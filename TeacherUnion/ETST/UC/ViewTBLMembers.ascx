...
s.cpShowPopup = undefined;
                ...
                <Columns>
                    ...
                    <dx:GridViewDataImageColumn Caption="الصوره" FieldName="MemberImage" 
                        Name="MemberImage2" VisibleIndex="24">
            ...
            <asp:SqlDataSource ID="DSData" runat="server" 
                ConnectionString="<%$ ConnectionStrings:ETSTConnectionString %>" SelectCommand="SELECT [MemberId], [MemberName], [Bdate], [NID], [Mobile], [ReceiptNo], MemberImage,
datein, cardr, dater
FROM [TBLMembers]
WHERE SyndicateId = @SyndicateId">
                <SelectParameters>
                    <asp:SessionParameter DefaultValue="0" Name="SyndicateId" 
                        SessionField="SyndicateId" />
                </SelectParameters>
            </asp:SqlDataSource>
        </td>
    </tr>
