<%@ Control Language="C#" AutoEventWireup="true" CodeFile="CDSubCommitte.ascx.cs" Inherits="CDSubCommitte" %>
...
s.cpShowPopup = undefined;
                ...
                <Columns>
                    ...
                    <dx:GridViewDataTextColumn Caption="اسم اللجنة" FieldName="SubCommitte" 
                        VisibleIndex="1">
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataTextColumn Caption="كود اللجنة" FieldName="SubCommitteId" ReadOnly="True" VisibleIndex="3">
                        <EditFormSettings Visible="False" />
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataComboBoxColumn Caption="اسم النقابة الفرعية" FieldName="SyndicateId" VisibleIndex="2">
                        <PropertiesComboBox DataSourceID="DSCDSyndicate" TextField="Syndicate" ValueField="SyndicateId" ValueType="System.Int32">
                        </PropertiesComboBox>
            ...
            <asp:SqlDataSource ID="DSData" runat="server" ConnectionString="<%$ ConnectionStrings:ETSTConnectionString %>" DeleteCommand="DELETE FROM [CDSubCommitte] WHERE [SubCommitteId] = @SubCommitteId" InsertCommand="INSERT INTO [CDSubCommitte] ([SubCommitteId], [SubCommitte], [SyndicateId]) VALUES 
((SELECT ISNULL(MAX(SubCommitteId) + 1, 1) FROM CDSubCommitte), @SubCommitte, @SyndicateId)" SelectCommand="SELECT [SubCommitteId], [SubCommitte], [SyndicateId] FROM [CDSubCommitte]" UpdateCommand="UPDATE [CDSubCommitte] SET [SubCommitte] = @SubCommitte, [SyndicateId] = @SyndicateId WHERE [SubCommitteId] = @SubCommitteId">
                <DeleteParameters>
                    <asp:Parameter Name="SubCommitteId" Type="Int32" />
                </DeleteParameters>
                <InsertParameters>
                    <asp:Parameter Name="SubCommitte" Type="String" />
            ...
            <asp:SqlDataSource ID="DSCDSyndicate" runat="server" ConnectionString="<%$ ConnectionStrings:ETSTConnectionString %>" SelectCommand="SELECT [SyndicateId], [Syndicate] FROM [CDSyndicate]">
            </asp:SqlDataSource>
        </td>
    </tr>
    </table>
