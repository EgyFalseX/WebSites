<%@ Control Language="C#" AutoEventWireup="true" CodeFile="CDCompanionType.ascx.cs" Inherits="CDCompanionType" %>
    ...
    <tr>
        <td>
            <dx:ASPxGridView ID="GVEditor" runat="server" AutoGenerateColumns="False" 
                ...
                KeyFieldName="CompanionTypeId" RightToLeft="True" 
...
s.cpShowPopup = undefined;
                ...
                <Columns>
                    ...
                    <dx:GridViewDataTextColumn Caption="الفئة" FieldName="CompanionType" 
                        VisibleIndex="1">
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataTextColumn Caption="كود" FieldName="CompanionTypeId" ReadOnly="True" VisibleIndex="2">
            ...
            <asp:SqlDataSource ID="DSData" runat="server" ConnectionString="<%$ ConnectionStrings:ETSTConnectionString %>" DeleteCommand="DELETE FROM [CDCompanionType] WHERE [CompanionTypeId] = @CompanionTypeId" InsertCommand="INSERT INTO [CDCompanionType] ([CompanionTypeId], [CompanionType]) VALUES 
((SELECT ISNULL(MAX(CompanionTypeId) + 1, 1) FROM CDCompanionType), @CompanionType)" SelectCommand="SELECT [CompanionTypeId], [CompanionType] FROM [CDCompanionType]" UpdateCommand="UPDATE [CDCompanionType] SET [CompanionType] = @CompanionType WHERE [CompanionTypeId] = @CompanionTypeId">
                <DeleteParameters>
                    <asp:Parameter Name="CompanionTypeId" Type="Byte" />
                </DeleteParameters>
                <InsertParameters>
                    <asp:Parameter Name="CompanionTypeId" Type="Byte" />
                    <asp:Parameter Name="CompanionType" Type="String" />
                </InsertParameters>
                <UpdateParameters>
                    <asp:Parameter Name="CompanionType" Type="String" />
                    <asp:Parameter Name="CompanionTypeId" Type="Byte" />
