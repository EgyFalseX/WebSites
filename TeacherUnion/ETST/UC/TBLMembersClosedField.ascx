...
s.cpShowPopup = undefined;
            ...
            <asp:SqlDataSource ID="DSData" runat="server" ConnectionString="<%$ ConnectionStrings:ETSTConnectionString %>" DeleteCommand="DELETE FROM [TBLMembers] WHERE [MemberId] = @MemberId" SelectCommand="SELECT [MemberId], [MemberName], [Closed],
...
(SELECT SubCommitte FROM CDSubCommitte WHERE SubCommitteId = TBLMembers.SubCommitteId) AS SubCommitte
 FROM [TBLMembers]" UpdateCommand="UPDATE [TBLMembers] SET [MemberName] = @MemberName, [Closed] = @Closed WHERE [MemberId] = @MemberId">
                <DeleteParameters>
