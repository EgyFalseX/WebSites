<%@ Control Language="C#" AutoEventWireup="true" CodeFile="CDSyndicate.ascx.cs" Inherits="CDSyndicate" %>
...
s.cpShowPopup = undefined;
                ...
                <Columns>
                    ...
                    <dx:GridViewDataTextColumn Caption="كود النقابة" FieldName="SyndicateId" ReadOnly="True" VisibleIndex="2">
            ...
            <asp:SqlDataSource ID="DSData" runat="server" ConnectionString="<%$ ConnectionStrings:ETSTConnectionString %>" DeleteCommand="DELETE FROM [CDSyndicate] WHERE [SyndicateId] = @SyndicateId" InsertCommand="INSERT INTO [CDSyndicate] ([SyndicateId], [Syndicate]) VALUES 
((SELECT ISNULL(MAX(SyndicateId) + 1, 1) FROM CDSyndicate), @Syndicate)" SelectCommand="SELECT [SyndicateId], [Syndicate] FROM [CDSyndicate]" UpdateCommand="UPDATE [CDSyndicate] SET [Syndicate] = @Syndicate WHERE [SyndicateId] = @SyndicateId">
                <DeleteParameters>
