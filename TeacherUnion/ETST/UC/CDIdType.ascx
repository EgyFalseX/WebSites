<%@ Control Language="C#" AutoEventWireup="true" CodeFile="CDIdType.ascx.cs" Inherits="CDIdType" %>
    ...
    <tr>
        <td>
            <dx:ASPxGridView ID="GVEditor" runat="server" AutoGenerateColumns="False" 
                ...
                KeyFieldName="IdTypeId" RightToLeft="True" 
...
s.cpShowPopup = undefined;
                ...
                <Columns>
                    ...
                    <dx:GridViewDataTextColumn Caption="النوع" FieldName="IdType" 
                        VisibleIndex="1">
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataTextColumn Caption="كود النوع" FieldName="IdTypeId" ReadOnly="True" VisibleIndex="2">
            ...
            <asp:SqlDataSource ID="DSData" runat="server" ConnectionString="<%$ ConnectionStrings:ETSTConnectionString %>" DeleteCommand="DELETE FROM [CDIdType] WHERE [IdTypeId] = @IdTypeId" InsertCommand="INSERT INTO [CDIdType] ([IdTypeId], [IdType]) VALUES 
((SELECT ISNULL(MAX(IdTypeId) + 1, 1) FROM CDIdType), @IdType)" SelectCommand="SELECT [IdTypeId], [IdType] FROM [CDIdType]" UpdateCommand="UPDATE [CDIdType] SET [IdType] = @IdType WHERE [IdTypeId] = @IdTypeId">
                <DeleteParameters>
                    <asp:Parameter Name="IdTypeId" Type="Byte" />
                </DeleteParameters>
                <InsertParameters>
                    <asp:Parameter Name="IdTypeId" Type="Byte" />
