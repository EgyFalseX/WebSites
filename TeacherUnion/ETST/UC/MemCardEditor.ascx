...
s.cpShowPopup = undefined;
            ...
            <asp:SqlDataSource ID="DSData" runat="server" ConnectionString="<%$ ConnectionStrings:ETSTConnectionString %>" SelectCommand="SELECT [MemberId], [MemberName], [cardr], [dater] FROM [TBLMembers] ORDER BY [datein]" UpdateCommand="UPDATE [TBLMembers] SET [MemberName] = @MemberName, [cardr] = @cardr, [dater] = @dater WHERE [MemberId] = @MemberId" OnSelecting="DSData_Selecting">
                <DeleteParameters>
