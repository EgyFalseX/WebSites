...
s.cpShowPopup = undefined;
                ...
                <Columns>
                    ...
                    <dx:GridViewDataImageColumn Caption="الصورة" VisibleIndex="8" 
            ...
            <asp:SqlDataSource ID="DSData" runat="server" 
                ConnectionString="<%$ ConnectionStrings:ETSTConnectionString %>" 
                
                SelectCommand="SELECT [CompanionId], [CompanionName], [MemberId],
...
cardr
 FROM [TBLCompanion]
WHERE EXISTS
(SELECT  SyndicateId FROM TBLMembers WHERE SyndicateId = @SyndicateId AND MemberId = TBLMembers.MemberId)">
                <SelectParameters>
