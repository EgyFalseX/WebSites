<%@ Control Language="C#" AutoEventWireup="true" CodeFile="CDMaritalStatus.ascx.cs" Inherits="CDMaritalStatus" %>
    ...
    <tr>
        <td>
            <dx:ASPxGridView ID="GVEditor" runat="server" AutoGenerateColumns="False" 
                ...
                KeyFieldName="MaritalStatusId" RightToLeft="True" 
...
s.cpShowPopup = undefined;
                ...
                <Columns>
                    ...
                    <dx:GridViewDataTextColumn Caption="الحالة" FieldName="MaritalStatus" 
                        VisibleIndex="1">
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataTextColumn Caption="كود الحالة" FieldName="MaritalStatusId" ReadOnly="True" VisibleIndex="2">
            ...
            <asp:SqlDataSource ID="DSData" runat="server" ConnectionString="<%$ ConnectionStrings:ETSTConnectionString %>" DeleteCommand="DELETE FROM [CDMaritalStatus] WHERE [MaritalStatusId] = @MaritalStatusId" InsertCommand="INSERT INTO [CDMaritalStatus] ([MaritalStatusId], [MaritalStatus]) VALUES 
((SELECT ISNULL(MAX(MaritalStatusId) + 1, 1) FROM CDMaritalStatus), @MaritalStatus)" SelectCommand="SELECT [MaritalStatusId], [MaritalStatus] FROM [CDMaritalStatus]" UpdateCommand="UPDATE [CDMaritalStatus] SET [MaritalStatus] = @MaritalStatus WHERE [MaritalStatusId] = @MaritalStatusId">
                <DeleteParameters>
                    <asp:Parameter Name="MaritalStatusId" Type="Byte" />
                </DeleteParameters>
                <InsertParameters>
