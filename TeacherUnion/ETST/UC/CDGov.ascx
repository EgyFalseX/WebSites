    ...
    <tr>
        <td>
            <dx:ASPxGridView ID="GVEditor" runat="server" AutoGenerateColumns="False" 
                ...
                KeyFieldName="GovId" RightToLeft="True" 
...
s.cpShowPopup = undefined;
                ...
                <Columns>
                    ...
                    <dx:GridViewDataTextColumn Caption="اسم المحافظه" FieldName="GOV" 
                        VisibleIndex="1">
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataTextColumn Caption="كود الحمحافظة" FieldName="GovId" ReadOnly="True" VisibleIndex="2">
...
VALUES
((SELECT ISNULL(MAX(GovId) + 1, 1) FROM CDGov), @GOV)" SelectCommand="SELECT [GovId], [GOV] FROM [CDGov]" UpdateCommand="UPDATE [CDGov] SET [GOV] = @GOV WHERE [GovId] = @GovId">
                <DeleteParameters>
