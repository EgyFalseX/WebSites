...
s.cpShowPopup = undefined;
            ...
            <asp:SqlDataSource ID="DSData" runat="server" ConnectionString="<%$ ConnectionStrings:ETSTConnectionString %>" SelectCommand="SELECT [CompanionId], [CompanionName], [cardr], [dater] FROM [TBLCompanion] ORDER BY [datein]" UpdateCommand="UPDATE [TBLCompanion] SET [CompanionName] = @CompanionName, [cardr] = @cardr, [dater] = @dater WHERE [CompanionId] = @CompanionId" OnSelecting="DSData_Selecting">
                <DeleteParameters>
