...
public partial class member_no_monyViewer : System.Web.UI.UserControl
{
    protected void Page_Load(object sender, EventArgs e)
    {
        dsEstrdaddata ds = new dsEstrdaddata();
        dsEstrdaddataTableAdapters.member_no_monyTableAdapter adpmember_no_mony = new dsEstrdaddataTableAdapters.member_no_monyTableAdapter();
        adpmember_no_mony.Fill(ds.member_no_mony);
        GVEditor.DataSource = ds.member_no_mony;
