<%@ Control Language="C#" AutoEventWireup="true" CodeFile="tabea_monyViewer.ascx.cs" Inherits="tabea_monyViewer" %>
    ...
    <tr>
        <td>
            <dx:ASPxGridView ID="GVEditor" runat="server" AutoGenerateColumns="False" 
                Caption="البيــــــــــا نـــــــــــــــات" RightToLeft="True" 
...
s.cpShowPopup = undefined;
                ...
                <Columns>
                    ...
                    <dx:GridViewDataTextColumn Caption="المبلغ" FieldName="mnycome" ReadOnly="True" 
                        VisibleIndex="2">
                        <EditFormSettings Visible="False" />
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataTextColumn Caption="الحالة" FieldName="servicetype" 
                        ReadOnly="True" VisibleIndex="3">
                        <EditFormSettings Visible="False" />
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataMemoColumn Caption="ملاحظات" FieldName="rem" 
                        VisibleIndex="9">
                        <EditFormSettings Visible="False" />
                    </dx:GridViewDataMemoColumn>
                    <dx:GridViewDataDateColumn Caption="التاريخ" FieldName="dateservice" 
                        VisibleIndex="5">
                        <PropertiesDateEdit DisplayFormatString="yyyy/MM/dd">
                        </PropertiesDateEdit>
                        <EditFormSettings Visible="False" />
                    </dx:GridViewDataDateColumn>
                    <dx:GridViewDataTextColumn Caption="الاسم" FieldName="CompanionName" 
                        VisibleIndex="1">
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataTextColumn Caption="الحافظة" FieldName="hafzano" 
                        VisibleIndex="7">
                        <EditFormSettings Visible="False" />
                    </dx:GridViewDataTextColumn>
                </Columns>
