<%@ Control Language="C#" AutoEventWireup="true" CodeFile="tabea_no_monyViewer.ascx.cs" Inherits="tabea_no_monyViewer" %>
...
s.cpShowPopup = undefined;
                ...
                <Columns>
                    ...
                    <dx:GridViewDataDateColumn Caption="التاريخ" FieldName="datesend" 
                        VisibleIndex="5">
