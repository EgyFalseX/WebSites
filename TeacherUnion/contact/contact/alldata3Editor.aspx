<%@ Page Title="" Language="C#" MasterPageFile="master.master" AutoEventWireup="true" CodeFile="alldata3Editor.aspx.cs" Inherits="alldata3Editor" %>
...
s.cpShowPopup = undefined;
                ...
                <Columns>
                    ...
                    <dx:GridViewDataComboBoxColumn Caption="الوظيفة" FieldName="jobid" VisibleIndex="4" ShowInCustomizationForm="True">
                    ...
                    <dx:GridViewDataComboBoxColumn Caption="الفرعية" FieldName="syndicateId" VisibleIndex="6" ShowInCustomizationForm="True">
                        <PropertiesComboBox DataSourceID="DSsyndicateId" TextField="syndicate" ValueField="syndicateId" DropDownStyle="DropDown" IncrementalFilteringMode="StartsWith" Width="250px">
                            <Columns>
            ...
            <asp:AccessDataSource ID="DSData" runat="server" DataFile="~/App_Data/contact.mdb" 
                DeleteCommand="DELETE FROM [alldata] WHERE [id] = ?" InsertCommand="INSERT INTO [alldata] ( [sname], [jobid], [smobile], [mail], [stype], [syndicateId]) VALUES ( ?, ?, ?, ?, 3, ?)" SelectCommand="SELECT [id], [sname], [jobid], [smobile], [mail], [stype], [syndicateId] FROM [alldata] WHERE ([syndicateId] = ?)
And stype = 3" 
...
WHERE type = 3">
            ...
            <asp:AccessDataSource ID="DSsyndicateId" runat="server" DataFile="~/App_Data/contact.mdb" SelectCommand="SELECT [syndicateId], [syndicate] FROM [CDsyndicate] WHERE ([syndicateId] = ?)">
                <SelectParameters>
                    <asp:SessionParameter DefaultValue="0" Name="syndicateId" SessionField="syndicateIdcontact" Type="Int32" />
                </SelectParameters>
            </asp:AccessDataSource>
