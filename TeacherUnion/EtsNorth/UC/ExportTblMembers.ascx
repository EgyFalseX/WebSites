    ...
    <tr>
        <td>
            <dx:ASPxGridView ID="GVEditor" runat="server" AutoGenerateColumns="False" 
                ...
                onrowinserted="GVEditor_RowInserted" Font-Bold="True" OnStartRowEditing="GVEditor_StartRowEditing" DataSourceID="DSData">
...
s.cpShowPopup = undefined;
                ...
                <Columns>
                    ...
                    <dx:GridViewDataDateColumn Caption="تاريخ الميلاد" FieldName="BirthDate" VisibleIndex="2">
                        <PropertiesDateEdit DisplayFormatString="{0:dd/MM/yyyy}">
                        </PropertiesDateEdit>
                    </dx:GridViewDataDateColumn>
                    <dx:GridViewDataTextColumn Caption="رقم" FieldName="num" VisibleIndex="0">
                    </dx:GridViewDataTextColumn>
                </Columns>
            ...
            <asp:SqlDataSource ID="DSData" runat="server" ConnectionString="<%$ ConnectionStrings:EtsNorthConnectionString %>" SelectCommand="SELECT ROW_NUMBER() OVER (ORDER BY MemberId) AS num,
