<%@ Control Language="C#" AutoEventWireup="true" CodeFile="tblestefaViewer.ascx.cs" Inherits="tblestefaViewer" %>
...
s.cpShowPopup = undefined;
                ...
                <Columns>
                    ...
                    <dx:GridViewDataTextColumn Caption="النقابة الفرعية" FieldName="Syndicate" ReadOnly="True" VisibleIndex="2">
                        <EditFormSettings Visible="False" />
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataTextColumn Caption="اللجنة النقابية" FieldName="SubCommitte" ReadOnly="True" VisibleIndex="3">
                        <EditFormSettings Visible="False" />
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataMemoColumn Caption="سبب الاستيفاء" FieldName="resoon" 
                        VisibleIndex="4">
                    </dx:GridViewDataMemoColumn>
                    <dx:GridViewDataDateColumn Caption="التاريخ" FieldName="datein" 
                        VisibleIndex="6">
                        <PropertiesDateEdit DisplayFormatString="yyyy/MM/dd">
                        </PropertiesDateEdit>
                    </dx:GridViewDataDateColumn>
                    <dx:GridViewDataTextColumn Caption="الحافظة" FieldName="hafzaid" 
                        VisibleIndex="1">
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataTextColumn Caption="الايصال" FieldName="esal" VisibleIndex="8">
                    </dx:GridViewDataTextColumn>
                </Columns>
            ...
            <asp:AccessDataSource ID="DSData" runat="server" 
                ...
                SelectCommand="SELECT tblestefa.MemberId, tblestefa.SyndicateId, tblestefa.SubCommitteId, tblestefa.MemberName, tblestefa.resoon, tblestefa.datein, CDSyndicate.Syndicate, CDSubCommitte.SubCommitte, tblestefa.hafzaid, tblestefa.esal FROM ((tblestefa LEFT OUTER JOIN CDSubCommitte ON tblestefa.SubCommitteId = CDSubCommitte.SubCommitteId) LEFT OUTER JOIN CDSyndicate ON tblestefa.SyndicateId = CDSyndicate.SyndicateId) WHERE (tblestefa.SyndicateId = ?)" 
                OnSelecting="DSData_Selecting">
                <SelectParameters>
                    <asp:SessionParameter DefaultValue="0" Name="?" 
                        SessionField="MemberCardSyndicateId" />
                </SelectParameters>
