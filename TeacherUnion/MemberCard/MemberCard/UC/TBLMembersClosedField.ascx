<%@ Control Language="C#" AutoEventWireup="true" CodeFile="TBLMembersClosedField.ascx.cs" Inherits="TBLMembersClosedField" %>
...
s.cpShowPopup = undefined;
                ...
                <Columns>
                    ...
                    <dx:GridViewDataCheckColumn Caption="اغلاق التعديل" FieldName="closed" VisibleIndex="4">
            ...
            <asp:AccessDataSource ID="DSData" runat="server" DataFile="~/App_Data/MemberCard.mdb" DeleteCommand="DELETE FROM [TBLAllMember] WHERE [MemberId] = ?" InsertCommand="INSERT INTO [TBLAllMember] ([MemberId], [closed]) VALUES (?, ?)" SelectCommand="SELECT [MemberId], [MemberName], [closed],
...
(SELECT SubCommitte FROM CDSubCommitte WHERE SubCommitteId = TBLAllMember.SubCommitteId) AS SubCommitte
 FROM [TBLAllMember]" UpdateCommand="UPDATE [TBLAllMember] SET [closed] = ? WHERE [MemberId] = ?" OnSelecting="DSData_Selecting">
                <DeleteParameters>
