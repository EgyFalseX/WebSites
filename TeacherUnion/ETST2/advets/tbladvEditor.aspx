<%@ Page Title="" Language="C#" MasterPageFile="master.master" AutoEventWireup="true" CodeFile="tbladvEditor.aspx.cs" Inherits="tbladvEditor" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderMain" runat="Server">
    <table align="center" class="auto-style1" dir="rtl">
        ...
        <tr>
            ...
            <td class="auto-style2">
                <dx:ASPxDateEdit ID="deadvdate" runat="server" Font-Size="12pt" Width="250px" Theme="PlasticBlue">
                    <ValidationSettings ValidationGroup="gv">
                        <RequiredField ErrorText="يجب ادخال تاريخ الفعالية" IsRequired="True" />
                    </ValidationSettings>
                </dx:ASPxDateEdit>
            </td>
        </tr>
        <tr>
            ...
            <td>
                <dx:ASPxComboBox ID="cbIdTypeId" runat="server" Font-Size="12pt" TabIndex="1" Width="250px" Theme="PlasticBlue" DataSourceID="dsCDIdType" TextField="IdType" ValueField="IdTypeId">
                    <Columns>
                        <dx:ListBoxColumn Caption="النوع" FieldName="IdType" />
                    </Columns>
                    <ValidationSettings ValidationGroup="gv">
                        <RequiredField ErrorText="يجب ادخال نوع الفعالية" IsRequired="True" />
                    </ValidationSettings>
                </dx:ASPxComboBox>
                <asp:AccessDataSource ID="dsCDIdType" runat="server" DataFile="~/App_Data/advets.mdb" SelectCommand="SELECT [IdTypeId], [IdType] FROM [CDIdType]"></asp:AccessDataSource>
            </td>
        </tr>
        <tr>
            <td>
            ...
            <td>
                <dx:ASPxTextBox ID="tbplacce" runat="server" Font-Size="12pt" TabIndex="2" Width="250px" Theme="PlasticBlue">
                </dx:ASPxTextBox>
            </td>
        </tr>
        <tr>
            ...
            <td>
                <dx:ASPxMemo ID="tbremmarks" runat="server" Font-Size="12pt" Height="50px" TabIndex="3" Width="250px" Theme="PlasticBlue">
                </dx:ASPxMemo>
            </td>
        </tr>
        <tr>
            ...
            <td>
                <dx:ASPxTextBox ID="tbnumber" runat="server" Font-Size="12pt" TabIndex="4" Width="250px" Theme="PlasticBlue">
        ...
        <tr>
            ...
            <td>
                <dx:ASPxMemo ID="tbegabeat" runat="server" Font-Size="12pt" Height="50px" TabIndex="5" Width="250px" Theme="PlasticBlue">
                </dx:ASPxMemo>
            </td>
        </tr>
        <tr>
            ...
            <td>
                <dx:ASPxMemo ID="tbsalbeat" runat="server" Font-Size="12pt" Height="50px" TabIndex="6" Width="250px" Theme="PlasticBlue">
                </dx:ASPxMemo>
            </td>
        </tr>
        <tr>
            ...
            <td>
                <dx:ASPxMemo ID="tbsugeest" runat="server" Font-Size="12pt" Height="50px" TabIndex="7" Width="250px" Theme="PlasticBlue">
                </dx:ASPxMemo>
            </td>
        </tr>
        <tr>
            ...
            <td>
                <dx:ASPxTextBox ID="tbresmobile" runat="server" Font-Size="12pt" TabIndex="8" Width="250px" Theme="PlasticBlue">
                </dx:ASPxTextBox>
            </td>
        </tr>
        <tr>
...
myImg.SetImageUrl('../Assets/advetsImages/' + e.callbackData);
}">
                    </ClientSideEvents>
