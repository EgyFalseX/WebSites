<%@ Control Language="C#" AutoEventWireup="true" CodeFile="MemCardEditor.ascx.cs" Inherits="MemCardEditor" %>
...
s.cpShowPopup = undefined;
                ...
                <Columns>
                    ...
                    <dx:GridViewDataTextColumn Caption="اسم العضو" FieldName="MemberName" 
                        VisibleIndex="1">
                    ...
                    <dx:GridViewDataTextColumn Caption="الفرعية" FieldName="Syndicate" VisibleIndex="4">
                    </dx:GridViewDataTextColumn>
                </Columns>
            ...
            <asp:AccessDataSource ID="DSData" runat="server" DataFile="~/App_Data/ETST.mdb" 
                SelectCommand="SELECT TBLMembers.MemberId, TBLMembers.MemberName, TBLMembers.cardr, TBLMembers.dater, CDSyndicate.Syndicate FROM (TBLMembers LEFT OUTER JOIN CDSyndicate ON TBLMembers.SyndicateId = CDSyndicate.SyndicateId) ORDER BY TBLMembers.datein" 
                UpdateCommand="UPDATE [TBLMembers] SET [MemberName] = ?, [cardr] = ?, [dater] = ? WHERE [MemberId] = ?" 
