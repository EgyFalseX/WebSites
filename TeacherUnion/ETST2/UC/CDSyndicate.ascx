...
s.cpShowPopup = undefined;
            ...
            <asp:AccessDataSource ID="DSData" runat="server" DataFile="~/App_Data/ETST.mdb" 
                DeleteCommand="DELETE FROM [CDSyndicate] WHERE [SyndicateId] = ?" InsertCommand="INSERT INTO [CDSyndicate] ([SyndicateId], [Syndicate]) VALUES 
(?, ?)" SelectCommand="SELECT [SyndicateId], [Syndicate] FROM [CDSyndicate]" 
                UpdateCommand="UPDATE [CDSyndicate] SET [Syndicate] = ? WHERE [SyndicateId] = ?" 
