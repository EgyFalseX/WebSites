...
s.cpShowPopup = undefined;
            ...
            <asp:AccessDataSource ID="DSData" runat="server" DataFile="~/App_Data/ETST.mdb" 
                DeleteCommand="DELETE FROM [TBLMembers] WHERE [MemberId] = ?" SelectCommand="SELECT [MemberId], [MemberName], [Closed],
...
(SELECT SubCommitte FROM CDSubCommitte WHERE SubCommitteId = TBLMembers.SubCommitteId) AS SubCommitte
 FROM [TBLMembers]" 
                UpdateCommand="UPDATE [TBLMembers] SET [MemberName] = ?, [Closed] = ? WHERE [MemberId] = ?">
                <DeleteParameters>
