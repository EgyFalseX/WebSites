...
s.cpShowPopup = undefined;
            ...
            <asp:AccessDataSource ID="DSData" runat="server" DataFile="~/App_Data/ETST.mdb" 
                DeleteCommand="DELETE FROM [CDIdType] WHERE [IdTypeId] = ?" InsertCommand="INSERT INTO [CDIdType] ([IdTypeId], [IdType]) VALUES 
(?, ?)" SelectCommand="SELECT [IdTypeId], [IdType] FROM [CDIdType]" 
                UpdateCommand="UPDATE [CDIdType] SET [IdType] = ? WHERE [IdTypeId] = ?" 
