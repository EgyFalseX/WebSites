...
s.cpShowPopup = undefined;
                ...
                <Columns>
                    ...
                    <dx:GridViewDataTextColumn Caption="فرعية المشترك" FieldName="MemberSyndicate" VisibleIndex="12">
                    </dx:GridViewDataTextColumn>
                </Columns>
            ...
            <asp:AccessDataSource ID="DSData" runat="server" 
                DataFile="~/App_Data/ETST.mdb" SelectCommand="SELECT [CompanionId], [CompanionName], [CompanionBdate], [MemberId],
...
cardr, dater,
(SELECT Syndicate FROM CDSyndicate WHERE SyndicateId = (SELECT MemberSyndicateId FROM TBLMembers WHERE MemberId = TBLCompanion.MemberId)) AS MemberSyndicate
 FROM [TBLCompanion]">
