<%@ Control Language="C#" AutoEventWireup="true" CodeFile="UserAppilty.ascx.cs" Inherits="UserAppilty" %>
    ...
    <tr>
        <td>
            <dx:ASPxGridView ID="GVEditor" runat="server" AutoGenerateColumns="False" 
                ...
                KeyFieldName="pid" RightToLeft="True" 
...
s.cpShowPopup = undefined;
                ...
                <Columns>
                    ...
                    <dx:GridViewDataComboBoxColumn Caption="اسم المستخدم" FieldName="id" 
                        VisibleIndex="1">
                        <PropertiesComboBox DataSourceID="DSUserInfo" TextField="user" ValueField="id" 
                            ValueType="System.Int32">
                            <Columns>
                                <dx:ListBoxColumn Caption="الاسم" FieldName="user" />
                            </Columns>
                        </PropertiesComboBox>
            ...
            <asp:AccessDataSource ID="DSData" runat="server" DataFile="../App_Data/contact.mdb" 
                DeleteCommand="DELETE FROM [UserAppilty] WHERE pid = ?" 
                InsertCommand="INSERT INTO [UserAppilty] ([id], [LagnaId], [EdaraId]) VALUES (?, ?, ?)" 
                SelectCommand="SELECT [id], [LagnaId], [EdaraId], [pid] FROM [UserAppilty]" 
                ...
                UpdateCommand="UPDATE [UserAppilty] SET [id] = ?, [LagnaId] = ?, [EdaraId] = ? WHERE pid = ?">
                <DeleteParameters>
            ...
            <asp:AccessDataSource ID="DSUserInfo" runat="server" DataFile="../App_Data/contact.mdb" 
                SelectCommand="SELECT [id], [user] FROM [UserInfo]">
            </asp:AccessDataSource>
