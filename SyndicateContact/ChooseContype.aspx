<%@ Page Title="" Language="C#" MasterPageFile="Master.master" AutoEventWireup="true" CodeFile="ChooseContype.aspx.cs" Inherits="ChooseContype" %>
        ...
        <tr>
            <td align="right" bgcolor="#CCD9EB" class="style2" valign="top">
                <dx:ASPxComboBox ID="ASPxCB" runat="server" 
                    ...
                    TextField="contype" ValueField="contypeid">
                    <Columns>
                    ...
                    <ValidationSettings ErrorText="عنصر خطاء" ErrorTextPosition="Bottom" 
                        ...
                        <RequiredField ErrorText="يجب اختيار عنصر من عناصر نوع الرساله" 
                            IsRequired="True" />
                    </ValidationSettings>
                </dx:ASPxComboBox>
