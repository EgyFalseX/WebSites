<%@ Control Language="C#" AutoEventWireup="true" CodeFile="RotatorElement.ascx.cs" Inherits="RotatorElement" %>
    ...
    <tr>
        <td>
            <dx:ASPxGridView ID="GVEditor" runat="server" AutoGenerateColumns="False" 
                ...
                KeyFieldName="IDElement" RightToLeft="True" 
...
s.cpShowPopup = undefined;
                ...
                <Columns>
                    ...
                    <dx:GridViewDataTextColumn Caption="الموضوع" FieldName="Caption" 
                        VisibleIndex="1">
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataCheckColumn Caption="يعرض ام لا" FieldName="show" 
                        VisibleIndex="2">
            ...
            <asp:AccessDataSource ID="DSData" runat="server" DataFile="../App_Data/DataDB.mdb" 
                DeleteCommand="DELETE FROM [RotatorElement] WHERE [IDElement] = ?" 
                InsertCommand="INSERT INTO [RotatorElement] ([Caption], [show]) VALUES (?, ?)" 
                ...
                UpdateCommand="UPDATE [RotatorElement] SET [Caption] = ?, [show] = ? WHERE [IDElement] = ?">
                <DeleteParameters>
