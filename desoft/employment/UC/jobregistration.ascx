<%@ Control Language="C#" AutoEventWireup="true" CodeFile="jobregistration.ascx.cs"
    Inherits="jobregistration" %>
                            ...
                            <tr>
                                ...
                                <td class="style2">
                                    <dx:ASPxComboBox ID="cbadvid" runat="server" CssFilePath="../App_Themes/DevEx/{0}/styles.css"
                                        ...
                                        Width="200px" DataSourceID="DSadvjob" TabIndex="2" TextField="advsubject" 
                                        ValueField="advid">
                                        <Columns>
                            ...
                            <tr>
                                ...
                                <td class="style2">
                                    <dx:ASPxComboBox ID="cbnationalityid" runat="server" CssFilePath="../App_Themes/DevEx/{0}/styles.css"
                                        CssPostfix="DevEx" Spacing="0" SpriteCssFilePath="../App_Themes/DevEx/{0}/sprite.css"
                                        Width="200px" DataSourceID="DSnationalitycd" TabIndex="3" TextField="nationality"
                            ...
                            <tr>
                                ...
                                <td class="style7">
                                    <dx:ASPxComboBox ID="cbempstat" runat="server" CssFilePath="../App_Themes/DevEx/{0}/styles.css"
                                        CssPostfix="DevEx" Spacing="0" SpriteCssFilePath="../App_Themes/DevEx/{0}/sprite.css"
                                        Width="200px" DataSourceID="DScdempstat" TabIndex="4" TextField="state" ValueField="empstat">
                                        <Columns>
    ...
    <tr>
        <td>
            <dx:ASPxButton ID="btnsend" runat="server" CssFilePath="../App_Themes/DevEx/{0}/styles.css"
                ...
                Text="ا رســــــــــــــال" RightToLeft="True" ValidationGroup="errorGrp" 
                TabIndex="33">
            </dx:ASPxButton>
        </td>
    </tr>
</table>
<asp:AccessDataSource ID="DSadvjob" runat="server" DataFile="../App_Data/tawzif.mdb"
    
    SelectCommand="SELECT advid, advsubject FROM advjob WHERE (showonsite = true)">
</asp:AccessDataSource>
<asp:AccessDataSource ID="DSnationalitycd" runat="server" DataFile="../App_Data/tawzif.mdb"
    SelectCommand="SELECT [nationalityid], [nationality] FROM [nationalitycd]"></asp:AccessDataSource>
<asp:AccessDataSource ID="DScdempstat" runat="server" DataFile="../App_Data/tawzif.mdb"
    SelectCommand="SELECT [empstat], [state] FROM [cdempstat]"></asp:AccessDataSource>
