<%@ Control Language="C#" AutoEventWireup="true" CodeFile="UsersMeetingsEditor.ascx.cs" Inherits="UsersMeetingsEditor" %>
    ...
    <tr>
        <td>
            <dx:ASPxGridView ID="GVEditor" runat="server" AutoGenerateColumns="False" 
                ...
                onrowinserted="GVEditor_RowInserted" Width="400px" Font-Bold="True">
...
s.cpShowPopup = undefined;
                ...
                <Columns>
                    ...
                    <dx:GridViewDataComboBoxColumn Caption="المستخدم" FieldName="id" 
                        VisibleIndex="2">
                        <PropertiesComboBox DataSourceID="DSaddata" TextField="user" ValueField="id" 
            ...
            <asp:AccessDataSource ID="DSData" runat="server" DataFile="../App_Data/Synricate.mdb" 
                DeleteCommand="DELETE FROM [UserMeeting] WHERE pid = ?" 
                InsertCommand="INSERT INTO [UserMeeting] ([id], [LagnaId]) VALUES (?, ?)" 
                SelectCommand="SELECT [id], [LagnaId], [pid] FROM [UserMeeting]" 
                UpdateCommand="UPDATE UserMeeting SET id = ?, LagnaId = ? WHERE (pid = ?)">
                <DeleteParameters>
            ...
            <asp:AccessDataSource ID="DSaddata" runat="server" DataFile="../App_Data/Synricate.mdb" 
                SelectCommand="SELECT [id], [user] FROM [addata]">
            </asp:AccessDataSource>
