...
s.cpShowPopup = undefined;
            ...
            <asp:AccessDataSource ID="DSData" runat="server" DataFile="../App_Data/Synricate.mdb" 
                ...
                InsertCommand="INSERT INTO [addata] ([user], [pass], seeall) VALUES (?, ?, ?)" 
                SelectCommand="SELECT id, [user], pass, seeall FROM addata" 
                
                
                
                
                UpdateCommand="UPDATE [addata] SET [user] = ?, [pass] = ?, seeall = ? WHERE [id] = ?">
                <DeleteParameters>
