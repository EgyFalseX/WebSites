<%@ Control Language="C#" AutoEventWireup="true" CodeFile="HallEditor.ascx.cs" Inherits="HallEditor" %>
    ...
    <tr>
        <td>
            <dx:ASPxGridView ID="GVEditor" runat="server" AutoGenerateColumns="False" 
                ...
                KeyFieldName="hallId" RightToLeft="True" 
...
s.cpShowPopup = undefined;
                ...
                <Columns>
                    ...
                    <dx:GridViewDataTextColumn Caption="العنوان" FieldName="hallAdress" 
                        VisibleIndex="3">
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataTextColumn Caption="تليفون1" FieldName="halltel1" 
                        VisibleIndex="7">
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataTextColumn Caption="اسم القاعه" 
                        VisibleIndex="1" FieldName="hallName">
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataTextColumn Caption="تليفون2" FieldName="halltel2" 
                        VisibleIndex="9">
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataTextColumn Caption="المسئول" FieldName="person" 
                        VisibleIndex="11">
                    </dx:GridViewDataTextColumn>
                </Columns>
            ...
            <asp:AccessDataSource ID="DSData" runat="server" DataFile="../App_Data/Synricate.mdb" 
                DeleteCommand="DELETE FROM [CDHall] WHERE [hallId] = ?" 
                InsertCommand="INSERT INTO [CDHall] ([hallName], [LagnaId], [hallAdress], [halltel1], [halltel2], [person]) VALUES (?, ?, ?, ?, ?, ?)" 
                SelectCommand="SELECT [hallId], [hallName], [LagnaId], [hallAdress], [halltel1], [halltel2], [person] FROM [CDHall]" 
                ...
                UpdateCommand="UPDATE [CDHall] SET [hallName] = ?, [LagnaId] = ?, [hallAdress] = ?, [halltel1] = ?, [halltel2] = ?, [person] = ? WHERE [hallId] = ?">
                <DeleteParameters>
                ...
                <InsertParameters>
                    ...
                    <asp:Parameter Name="hallAdress" Type="String" />
                    <asp:Parameter Name="halltel1" Type="String" />
                    <asp:Parameter Name="halltel2" Type="String" />
