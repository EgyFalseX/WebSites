<%@ Control Language="C#" AutoEventWireup="true" CodeFile="LagnaEditor.ascx.cs" Inherits="LagnaEditor" %>
    ...
    <tr>
        <td>
            <dx:ASPxGridView ID="GVEditor" runat="server" AutoGenerateColumns="False" 
                ...
                KeyFieldName="LagnaId" RightToLeft="True" 
...
s.cpShowPopup = undefined;
                ...
                <Columns>
                    ...
                    <dx:GridViewDataTextColumn Caption="اسم اللجنه" FieldName="LagnaName" 
                        VisibleIndex="1">
            ...
            <asp:AccessDataSource ID="DSData" runat="server" DataFile="../App_Data/Synricate.mdb" 
                DeleteCommand="DELETE FROM [CDLagna] WHERE [LagnaId] = ?" 
                InsertCommand="INSERT INTO [CDLagna] ([LagnaName]) VALUES (?)" 
                SelectCommand="SELECT [LagnaId], [LagnaName] FROM [CDLagna]" 
                
                
                
                UpdateCommand="UPDATE [CDLagna] SET [LagnaName] = ? WHERE [LagnaId] = ?">
                <DeleteParameters>
                    <asp:Parameter Name="LagnaId" Type="Int32" />
                </DeleteParameters>
                <InsertParameters>
                    <asp:Parameter Name="LagnaName" Type="String" />
                </InsertParameters>
                <UpdateParameters>
                    <asp:Parameter Name="LagnaName" Type="String" />
                    <asp:Parameter Name="LagnaId" Type="Int32" />
