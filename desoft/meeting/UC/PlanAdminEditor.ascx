<%@ Control Language="C#" AutoEventWireup="true" CodeFile="PlanAdminEditor.ascx.cs" Inherits="PlanAdminEditor" %>
...
s.cpShowPopup = undefined;
                ...
                <Columns>
                    <dx:GridViewCommandColumn ButtonType="Image" Caption="العمليات" 
                        VisibleIndex="0" Visible="False" ShowInCustomizationForm="False">
                    ...
                    <dx:GridViewDataHyperLinkColumn Caption="تفاصيل الخطه" FieldName="planId" 
                        VisibleIndex="7">
                        <PropertiesHyperLinkEdit NavigateUrlFormatString="../PlanDetailsAdminEditor.aspx?id={0}" 
