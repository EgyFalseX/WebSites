<%@ Control Language="C#" AutoEventWireup="true" CodeFile="PlanDetailsAdminEditor.ascx.cs" Inherits="PlanDetailsAdminEditor" %>
...
s.cpShowPopup = undefined;
                ...
                <Columns>
                    <dx:GridViewCommandColumn ButtonType="Image" Caption="العمليات" 
                        VisibleIndex="0" ShowInCustomizationForm="False" Visible="False">
            ...
            <asp:AccessDataSource ID="DSData" runat="server" DataFile="../App_Data/Synricate.mdb" 
                ...
                SelectCommand="SELECT [plandetialId], [planId], [plandetialdate], [plandetial], [MemberId], [rem], [tam] FROM [tblplandetials]" 
