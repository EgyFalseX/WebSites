<%@ Control Language="C#" AutoEventWireup="true" CodeFile="JobsEditor.ascx.cs" Inherits="JobsEditor" %>
    ...
    <tr>
        <td>
            <dx:ASPxGridView ID="GVEditor" runat="server" AutoGenerateColumns="False" 
                ...
                KeyFieldName="jobId" RightToLeft="True" 
...
s.cpShowPopup = undefined;
                ...
                <Columns>
                    ...
                    <dx:GridViewDataTextColumn Caption="اسم الوظيفه" FieldName="jobName" 
                        VisibleIndex="1">
            ...
            <asp:AccessDataSource ID="DSData" runat="server" DataFile="../App_Data/Synricate.mdb" 
                DeleteCommand="DELETE FROM [CDjob] WHERE ([jobId] = ?)" 
                InsertCommand="INSERT INTO [CDjob] ([jobName]) VALUES (?)" 
                SelectCommand="SELECT [jobId], [jobName] FROM [CDjob]" 
                
                
                
                UpdateCommand="UPDATE [CDjob] SET [jobName] = ? WHERE ([jobId] = ?)">
                <DeleteParameters>
