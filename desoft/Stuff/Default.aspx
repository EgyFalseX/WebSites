        ...
        <tr>
            <td style="text-align: center">
                <asp:HyperLink ID="HyperLink7" runat="server" 
                    NavigateUrl="StaffCodeEditor.aspx">اكواد الاسر</asp:HyperLink>
            </td>
        </tr>
        <tr>
            <td style="text-align: center">
                <asp:HyperLink ID="HyperLink1" runat="server" 
                    NavigateUrl="TrainershowEditor.aspx">الاسر</asp:HyperLink>
            </td>
        </tr>
        <tr>
            <td style="text-align: center">
        ...
        <tr>
            <td style="text-align: center">
                <asp:HyperLink ID="HyperLink6" runat="server" 
                    NavigateUrl="TrainershowViewer.aspx">عرض الاســر</asp:HyperLink>
            </td>
        </tr>
    </table>
</asp:Content>
