<%@ Control Language="C#" AutoEventWireup="true" CodeFile="StaffCodeEditor.ascx.cs" Inherits="ContactUsEditor" %>
    ...
    <tr>
        <td>
            <dx:ASPxGridView ID="GVEditor" runat="server" AutoGenerateColumns="False" 
                Caption="الاســـــــر" DataSourceID="DSData" 
                KeyFieldName="Trainer_type_id" RightToLeft="True" 
                SummaryText="الملخص" CssFilePath="../App_Themes/DevEx/{0}/styles.css" 
                CssPostfix="DevEx" EnableTheming="True" 
                onrowdeleted="GVEditor_RowDeleted" onrowupdated="GVEditor_RowUpdated" 
                onrowinserted="GVEditor_RowInserted" Width="400px">
...
s.cpShowPopup = undefined;
                ...
                <Columns>
                    ...
                    <dx:GridViewDataTextColumn Caption="الاســـــره" FieldName="Trainer_type" 
                        VisibleIndex="1">
