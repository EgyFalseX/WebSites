...
s.cpShowPopup = undefined;
                ...
                <Columns>
                    ...
                    <dx:GridViewDataTextColumn Caption="المدرسه" FieldName="school" VisibleIndex="11">
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataTextColumn Caption="اسم المسئول" FieldName="namelogin" ReadOnly="True" VisibleIndex="12">
                    </dx:GridViewDataTextColumn>
                </Columns>
            ...
            <asp:AccessDataSource ID="DSData" runat="server" DataFile="~/App_Data/ContactUs2.mdb" 
                ...
                SelectCommand="SELECT        contact.addno, contact.coname, contact.sefaid, contact.contypeid, contact.tel, contact.mail, contact.massage, contact.condate, contact.rply, contact.agreeshow, contact.adminagree, adminContactUs2.school, 
                         adminContactUs2.namelogin
FROM            (contact INNER JOIN
                         adminContactUs2 ON contact.userid = adminContactUs2.id)" 
            ...
            <asp:AccessDataSource ID="DSsefa" runat="server" DataFile="~/App_Data/ContactUs2.mdb"
                SelectCommand="SELECT [sefaid], [sefa] FROM [sefa]">
            </asp:AccessDataSource>
            <asp:AccessDataSource ID="DScontype" runat="server" DataFile="~/App_Data/ContactUs2.mdb"
