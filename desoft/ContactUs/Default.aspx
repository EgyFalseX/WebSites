...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table align="center" class="style1">
        ...
        <tr>
            <td style="text-align: center">
                <asp:HyperLink ID="HyperLink1" runat="server" 
                    NavigateUrl="ContactUsEditor.aspx">راسلنــــــا</asp:HyperLink>
            </td>
        </tr>
        <tr>
            <td style="text-align: center">
        ...
        <tr>
            <td style="text-align: center">
                <asp:HyperLink ID="HyperLink3" runat="server" NavigateUrl="ContactUs.aspx">اضافة راسلنــــــا</asp:HyperLink>
            </td>
        </tr>
        <tr>
            <td style="text-align: center">
                <asp:HyperLink ID="HyperLink6" runat="server" NavigateUrl="ViewContracUs.aspx">عرض راسلنـــــــا</asp:HyperLink>
            </td>
        </tr>
    </table>
</asp:Content>
